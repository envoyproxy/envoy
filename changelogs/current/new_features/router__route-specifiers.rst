Added ``route_specifiers``, a new extension point that post-processes the route resolved by route
matching. Specifiers are executed in order and the output of each is the input of the next, and may
