...
void QueueData::encode(Protobuf::Struct& data_struct) {
  auto* fields = data_struct.mutable_fields();

  Protobuf::Value broker_name_v;
...
void TopicRouteData::encode(Protobuf::Struct& data_struct) {
  auto* fields = data_struct.mutable_fields();

  if (!queue_data_.empty()) {
    Protobuf::ListValue queue_data_list_v;
  ...
  if (!broker_data_.empty()) {
    Protobuf::ListValue broker_data_list_v;
