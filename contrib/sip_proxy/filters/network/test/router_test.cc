...
public:
  ...
  void initializeTrans(const std::string& sip_protocol_options_yaml = "",
    ...
    context_.mock_server_context_.cluster_manager_.initializeThreadLocalClusters({cluster_name_});
  ...
  void initializeRouter() {
    ...
    router_ = std::make_unique<Router>(context_.mock_server_context_.clusterManager(), "test",
                                       context_.scope(), context_);
