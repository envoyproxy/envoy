...
// downstream
CAPIStatus envoyGoFilterDownstreamClose(void* wrapper, int closeType); // NOLINT(readability-identifier-naming)
CAPIStatus envoyGoFilterDownstreamWrite(void* wrapper, void* buffers, int buffersNum, // NOLINT(readability-identifier-naming)
...
// upstream
void* envoyGoFilterUpstreamConnect(void* libraryID, void* addr, unsigned long long int connID); // NOLINT(readability-identifier-naming)
CAPIStatus envoyGoFilterUpstreamWrite(void* wrapper, void* buffers, int buffersNum, int endStream); // NOLINT(readability-identifier-naming)
CAPIStatus envoyGoFilterUpstreamClose(void* wrapper, int closeType); // NOLINT(readability-identifier-naming)
