...
public:
  ...
  virtual GoUint64 envoyGoFilterMergeHttpPluginConfig(GoUint64 p0, GoUint64 p1, GoUint64 p2,
                                                      GoUint64 p3) PURE;
  virtual void envoyGoFilterDestroyHttpPluginConfig(httpConfig* p0, GoUint64 p1) PURE;
...
public:
  ...
  void envoyGoFilterDestroyHttpPluginConfig(httpConfig* p0, GoUint64 p1) override;
...
private:
  ...
  GoUint64 (*envoy_go_filter_merge_http_plugin_config_)(GoUint64 p0, GoUint64 p1, GoUint64 p2,
                                                        GoUint64 p3) = {nullptr};
  void (*envoy_go_filter_destroy_http_plugin_config_)(httpConfig* p0, GoUint64 p1) = {nullptr};
