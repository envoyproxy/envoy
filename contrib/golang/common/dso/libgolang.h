...
extern GoUint64 envoyGoFilterMergeHttpPluginConfig(GoUint64 namePtr, GoUint64 nameLen, // NOLINT(readability-identifier-naming)
...
extern GoUint64 envoyGoFilterOnHttpHeader(httpRequest* r, GoUint64 endStream, GoUint64 headerNum, // NOLINT(readability-identifier-naming)
...
extern GoUint64 envoyGoFilterOnHttpData(httpRequest* r, GoUint64 endStream, GoUint64 buffer, // NOLINT(readability-identifier-naming)
                                        GoUint64 length);
...
extern GoInt64 envoyGoOnClusterSpecify(GoUint64 pluginPtr, GoUint64 headerPtr, GoUint64 pluginId, // NOLINT(readability-identifier-naming)
                                       GoUint64 bufferPtr, GoUint64 bufferLen); // NOLINT(readability-identifier-naming)
...
extern GoUint64 envoyGoClusterSpecifierNewPlugin(GoUint64 configPtr, GoUint64 configLen); // NOLINT(readability-identifier-naming)
...
extern GoUint64 envoyGoFilterOnNetworkFilterConfig(GoUint64 libraryIDPtr, GoUint64 libraryIDLen, // NOLINT(readability-identifier-naming)
...
extern GoUint64 envoyGoFilterOnDownstreamConnection(void* f, GoUint64 pluginNamePtr, // NOLINT(readability-identifier-naming)
...
extern GoUint64 envoyGoFilterOnDownstreamData(void* f, GoUint64 dataSize, GoUint64 dataPtr, // NOLINT(readability-identifier-naming)
...
extern GoUint64 envoyGoFilterOnDownstreamWrite(void* f, GoUint64 dataSize, GoUint64 dataPtr, // NOLINT(readability-identifier-naming)
                                               GoInt sliceNum, GoInt endOfStream); // NOLINT(readability-identifier-naming)
...
extern void envoyGoFilterOnUpstreamConnectionReady(void* f, GoUint64 connID); // NOLINT(readability-identifier-naming)
...
extern void envoyGoFilterOnUpstreamConnectionFailure(void* f, GoInt reason, GoUint64 connID); // NOLINT(readability-identifier-naming)
...
extern GoUint64 envoyGoFilterOnUpstreamData(void* f, GoUint64 dataSize, GoUint64 dataPtr, // NOLINT(readability-identifier-naming)
                                            GoInt sliceNum, GoInt endOfStream); // NOLINT(readability-identifier-naming)
