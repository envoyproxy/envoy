...
extern GoUint64 envoyGoFilterMergeHttpPluginConfig(GoUint64 namePtr, GoUint64 nameLen,
                                                   GoUint64 parentId, GoUint64 childId);
...
extern GoUint64 envoyGoFilterOnHttpHeader(httpRequest* r, GoUint64 endStream, GoUint64 headerNum,
...
extern GoUint64 envoyGoFilterOnHttpData(httpRequest* r, GoUint64 endStream, GoUint64 buffer,
                                        GoUint64 length);
...
extern GoUint64 envoyGoFilterOnNetworkFilterConfig(GoUint64 libraryIDPtr, GoUint64 libraryIDLen,
                                                   GoUint64 configPtr, GoUint64 configLen);
...
extern GoUint64 envoyGoFilterOnDownstreamConnection(void* f, GoUint64 pluginNamePtr,
                                                    GoUint64 pluginNameLen, GoUint64 configID);
...
extern GoUint64 envoyGoFilterOnDownstreamData(void* f, GoUint64 dataSize, GoUint64 dataPtr,
                                              GoInt sliceNum, GoInt endOfStream);
...
extern GoUint64 envoyGoFilterOnDownstreamWrite(void* f, GoUint64 dataSize, GoUint64 dataPtr,
                                               GoInt sliceNum, GoInt endOfStream);
...
extern void envoyGoFilterOnUpstreamConnectionReady(void* f, GoUint64 connID);
...
extern void envoyGoFilterOnUpstreamConnectionFailure(void* f, GoInt reason, GoUint64 connID);
...
extern GoUint64 envoyGoFilterOnUpstreamData(void* f, GoUint64 dataSize, GoUint64 dataPtr,
                                            GoInt sliceNum, GoInt endOfStream);
