...
#include "contrib/envoy/extensions/http/sse_stateful_session/envelope/v3alpha/envelope.pb.validate.h"
...
EnvelopeSessionStateFactoryConfig::createSseSessionStateFactory(
  ...
  const auto& proto_config =
      MessageUtil::downcastAndValidate<const envoy::extensions::http::sse_stateful_session::
