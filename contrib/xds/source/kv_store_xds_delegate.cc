...
#include "contrib/envoy/extensions/xds/v3alpha/kv_store_xds_delegate_config.pb.h"
#include "contrib/envoy/extensions/xds/v3alpha/kv_store_xds_delegate_config.pb.validate.h"
...
using ::envoy::extensions::xds::v3alpha::KeyValueStoreXdsDelegateConfig;
