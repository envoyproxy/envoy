...
class ServicesHolder:
    ...
    def find_envoy():
        ...
        or at ./external/envoy/contrib/exe/envoy-static (for bazel-compile_time_options with Bazel 7),
        or at ./envoy/contrib/exe/envoy-static (for bazel-compile_time_options with Bazel 8).
        """
