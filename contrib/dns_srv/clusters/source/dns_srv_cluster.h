...
private:
  ...
  // Host map (hosts_by_address_) for current resolve target. When we have multiple resolve targets,
  // multiple targets may contain two different hosts with the same address. This has two effects:
