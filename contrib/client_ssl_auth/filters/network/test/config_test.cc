...
ip_white_list:
  ...
  context.mock_server_context_.cluster_manager_.initializeClusters({"fake_cluster"}, {});
  context.mock_server_context_.cluster_manager_.initializeThreadLocalClusters({"fake_cluster"});
