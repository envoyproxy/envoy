 ...
 */
#define CKF_USER_PIN_COUNT_LOW 0X00000010000UL

/* CKF_USER_PIN_FINAL_TRY. If it is true,
 * supplying an incorrect user PIN will it to become locked.
 */
#define CKF_USER_PIN_FINAL_TRY 0X00000020000UL

/* CKF_USER_PIN_LOCKED. If it is true, the
 * user PIN has been locked. User login to the token is not
 * possible.
 */
#define CKF_USER_PIN_LOCKED 0X00000040000UL
 ...
 * expired by the card.
 */
#define CKF_USER_PIN_TO_BE_CHANGED 0X00000080000UL

/* CKF_SO_PIN_COUNT_LOW. If it is true, an
 * incorrect SO login PIN has been entered at least once since
 * the last successful authentication.
 */
#define CKF_SO_PIN_COUNT_LOW 0X00000100000UL

/* CKF_SO_PIN_FINAL_TRY. If it is true,
 * supplying an incorrect SO PIN will it to become locked.
 */
#define CKF_SO_PIN_FINAL_TRY 0X00000200000UL

/* CKF_SO_PIN_LOCKED. If it is true, the SO
 * PIN has been locked. SO login to the token is not possible.
 */
#define CKF_SO_PIN_LOCKED 0X00000400000UL
 ...
 * expired by the card.
 */
#define CKF_SO_PIN_TO_BE_CHANGED 0X00000800000UL
...
#define CKM_SKIPJACK_KEY_GEN 0X00000001000UL
#define CKM_SKIPJACK_ECB64 0X00000001001UL
#define CKM_SKIPJACK_CBC64 0X00000001002UL
#define CKM_SKIPJACK_OFB64 0X00000001003UL
#define CKM_SKIPJACK_CFB64 0X00000001004UL
#define CKM_SKIPJACK_CFB32 0X00000001005UL
#define CKM_SKIPJACK_CFB16 0X00000001006UL
#define CKM_SKIPJACK_CFB8 0X00000001007UL
#define CKM_SKIPJACK_WRAP 0X00000001008UL
#define CKM_SKIPJACK_PRIVATE_WRAP 0X00000001009UL
#define CKM_SKIPJACK_RELAYX 0X0000000100aUL
#define CKM_KEA_KEY_PAIR_GEN 0X00000001010UL
#define CKM_KEA_KEY_DERIVE 0X00000001011UL
#define CKM_KEA_DERIVE 0X00000001012UL
#define CKM_FORTEZZA_TIMESTAMP 0X00000001020UL
#define CKM_BATON_KEY_GEN 0X00000001030UL
#define CKM_BATON_ECB128 0X00000001031UL
#define CKM_BATON_ECB96 0X00000001032UL
#define CKM_BATON_CBC128 0X00000001033UL
#define CKM_BATON_COUNTER 0X00000001034UL
#define CKM_BATON_SHUFFLE 0X00000001035UL
#define CKM_BATON_WRAP 0X00000001036UL

#define CKM_ECDSA_KEY_PAIR_GEN 0X00000001040UL /* Deprecated */
#define CKM_EC_KEY_PAIR_GEN 0X00000001040UL

#define CKM_ECDSA 0X00000001041UL
#define CKM_ECDSA_SHA1 0X00000001042UL
#define CKM_ECDSA_SHA224 0X00000001043UL
#define CKM_ECDSA_SHA256 0X00000001044UL
#define CKM_ECDSA_SHA384 0X00000001045UL
#define CKM_ECDSA_SHA512 0X00000001046UL

#define CKM_ECDH1_DERIVE 0X00000001050UL
#define CKM_ECDH1_COFACTOR_DERIVE 0X00000001051UL
#define CKM_ECMQV_DERIVE 0X00000001052UL

#define CKM_ECDH_AES_KEY_WRAP 0X00000001053UL
#define CKM_RSA_AES_KEY_WRAP 0X00000001054UL

#define CKM_JUNIPER_KEY_GEN 0X00000001060UL
#define CKM_JUNIPER_ECB128 0X00000001061UL
#define CKM_JUNIPER_CBC128 0X00000001062UL
#define CKM_JUNIPER_COUNTER 0X00000001063UL
#define CKM_JUNIPER_SHUFFLE 0X00000001064UL
#define CKM_JUNIPER_WRAP 0X00000001065UL
#define CKM_FASTHASH 0X00000001070UL

#define CKM_AES_KEY_GEN 0X00000001080UL
#define CKM_AES_ECB 0X00000001081UL
#define CKM_AES_CBC 0X00000001082UL
#define CKM_AES_MAC 0X00000001083UL
#define CKM_AES_MAC_GENERAL 0X00000001084UL
#define CKM_AES_CBC_PAD 0X00000001085UL
#define CKM_AES_CTR 0X00000001086UL
#define CKM_AES_GCM 0X00000001087UL
#define CKM_AES_CCM 0X00000001088UL
#define CKM_AES_CTS 0X00000001089UL
#define CKM_AES_CMAC 0X0000000108AUL
#define CKM_AES_CMAC_GENERAL 0X0000000108BUL

#define CKM_AES_XCBC_MAC 0X0000000108CUL
#define CKM_AES_XCBC_MAC_96 0X0000000108DUL
#define CKM_AES_GMAC 0X0000000108EUL

#define CKM_BLOWFISH_KEY_GEN 0X00000001090UL
#define CKM_BLOWFISH_CBC 0X00000001091UL
#define CKM_TWOFISH_KEY_GEN 0X00000001092UL
#define CKM_TWOFISH_CBC 0X00000001093UL
#define CKM_BLOWFISH_CBC_PAD 0X00000001094UL
#define CKM_TWOFISH_CBC_PAD 0X00000001095UL

#define CKM_DES_ECB_ENCRYPT_DATA 0X00000001100UL
#define CKM_DES_CBC_ENCRYPT_DATA 0X00000001101UL
#define CKM_DES3_ECB_ENCRYPT_DATA 0X00000001102UL
#define CKM_DES3_CBC_ENCRYPT_DATA 0X00000001103UL
#define CKM_AES_ECB_ENCRYPT_DATA 0X00000001104UL
#define CKM_AES_CBC_ENCRYPT_DATA 0X00000001105UL

#define CKM_GOSTR3410_KEY_PAIR_GEN 0X00000001200UL
#define CKM_GOSTR3410 0X00000001201UL
#define CKM_GOSTR3410_WITH_GOSTR3411 0X00000001202UL
#define CKM_GOSTR3410_KEY_WRAP 0X00000001203UL
#define CKM_GOSTR3410_DERIVE 0X00000001204UL
#define CKM_GOSTR3411 0X00000001210UL
#define CKM_GOSTR3411_HMAC 0X00000001211UL
#define CKM_GOST28147_KEY_GEN 0X00000001220UL
#define CKM_GOST28147_ECB 0X00000001221UL
#define CKM_GOST28147 0X00000001222UL
#define CKM_GOST28147_MAC 0X00000001223UL
#define CKM_GOST28147_KEY_WRAP 0X00000001224UL

#define CKM_DSA_PARAMETER_GEN 0X00000002000UL
#define CKM_DH_PKCS_PARAMETER_GEN 0X00000002001UL
#define CKM_X9_42_DH_PARAMETER_GEN 0X00000002002UL
#define CKM_DSA_PROBABLISTIC_PARAMETER_GEN 0X00000002003UL
#define CKM_DSA_SHAWE_TAYLOR_PARAMETER_GEN 0X00000002004UL

#define CKM_AES_OFB 0X00000002104UL
#define CKM_AES_CFB64 0X00000002105UL
#define CKM_AES_CFB8 0X00000002106UL
#define CKM_AES_CFB128 0X00000002107UL

#define CKM_AES_CFB1 0X00000002108UL
#define CKM_AES_KEY_WRAP 0X00000002109UL     /* WAS: 0x00001090 */
#define CKM_AES_KEY_WRAP_PAD 0X0000000210AUL /* WAS: 0x00001091 */

#define CKM_RSA_PKCS_TPM_1_1 0X00000004001UL
#define CKM_RSA_PKCS_OAEP_TPM_1_1 0X00000004002UL
...
#define CKF_SIGN_RECOVER 0X00000001000UL
#define CKF_VERIFY 0X00000002000UL
#define CKF_VERIFY_RECOVER 0X00000004000UL
#define CKF_GENERATE 0X00000008000UL
#define CKF_GENERATE_KEY_PAIR 0X00000010000UL
#define CKF_WRAP 0X00000020000UL
#define CKF_UNWRAP 0X00000040000UL
#define CKF_DERIVE 0X00000080000UL

/* Describe a token's EC capabilities not available in mechanism
 * information.
 */
#define CKF_EC_F_P 0X00000100000UL
#define CKF_EC_F_2M 0X00000200000UL
#define CKF_EC_ECPARAMETERS 0X00000400000UL
#define CKF_EC_NAMEDCURVE 0X00000800000UL
...
typedef CK_CALLBACK_FUNCTION(CK_RV,
                             CK_NOTIFY)(CK_SESSION_HANDLE hSession, /* the session's handle */
