...
ARM64_SKIP_CONTRIB_TARGETS = ["envoy.tls.key_providers.cryptomb", "envoy.regex.hyperscan"]
PPC_SKIP_CONTRIB_TARGETS = ["envoy.tls.key_providers.cryptomb", "envoy.regex.hyperscan"]
