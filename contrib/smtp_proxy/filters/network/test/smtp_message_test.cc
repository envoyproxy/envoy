...
// Tests for individual types used in Smtp messages.
//
// Integer types.
...
// ByteN type is always placed at the end of Smtp message.
// There is no explicit message length. Length must be deduced from
// "length" field on Smtp message.
...
TEST(SmtpMessage, SingleFieldInt32) {
...
TEST(SmtpMessage, SingleFieldInt16) {
...
TEST(SmtpMessage, MultipleValues1) {
...
TEST(SmtpMessage, MultipleValues2) {
...
TEST(SmtpMessage, MultipleValues3) {
...
TEST(SmtpMessage, MultipleValues4) {
...
TEST(SmtpMessage, MultipleValues5) {
...
TEST(SmtpMessage, MultipleValues6) {
...
TEST(SmtpMessage, MultipleValues7) {
...
TEST(SmtpMessage, NotEnoughData) {
...
TEST(SmtpMessage, ValidateFromOffset) {
  std::unique_ptr<Message> msg = createMsgBodyReader<Int32, String>();
  Buffer::OwnedImpl data;
