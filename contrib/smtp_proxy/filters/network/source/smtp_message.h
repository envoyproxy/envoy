...
/**
 * Smtp messages are described in official Smtp documentation:
 ...
 *
 * Structures defined below have the same naming as types used in official Smtp documentation.
 *
...
// Interface to Smtp message class.
class Message {
public:
  ...
  // "length" parameter indicates how many bytes were indicated in Smtp message's
...
public:
   ...
   * this parameter.
   * @param left number of bytes to be read to reach the end of Smtp message.
...
// ByteN type is used as the last type in the Smtp message and contains
...
// In Smtp documentation it is described as:
// - Int32
...
// Helper function to create pointer to a Sequence structure and is used by Smtp
// decoder after learning the type of Smtp message.
