...
Network::ReverseConnectionListenerPtr RCThreadLocalRegistry::createActiveReverseConnectionListener(
    Network::ConnectionHandler& conn_handler, Event::Dispatcher& dispatcher,
    Network::ListenerConfig& config) {
  return std::make_unique<Envoy::Extensions::ReverseConnection::ActiveReverseConnectionListener>(
      conn_handler, dispatcher, config, *this);
}
