...
TEST(FactoryTest, FactoryTest) {
  ...
  EXPECT_NE(nullptr, factory.createFilterFactoryFromProto(proto_config, nullptr, factory_context));
}
...
resources:
  ...
  Network::FilterFactoryCb cb =
      factory.createFilterFactoryFromProto(config, nullptr, factory_context);
  auto response =
...
TEST(FactoryTest, GenericRdsApiConfigSource) {
  ...
  EXPECT_THROW_WITH_REGEX(factory.createFilterFactoryFromProto(config, nullptr, factory_context),
                          EnvoyException,
