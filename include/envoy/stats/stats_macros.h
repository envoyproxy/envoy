...
#define GENERATE_BOOL_INDICATOR_STRUCT(NAME) Stats::TextReadout& NAME##_;
...
#define POOL_BOOL_INDICATOR_PREFIX(POOL, PREFIX) (POOL).textReadout(PREFIX FINISH_STAT_DECL_
