...
public:
   ...
   */
  virtual LdsApiPtr createLdsApi(const envoy::api::v3alpha::core::ConfigSource& lds_config) PURE;
  ...
  createDrainManager(envoy::api::v3alpha::Listener::DrainType drain_type) PURE;
...
public:
   ...
   */
  virtual bool addOrUpdateListener(const envoy::api::v3alpha::Listener& config,
   ...
   * @param lds_config supplies the management server configuration.
   */
  virtual void createLdsApi(const envoy::api::v3alpha::core::ConfigSource& lds_config) PURE;
