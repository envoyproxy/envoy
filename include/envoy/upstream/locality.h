...
struct LocalityHash {
  size_t operator()(const envoy::api::v3alpha::core::Locality& locality) const {
    return MessageUtil::hash(locality);
  }
};

struct LocalityEqualTo {
  bool operator()(const envoy::api::v3alpha::core::Locality& lhs,
                  const envoy::api::v3alpha::core::Locality& rhs) const {
...
static inline envoy::api::v3alpha::core::Locality
...
inline bool operator==(const envoy::api::v3alpha::core::Locality& x,
                       const envoy::api::v3alpha::core::Locality& y) {
