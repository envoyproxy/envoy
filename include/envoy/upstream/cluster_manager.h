...
public:
   ...
   */
  virtual bool addOrUpdateCluster(const envoy::api::v3alpha::Cluster& cluster,
   ...
   */
  virtual const envoy::api::v3alpha::core::BindConfig& bindConfig() const PURE;
...
public:
  ...
  clusterManagerFromProto(const envoy::config::bootstrap::v3alpha::Bootstrap& bootstrap) PURE;
  ...
  clusterFromProto(const envoy::api::v3alpha::Cluster& cluster, ClusterManager& cm,
   ...
   */
  virtual CdsApiPtr createCds(const envoy::api::v3alpha::core::ConfigSource& cds_config,
