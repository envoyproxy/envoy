...
"source/extensions/compression:90.1"
"source/extensions/compression/gzip:93.1"
"source/extensions/compression/gzip/decompressor:81.1"
...
"source/extensions/filters/network/thrift_proxy/docs:n"
...
"source/extensions/filters/network/kafka/serialization:n"
"source/extensions/filters/network/kafka/protocol:n"
...
"source/extensions/filters/http/decompressor:n"
...
"source/extensions/__pycache__:n"
"source/extensions/quic_listeners:85.1"
"source/extensions/quic_listeners/quiche:85.1"
"source/extensions/quic_listeners/quiche/platform:n"
...
COVERAGE_DATA=/tmp/coverage.dat
