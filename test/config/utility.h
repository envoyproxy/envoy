...
public:
  ...
  static void initializeTls(const ServerSslOptions& options,
                            envoy::api::v3alpha::auth::CommonTlsContext& common_context);
  ...
  static envoy::api::v3alpha::Cluster buildCluster(const std::string& name, int port,
  ...
  void addVirtualHost(const envoy::api::v3alpha::route::VirtualHost& vhost);
  ...
  void setClientCodec(envoy::config::filter::network::http_connection_manager::v3alpha::
...
private:
  ...
  bool loadHttpConnectionManager(
      envoy::config::filter::network::http_connection_manager::v3alpha::HttpConnectionManager& hcm);
  ...
  envoy::api::v3alpha::listener::Filter* getFilterFromListener(const std::string& name);
  ...
  void setTapTransportSocket(const std::string& tap_path, const std::string& type,
                             envoy::api::v3alpha::core::TransportSocket& transport_socket,
...
public:
  ...
  void setCds(const std::vector<envoy::api::v3alpha::Cluster>& cluster);
...
public:
  ...
  void
  setEds(const std::vector<envoy::api::v3alpha::ClusterLoadAssignment>& cluster_load_assignments);
  void setEdsAndWait(
      const std::vector<envoy::api::v3alpha::ClusterLoadAssignment>& cluster_load_assignments,
