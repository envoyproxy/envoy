...
TEST_P(ClusterMemoryTestRunner, MemoryLargeClusterSizeWithFakeSymbolTable) {
  ...
  // 2020/06/23  11559    44747       46000   stats: add histogram for request headers size per
  //                                          upstream
...
TEST_P(ClusterMemoryTestRunner, MemoryLargeClusterSizeWithRealSymbolTable) {
  ...
  // 2020/06/23  11559    36859       38000   stats: add histogram for request headers size per
  //                                          upstream
