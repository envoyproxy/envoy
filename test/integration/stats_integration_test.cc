...
TEST_P(ClusterMemoryTestRunner, MemoryLargeClusterSizeWithFakeSymbolTable) {
  ...
  // 2020/01/07  9564     42951       43500   use RefcountPtr for CentralCache.
  ...
  EXPECT_MEMORY_EQ(m_per_cluster, 42951); // 104 bytes higher than a debug build.
...
TEST_P(ClusterMemoryTestRunner, MemoryLargeClusterSizeWithRealSymbolTable) {
  ...
  // 2020/01/07  9564     35085       35000   RefcountPtr for CentralCache.
  ...
  // https://github.com/envoyproxy/envoy/blob/master/source/docs/stats.md#stats-memory-tests
  // for details on how to fix.
  EXPECT_MEMORY_EQ(m_per_cluster, 35085); // 104 bytes higher than a debug build.
