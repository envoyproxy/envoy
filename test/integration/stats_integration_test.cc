...
TEST_P(ClusterMemoryTestRunner, MemoryLargeClusterSizeWithFakeSymbolTable) {
  ...
  // 2020/01/09  8889     43509       43605   api: add UpstreamHttpProtocolOptions message
  ...
  EXPECT_MEMORY_LE(m_per_cluster, 43605);
}
...
TEST_P(ClusterMemoryTestRunner, MemoryLargeClusterSizeWithRealSymbolTable) {
  ...
  // 2020/01/09  8889     35644       35740   api: add UpstreamHttpProtocolOptions message
  ...
  EXPECT_MEMORY_LE(m_per_cluster, 35740);
}
