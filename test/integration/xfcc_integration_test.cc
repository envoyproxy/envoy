...
TEST_P(XfccIntegrationTest, TagExtractedNameGenerationTest) {
  ...
  tag_extracted_counter_map = {
      ...
      {"http.admin.downstream_flow_control_combined_reading_delay_micros",
       "http.downstream_flow_control_combined_reading_delay_micros"},
      ...
      {"http.config_test.downstream_flow_control_paused_reading_total",
       "http.downstream_flow_control_paused_reading_total"},
      {"http.config_test.downstream_flow_control_combined_reading_delay_micros",
       "http.downstream_flow_control_combined_reading_delay_micros"},
      ...
      {"cluster.cluster_0.upstream_flow_control_combined_reading_delay_micros",
       "cluster.upstream_flow_control_combined_reading_delay_micros"},
