...
public:
  const std::string previous_xfcc_ =
      "By=spiffe://lyft.com/frontend;By=http://frontend.lyft.com;Hash=123456;URI=spiffe://lyft.com/testclient";
  ...
  const std::string client_uri_san_ = "URI=spiffe://lyft.com/frontend-team;URI=http://frontend.lyft.com";
