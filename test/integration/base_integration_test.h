...
protected:
  ...
  void setMaxRequestHeadersCount(uint32_t value) { upstream_config_.max_request_headers_count_ = value; }
  void setHeadersWithUnderscoreAction(envoy::config::core::v3::HttpProtocolOptions::HeadersWithUnderscoresAction value) {
