...
TEST_P(AdsIntegrationTest, Failure) {
  ...
  sendDiscoveryResponse<envoy::api::v3alpha::ClusterLoadAssignment>(
  ...
  sendDiscoveryResponse<envoy::api::v3alpha::Cluster>(Config::TypeUrl::get().Cluster,
                                                      {buildCluster("cluster_0")},
                                                      {buildCluster("cluster_0")}, {}, "1");

  EXPECT_TRUE(compareDiscoveryRequest(Config::TypeUrl::get().ClusterLoadAssignment, "",
                                      {"cluster_0"}, {"cluster_0"}, {}));
  sendDiscoveryResponse<envoy::api::v3alpha::Cluster>(Config::TypeUrl::get().ClusterLoadAssignment,
                                                      {buildCluster("cluster_0")},
                                                      {buildCluster("cluster_0")}, {}, "1");
  ...
  EXPECT_TRUE(compareDiscoveryRequest(Config::TypeUrl::get().ClusterLoadAssignment, "1",
                                      {"cluster_0"}, {}, {}));
  sendDiscoveryResponse<envoy::api::v3alpha::RouteConfiguration>(
  ...
  sendDiscoveryResponse<envoy::api::v3alpha::Listener>(
...
TEST_P(AdsIntegrationTest, DuplicateInitialClusters) {
  ...
  // process a request.
  EXPECT_TRUE(compareDiscoveryRequest(Config::TypeUrl::get().Cluster, "", {}, {}, {}, true));
  sendDiscoveryResponse<envoy::api::v3alpha::Cluster>(
  ...
  void initialize() override {
    config_helper_.addConfigModifier(
        [this](envoy::config::bootstrap::v3alpha::Bootstrap& bootstrap) {
          ...
          ads_eds_cluster->set_type(envoy::api::v3alpha::Cluster::EDS);
...
TEST_P(AdsIntegrationTest, ListenerDrainBeforeServerStart) {
  ...
  // Remove listener.
  EXPECT_TRUE(compareDiscoveryRequest(Config::TypeUrl::get().Listener, "1", {}, {}, {}));
  sendDiscoveryResponse<envoy::api::v3alpha::Listener>(Config::TypeUrl::get().Listener, {}, {},
                                                       {"listener_0"}, "2");
...
public:
  ...
  void initialize() override {
    config_helper_.addConfigModifier(
        [this](envoy::config::bootstrap::v3alpha::Bootstrap& bootstrap) {
          ...
          ads_cluster->set_type(envoy::api::v3alpha::Cluster::EDS);
  ...
  envoy::api::v3alpha::ClusterLoadAssignment buildClusterLoadAssignment(const std::string& name) {
    return TestUtility::parseYaml<envoy::api::v3alpha::ClusterLoadAssignment>(
        fmt::format(R"EOF(
      cluster_name: {}
      endpoints:
      - lb_endpoints:
