...
OptionsImpl createTestOptionsImpl(const std::string& config_path, const std::string& config_yaml,
                                  Network::Address::IpVersion ip_version, bool allow_unknown_fields,
  ...
  test_options.setAllowUnkownFields(allow_unknown_fields);
  test_options.setRejectUnknownFieldsDynamic(reject_unknown_fields_dynamic);
...
IntegrationTestServerPtr IntegrationTestServer::create(
    ...
    absl::optional<std::reference_wrapper<ProcessObject>> process_object, bool allow_unknown_fields,
    bool reject_unknown_fields_dynamic) {
  ...
  server->start(version, on_server_init_function, deterministic, defer_listener_finalization,
                process_object, allow_unknown_fields, reject_unknown_fields_dynamic);
  return server;
}
...
void IntegrationTestServer::start(
  ...
  thread_ = api_.threadFactory().createThread([version, deterministic, process_object,
                                               ...
                                               this]() -> void {
    threadRoutine(version, deterministic, process_object, allow_unknown_fields,
                  reject_unknown_fields_dynamic);
  });
