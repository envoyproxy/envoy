...
#include "envoy/api/v3alpha/endpoint/load_report.pb.h"
...
public:
  ...
  void addEndpoint(envoy::api::v3alpha::endpoint::LocalityLbEndpoints& locality_lb_endpoints,
  ...
  void initialize() override {
    ...
    config_helper_.addConfigModifier([this](
      ...
      loadstats_config->set_api_type(envoy::api::v3alpha::core::ApiConfigSource::GRPC);
      ...
      cluster_0->set_type(envoy::api::v3alpha::Cluster::EDS);
  ...
  void mergeLoadStats(
      envoy::service::load_stats::v3alpha::LoadStatsRequest& loadstats_request,
      const envoy::service::load_stats::v3alpha::LoadStatsRequest& local_loadstats_request) {
  ...
  void
  waitForLoadStatsRequest(const std::vector<envoy::api::v3alpha::endpoint::UpstreamLocalityStats>&
                              expected_locality_stats,
                          uint64_t dropped = 0) {
    Protobuf::RepeatedPtrField<envoy::api::v3alpha::endpoint::ClusterStats> expected_cluster_stats;
    ...
    do {
      envoy::service::load_stats::v3alpha::LoadStatsRequest local_loadstats_request;
      AssertionResult result =
  ...
  void requestLoadStatsResponse(const std::vector<std::string>& clusters) {
    envoy::service::load_stats::v3alpha::LoadStatsResponse loadstats_response;
  ...
  envoy::api::v3alpha::endpoint::UpstreamLocalityStats
  localityStats(const std::string& sub_zone, uint64_t success, uint64_t error, uint64_t active,
                uint64_t issued, uint32_t priority = 0) {
    envoy::api::v3alpha::endpoint::UpstreamLocalityStats locality_stats;
