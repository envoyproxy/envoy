...
TEST_P(ExtensionDiscoveryIntegrationTest, ReuseExtensionConfigInvalid) {
  ...
  hcm_config.mutable_http_filters(0)->mutable_config_discovery()->add_type_urls(
      "type.googleapis.com/test.integration.filters.SetResponseCodeFilterConfig");
  static_cast<void>(listener_config_.mutable_filter_chains(0)
                        ->mutable_filters(0)
...
TEST_P(ExtensionDiscoveryIntegrationTest, ConfigDumpWithTwoSubscriptionTypes) {
  ...
  static_cast<void>(config_dump.configs(2).UnpackTo(&ecds_config_dump_http));
  ...
  static_cast<void>(http_filter_config.typed_config().UnpackTo(&http_config));
  ...
  static_cast<void>(config_dump.configs(3).UnpackTo(&ecds_config_dump_listener));
  ...
  static_cast<void>(filter_config.typed_config().UnpackTo(&listener_config));
