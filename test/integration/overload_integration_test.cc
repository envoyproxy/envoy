...
//   updateResource(0.9);
//   test_server_->waitForGaugeEq("overload.envoy.overload_actions.stop_accepting_requests.active",
//   1);
...
//   updateResource(0.8);
//   test_server_->waitForGaugeEq("overload.envoy.overload_actions.disable_http_keepalive.active",
//   1);
...
//       {":method", "GET"}, {":path", "/test/long/url"}, {":scheme", "http"}, {":authority",
//       "host"}};
//   auto response = sendRequestAndWaitForResponse(request_headers, 1, default_response_headers_,
//   1); ASSERT_TRUE(codec_client_->waitForDisconnect());
...
//     EXPECT_FALSE(fake_upstreams_[0]->waitForHttpConnection(*dispatcher_,
...
//   updateResource(0.8);
//   test_server_->waitForGaugeGe("overload.envoy.overload_actions.reduce_timeouts.scale_percent",
//   50);
