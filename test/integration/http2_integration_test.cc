...
TEST_P(Http2IntegrationTest, EncodingHeaderOnlyResponse) {
  testHeadersOnlyFilterEncoding();
}

TEST_P(Http2IntegrationTest, DecodingHeaderOnlyResponse) {
  testHeadersOnlyFilterDecoding();
}

TEST_P(Http2IntegrationTest, DecodingHeaderOnlyInterleaved) {
