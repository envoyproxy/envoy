...
class HttpSubsetLbIntegrationTest
    : public testing::TestWithParam<envoy::api::v3alpha::Cluster::LbPolicy>,
      public HttpIntegrationTest {
public:
  // Returns all load balancer types except ORIGINAL_DST_LB and CLUSTER_PROVIDED.
  static std::vector<envoy::api::v3alpha::Cluster::LbPolicy> getSubsetLbTestParams() {
    ...
    std::vector<envoy::api::v3alpha::Cluster::LbPolicy> ret;
    for (int i = first; i <= last; i++) {
      ...
      if (policy == envoy::api::v3alpha::Cluster::hidden_envoy_deprecated_ORIGINAL_DST_LB ||
          policy == envoy::api::v3alpha::Cluster::CLUSTER_PROVIDED ||
          policy == envoy::api::v3alpha::Cluster::LOAD_BALANCING_POLICY_CONFIG) {
        continue;
      }
  ...
  static std::string subsetLbTestParamsToString(
      const testing::TestParamInfo<envoy::api::v3alpha::Cluster::LbPolicy>& p) {
    const std::string& policy_name = envoy::api::v3alpha::Cluster::LbPolicy_Name(p.param);
  ...
  HttpSubsetLbIntegrationTest()
      : HttpIntegrationTest(Http::CodecClient::Type::HTTP1,
        ...
        num_hosts_{4}, is_hash_lb_(GetParam() == envoy::api::v3alpha::Cluster::RING_HASH ||
                                   GetParam() == envoy::api::v3alpha::Cluster::MAGLEV) {
