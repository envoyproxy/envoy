...
TEST_P(IntegrationAdminTest, Admin) {
  ...
  static_cast<void>(config_dump.configs(4).UnpackTo(&route_config_dump));
  ...
  static_cast<void>(config_dump.configs(5).UnpackTo(&secret_config_dump));
  ...
  static_cast<void>(name_filtered_config_dump.configs(5).UnpackTo(&secret_config_dump));
