...
public:
  ...
  void initialize() override {
    ...
    config_helper_.addConfigModifier([](envoy::config::bootstrap::v3alpha::Bootstrap& bootstrap) {
      ...
      hds_config->set_api_type(envoy::api::v3alpha::core::ApiConfigSource::GRPC);
  ...
  envoy::service::discovery::v3alpha::HealthCheckSpecifier makeHttpHealthCheckSpecifier() {
    envoy::service::discovery::v3alpha::HealthCheckSpecifier server_health_check_specifier_;
  ...
  envoy::service::discovery::v3alpha::HealthCheckSpecifier makeTcpHealthCheckSpecifier() {
    envoy::service::discovery::v3alpha::HealthCheckSpecifier server_health_check_specifier_;
    server_health_check_specifier_.mutable_interval()->set_nanos(100000000); // 0.1 seconds
  ...
  bool checkEndpointHealthResponse(envoy::service::discovery::v3alpha::EndpointHealth endpoint,
                                   envoy::api::v3alpha::core::HealthStatus healthy,
  ...
  void waitForEndpointHealthResponse(envoy::api::v3alpha::core::HealthStatus healthy) {
  ...
  envoy::service::discovery::v3alpha::HealthCheckRequestOrEndpointHealthResponse envoy_msg_;
  envoy::service::discovery::v3alpha::HealthCheckRequestOrEndpointHealthResponse response_;
  envoy::service::discovery::v3alpha::HealthCheckSpecifier server_health_check_specifier_;
};
...
TEST_P(HdsIntegrationTest, SingleEndpointHealthyHttp) {
  ...
  waitForEndpointHealthResponse(envoy::api::v3alpha::core::HEALTHY);
...
TEST_P(HdsIntegrationTest, SingleEndpointTimeoutHttp) {
  ...
  // Receive updates until the one we expect arrives
  waitForEndpointHealthResponse(envoy::api::v3alpha::core::TIMEOUT);
...
TEST_P(HdsIntegrationTest, SingleEndpointUnhealthyHttp) {
  ...
  // Receive updates until the one we expect arrives
  waitForEndpointHealthResponse(envoy::api::v3alpha::core::UNHEALTHY);
...
TEST_P(HdsIntegrationTest, TwoEndpointsSameLocality) {
  ...
  while (!(checkEndpointHealthResponse(response_.endpoint_health_response().endpoints_health(0),
           ...
           checkEndpointHealthResponse(response_.endpoint_health_response().endpoints_health(1),
                                       envoy::api::v3alpha::core::HEALTHY,
                                       host2_upstream_->localAddress()))) {
    ASSERT_TRUE(hds_stream_->waitForGrpcMessage(*dispatcher_, response_));
  }
...
TEST_P(HdsIntegrationTest, TestUpdateMessage) {
  ...
  envoy::service::discovery::v3alpha::HealthCheckSpecifier new_message;
