...
public:
  HdsIntegrationTest() : HttpIntegrationTest(Http::CodecClient::Type::HTTP1, GetParam(), realTime()) {}
  ...
  void initialize() override {
    ...
    host_upstream_.reset(new FakeUpstream(0, FakeHttpConnection::Type::HTTP1, version_, timeSystem()));
    host2_upstream_.reset(new FakeUpstream(0, FakeHttpConnection::Type::HTTP1, version_, timeSystem()));
  }
