...
TEST_P(UpstreamAccessLogTest, UpstreamFilterState) {
  ...
  config_helper_.addConfigModifier([](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
    ...
    static_cast<void>(inner_socket.mutable_typed_config()->PackFrom(raw_buffer_config));
    ...
    static_cast<void>(cluster_transport_socket->mutable_typed_config()->PackFrom(proto_config));
  });
