  ...
  config_source:
    api_config_source:
      ...
      grpc_services:
        envoy_grpc:
          cluster_name: xds_cluster
  default_resource_locator: "xdstp://test/envoy.config.route.v3.VirtualHost/my_route/*"
)EOF";
  ...
  config_source:
    api_config_source:
      ...
      grpc_services:
        envoy_grpc:
          cluster_name: xds_cluster
  default_resource_locator: "xdstp://test/envoy.config.route.v3.VirtualHost/default/*"
)EOF";
