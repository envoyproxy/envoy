...
const envoy::api::v2::RouteConfiguration RdsConfig = TestUtility::parseYaml<envoy::api::v2::RouteConfiguration>(R"EOF(
name: my_route
vhds:
  route_config_name: my_route
  config_source:
...
const int UpstreamIndex = 2;

class VhdsIntegrationTest : public HttpIntegrationTest, public Grpc::GrpcClientIntegrationParamTest {
public:
  VhdsIntegrationTest()
  ...
  envoy::api::v2::route::VirtualHost buildVirtualHost() {
    return TestUtility::parseYaml<envoy::api::v2::route::VirtualHost>(virtualHostYaml("vhost_0", "host"));
  }

  std::vector<envoy::api::v2::route::VirtualHost> buildVirtualHost1() {
    return {TestUtility::parseYaml<envoy::api::v2::route::VirtualHost>(virtualHostYaml("vhost_1", "vhost.first")),
            TestUtility::parseYaml<envoy::api::v2::route::VirtualHost>(virtualHostYaml("vhost_2", "vhost.second"))};
  }
...
*/
    ...
    EXPECT_TRUE(compareDiscoveryRequest(Config::TypeUrl::get().RouteConfiguration, "", {"my_route"}));
    sendDiscoveryResponse<envoy::api::v2::RouteConfiguration>(Config::TypeUrl::get().RouteConfiguration, {RdsConfig}, "1");
    ...
    sendDeltaDiscoveryResponse<envoy::api::v2::route::VirtualHost>({buildVirtualHost()}, {}, "1", vhds_stream_);
...
TEST_P(VhdsIntegrationTest, RdsVirtualHostAddUpdateRemove) {
  ...
  sendDeltaDiscoveryResponse<envoy::api::v2::route::VirtualHost>(buildVirtualHost1(), {}, "2", vhds_stream_);
  EXPECT_TRUE(compareDeltaDiscoveryRequest(Config::TypeUrl::get().VirtualHost, {}, {}, vhds_stream_));
  EXPECT_TRUE(compareDeltaDiscoveryRequest(Config::TypeUrl::get().VirtualHost, {}, {}, vhds_stream_));
  ...
  sendDeltaDiscoveryResponse<envoy::api::v2::route::VirtualHost>({}, {"vhost_1", "vhost_2"}, "3", vhds_stream_);
  EXPECT_TRUE(compareDeltaDiscoveryRequest(Config::TypeUrl::get().VirtualHost, {}, {}, vhds_stream_));
  EXPECT_TRUE(compareDeltaDiscoveryRequest(Config::TypeUrl::get().VirtualHost, {}, {}, vhds_stream_));
  ...
  EXPECT_TRUE(compareDeltaDiscoveryRequest(Config::TypeUrl::get().VirtualHost, {"vhost.first"}, {}, vhds_stream_));
  sendDeltaDiscoveryResponse<envoy::api::v2::route::VirtualHost>({buildVirtualHost2()}, {}, "4", vhds_stream_);
