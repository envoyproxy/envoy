...
public:
  ...
  MOCK_METHOD(const std::string&, sha256PeerCertificateChainDigests, (), (const));
  MOCK_METHOD(const std::string&, sha1PeerCertificateDigest, (), (const));
  MOCK_METHOD(const std::string&, sha1PeerCertificateChainDigests, (), (const));
  MOCK_METHOD(const std::string&, serialNumberPeerCertificate, (), (const));
  MOCK_METHOD(const std::string&, serialNumbersPeerCertificates, (), (const));
