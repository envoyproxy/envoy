...
class MockDownstreamCallbacks : public DownstreamCallbacks {
public:
  ~MockDownstreamCallbacks() override = default;
...
public:
  ...
  testing::NiceMock<MockDownstreamCallbacks> downstream_callbacks_;
