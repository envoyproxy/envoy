...
public:
  ...
  MOCK_METHOD(void, injectDecodedDataToFilterChain,
              (Buffer::Instance & data, bool end_stream, bool update_state_end_stream));
...
public:
  ...
  MOCK_METHOD(void, injectEncodedDataToFilterChain,
              (Buffer::Instance & data, bool end_stream, bool update_state_end_stream));
