...
public:
  ...
  MOCK_METHOD(Http::Status, encode100ContinueHeaders, (const ResponseHeaderMap& headers));
  MOCK_METHOD(Http::Status, encodeHeaders, (const ResponseHeaderMap& headers, bool end_stream));
