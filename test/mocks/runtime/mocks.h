...
public:
  ...
  MOCK_CONST_METHOD3(sampleFeatureEnabled,
                     bool(const std::string& key, uint64_t default_value, uint64_t num_buckets));
  MOCK_CONST_METHOD4(sampleFeatureEnabled, bool(const std::string& key, uint64_t default_value,
