...
public:
  ...
  MOCK_CONST_METHOD0(requestReceivedDuration, const absl::optional<std::chrono::microseconds>&());
  MOCK_METHOD1(requestReceivedDuration, void(MonotonicTime time));
  MOCK_CONST_METHOD0(responseReceivedDuration, const absl::optional<std::chrono::microseconds>&());
  MOCK_METHOD1(responseReceivedDuration, void(MonotonicTime time));
  MOCK_CONST_METHOD0(bytesReceived, uint64_t());
  MOCK_CONST_METHOD0(protocol, const absl::optional<Http::Protocol>&());
