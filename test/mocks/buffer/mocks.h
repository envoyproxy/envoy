...
public:
  ...
  MOCK_METHOD(void, unregisterAccount, (const Buffer::BufferMemoryAccountSharedPtr&));
  MOCK_METHOD(void, onAccountBalanceUpdate,
              (const Buffer::BufferMemoryAccountSharedPtr&, uint64_t));
};
