...
public:
  ...
  MOCK_METHOD1(sendParentAdminShutdownRequest, void(SystemTime& original_start_time));
...
public:
  ...
  MOCK_METHOD0(startTimeCurrentEpoch, SystemTime());
  MOCK_METHOD0(startTimeFirstEpoch, SystemTime());
