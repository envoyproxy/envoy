...
public:
  ...
  MOCK_METHOD1(sendParentAdminShutdownRequest, void(MonotonicTime& original_start_time));
...
public:
  ...
  MOCK_METHOD0(startTimeCurrentEpoch, MonotonicTime());
  MOCK_METHOD0(startTimeFirstEpoch, MonotonicTime());
