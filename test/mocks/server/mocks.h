...
public:
  ...
  MOCK_METHOD1(createLdsApi_, LdsApi*(const envoy::api::v3alpha::core::ConfigSource& lds_config));
  ...
  MOCK_METHOD1(createDrainManager_,
               DrainManager*(envoy::api::v3alpha::Listener::DrainType drain_type));
...
public:
  ...
  MOCK_METHOD3(addOrUpdateListener, bool(const envoy::api::v3alpha::Listener& config,
                                         const std::string& version_info, bool modifiable));
  MOCK_METHOD1(createLdsApi, void(const envoy::api::v3alpha::core::ConfigSource& lds_config));
...
public:
  ...
  MOCK_CONST_METHOD0(localInfo, const LocalInfo::LocalInfo&());
  MOCK_CONST_METHOD0(listenerMetadata, const envoy::api::v3alpha::core::Metadata&());
  MOCK_CONST_METHOD0(direction, envoy::api::v3alpha::core::TrafficDirection());
  MOCK_METHOD0(timeSource, TimeSource&());
  Event::TestTimeSystem& timeSystem() { return time_system_; }
