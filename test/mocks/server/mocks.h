...
public:
  ...
  MOCK_METHOD0(httpRouteManager, Router::ServerHttpRouteManager&());
  ...
  testing::NiceMock<Router::MockHttpRouteManager> http_route_manager_;
...
public:
  ...
  MOCK_METHOD0(threadLocal, ThreadLocal::Instance&());
  MOCK_METHOD0(httpRouteManager, Router::HttpRouteManager&());
