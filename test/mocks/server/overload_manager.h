...
public:
  ...
  MOCK_METHOD(bool, tryAllocateResource, (OverloadProactiveResourceName, uint64_t));
  MOCK_METHOD(bool, tryDeallocateResource, (OverloadProactiveResourceName, uint64_t));
