...
public:
  ...
  MOCK_METHOD(void, setTerminationDetails, (std::string));
  ...
  MOCK_METHOD(const absl::optional<std::string>&, terminationDetails, (), (const));
  ...
  absl::optional<std::string> termination_details_;
