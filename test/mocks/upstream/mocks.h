...
public:
  ...
  MOCK_METHOD4(clusterFromProto,
               std::pair<ClusterSharedPtr, ThreadAwareLoadBalancerPtr>(
                   const envoy::api::v3alpha::Cluster& cluster, ClusterManager& cm,
                   Outlier::EventLoggerSharedPtr outlier_event_logger, bool added_via_api));

  MOCK_METHOD2(createCds, CdsApiPtr(const envoy::api::v3alpha::core::ConfigSource& cds_config,
                                    ClusterManager& cm));
...
public:
  ...
  MOCK_METHOD2(addOrUpdateCluster,
               bool(const envoy::api::v3alpha::Cluster& cluster, const std::string& version_info));
  ...
  MOCK_CONST_METHOD0(bindConfig, const envoy::api::v3alpha::core::BindConfig&());
  ...
  envoy::api::v3alpha::core::BindConfig bind_config_;
