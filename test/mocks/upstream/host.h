...
public:
  ...
  MOCK_CONST_METHOD0(metadata, const std::shared_ptr<envoy::api::v3alpha::core::Metadata>());
  MOCK_METHOD1(metadata, void(const envoy::api::v3alpha::core::Metadata&));
  ...
  MOCK_CONST_METHOD0(locality, const envoy::api::v3alpha::core::Locality&());
