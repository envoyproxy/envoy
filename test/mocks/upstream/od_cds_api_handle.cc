...
MockOdCdsApiHandle::MockOdCdsApiHandle() {
  ON_CALL(*this, requestOnDemandClusterDiscovery(_, _)).WillByDefault(Invoke(
      [](const std::string&, ClusterDiscoveryCallbackWeakPtr) -> ClusterDiscoveryCallbackHandlePtr {
