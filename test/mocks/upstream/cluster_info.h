...
public:
  ...
  MOCK_CONST_METHOD0(fallbackPolicy,
                     envoy::api::v3alpha::Cluster::LbSubsetConfig::LbSubsetFallbackPolicy());
...
public:
  ...
  MOCK_CONST_METHOD0(lbConfig, const envoy::api::v3alpha::Cluster::CommonLbConfig&());
  MOCK_CONST_METHOD0(lbType, LoadBalancerType());
  MOCK_CONST_METHOD0(type, envoy::api::v3alpha::Cluster::DiscoveryType());
  MOCK_CONST_METHOD0(clusterType,
                     const absl::optional<envoy::api::v3alpha::Cluster::CustomClusterType>&());
  MOCK_CONST_METHOD0(lbRingHashConfig,
                     const absl::optional<envoy::api::v3alpha::Cluster::RingHashLbConfig>&());
  MOCK_CONST_METHOD0(lbLeastRequestConfig,
                     const absl::optional<envoy::api::v3alpha::Cluster::LeastRequestLbConfig>&());
  MOCK_CONST_METHOD0(lbOriginalDstConfig,
                     const absl::optional<envoy::api::v3alpha::Cluster::OriginalDstLbConfig>&());
  ...
  MOCK_CONST_METHOD0(metadata, const envoy::api::v3alpha::core::Metadata&());
  ...
  envoy::api::v3alpha::Cluster::DiscoveryType type_{envoy::api::v3alpha::Cluster::STRICT_DNS};
  absl::optional<envoy::api::v3alpha::Cluster::CustomClusterType> cluster_type_;
  NiceMock<MockLoadBalancerSubsetInfo> lb_subset_;
  absl::optional<envoy::api::v3alpha::Cluster::RingHashLbConfig> lb_ring_hash_config_;
  absl::optional<envoy::api::v3alpha::Cluster::OriginalDstLbConfig> lb_original_dst_config_;
  Network::ConnectionSocket::OptionsSharedPtr cluster_socket_options_;
  envoy::api::v3alpha::Cluster::CommonLbConfig lb_config_;
