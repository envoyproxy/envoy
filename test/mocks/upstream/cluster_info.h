...
public:
  ...
  MOCK_METHOD(LazyInitStats<ClusterUpstreamStats>&, upstreamStats, (), (const));
  ...
  ClusterUpstreamStatNames upstream_stat_names_;
  ...
  LazyInitStats<ClusterUpstreamStats> upstream_stats_;
