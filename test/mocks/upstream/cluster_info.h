...
public:
  ...
  MOCK_CONST_METHOD0(timeoutBudgetStats, ClusterTimeoutBudgetStats&());
  ...
  MOCK_CONST_METHOD0(trackTimeoutBudgets, bool());
  ...
  ClusterTimeoutBudgetStats timeout_budget_stats_;
