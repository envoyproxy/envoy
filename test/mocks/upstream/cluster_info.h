...
public:
  ...
  MOCK_METHOD(OptRef<const ClusterInfo::PendingRqQueuePolicy>, pendingRqQueuePolicy, (), (const));
  ...
  std::unique_ptr<ClusterInfo::PendingRqQueuePolicy> pending_rq_queue_policy_;
