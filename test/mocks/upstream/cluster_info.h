...
public:
  ...
  MOCK_METHOD(const envoy::config::cluster::v3::Cluster::HappyEyeballsConfig, happyEyeballsConfig,
              (), (const));
  ...
  envoy::config::cluster::v3::Cluster::HappyEyeballsConfig happy_eyeballs_config_;
};
