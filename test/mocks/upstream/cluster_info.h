...
public:
  ...
  MOCK_METHOD(OptRef<const envoy::config::core::v3::TypedExtensionConfig>, queuePolicyConfig, (),
              (const));
  ...
  std::unique_ptr<envoy::config::core::v3::TypedExtensionConfig> queue_policy_config_;
