...
public:
  ...
  MOCK_METHOD(CounterOptRef, findCounter, (StatName), (const));
  MOCK_METHOD(GaugeOptRef, findGauge, (StatName), (const));
  MOCK_METHOD(HistogramOptRef, findHistogram, (StatName), (const));
