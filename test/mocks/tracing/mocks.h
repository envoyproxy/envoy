...
public:
  ...
  MOCK_METHOD(void, injectContext, (TracingContext & tracing_context));
...
public:
  ...
  SpanPtr startSpan(const Config& config, TracingContext& tracing_context,
                    const std::string& operation_name, SystemTime start_time,
                    const Tracing::Decision tracing_decision) override {
    return SpanPtr{
        startSpan_(config, tracing_context, operation_name, start_time, tracing_decision)};
  }
