...
protected:
  ...
  void SetupForDeath() {
    ...
    unpet_dog_ = guard_dog_->createWatchDog(*api_);
  ...
  void SetupForMultiDeath() {
    ...
    auto unpet_dog_ = guard_dog_->createWatchDog(*api_);
    guard_dog_->forceCheckForTest();
    auto second_dog_ = guard_dog_->createWatchDog(*api_);
    guard_dog_->forceCheckForTest();
...
TEST_F(GuardDogAlmostDeadTest, NearDeathTest) {
  ...
  auto unpet_dog = gd.createWatchDog(*api_);
  auto pet_dog = gd.createWatchDog(*api_);
...
TEST_F(GuardDogMissTest, MissCountTest) {
  ...
  GuardDogImpl gd(stats_store_, config_miss_, time_system_, *api_);
  auto sometimes_pet_dog = gd.createWatchDog(*api_);
