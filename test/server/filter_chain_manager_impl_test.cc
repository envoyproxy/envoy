...
class MockFilterChainFactoryBuilder : public FilterChainFactoryBuilder {
  ...
  buildFilterChain(const envoy::api::v3alpha::listener::FilterChain&) const override {
...
public:
  ...
  void addSingleFilterChainHelper(const envoy::api::v3alpha::listener::FilterChain& filter_chain) {
    filter_chain_manager_.addFilterChain(
        std::vector<const envoy::api::v3alpha::listener::FilterChain*>{&filter_chain},
  ...
  envoy::api::v3alpha::listener::FilterChain filter_chain_template_;
