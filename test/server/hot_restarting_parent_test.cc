...
TEST_F(HotRestartingParentTest, RetainDynamicStats) {
  ...
  HotRestartMessage::Reply::Stats stats_proto;
  {
    ...
    parent_store.rootScope()->gaugeFromStatName(dynamic.add("g2"), Stats::Gauge::ImportMode::Accumulate).set(42);
...

  {
    ...
    Stats::Gauge& g2 =
        child_store.rootScope()->gaugeFromStatName(dynamic.add("g2"), Stats::Gauge::ImportMode::Accumulate);
