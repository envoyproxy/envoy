...
protected:
  ...
  void testWithUpdateListenerWithBuildInSocketOptions(const std::string& origin,
                                                      const std::string& updated,
                                                      const std::string& expect_error_mesage) {
    InSequence s;
    ...
    ListenerHandle* listener_update = expectListenerCreate(true, true);
    EXPECT_CALL(*listener_update, onDestroy());
