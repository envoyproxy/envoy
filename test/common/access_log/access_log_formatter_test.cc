...
TEST(AccessLogFormatterTest, requestInfoFormatter) {
...

  {
    ...
    absl::optional<std::chrono::microseconds> duration{std::chrono::microseconds(5000)};
  ...
  {
    RequestInfoFormatter request_duration_format("REQUEST_DURATION");
    absl::optional<std::chrono::microseconds> duration;
    EXPECT_CALL(request_info, requestReceivedDuration()).WillOnce(ReturnRef(duration));
...

  {
    ...
    absl::optional<std::chrono::microseconds> duration{std::chrono::microseconds(10000)};
