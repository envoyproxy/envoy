...
#include "envoy/config/accesslog/v3alpha/accesslog.pb.validate.h"
...
envoy::config::accesslog::v3alpha::AccessLog parseAccessLogFromV2Yaml(const std::string& yaml) {
  envoy::config::accesslog::v3alpha::AccessLog access_log;
...
duration_filter:
  ...
  envoy::config::accesslog::v3alpha::AccessLogFilter config;
...
typed_config:
  ...
  const auto desc = envoy::config::accesslog::v3alpha::GrpcStatusFilter::Status_descriptor();
...
public:
  ...
  FilterPtr createFilter(const envoy::config::accesslog::v3alpha::ExtensionFilter& config,
    ...
    const auto& header_config =
        TestUtility::downcastAndValidate<const envoy::config::accesslog::v3alpha::HeaderFilter&>(
            *factory_config);
    return std::make_unique<HeaderFilter>(header_config);
  }

  ProtobufTypes::MessagePtr createEmptyConfigProto() override {
    return std::make_unique<envoy::config::accesslog::v3alpha::HeaderFilter>();
  }
