...
typed_config:
  ...
  const int grpcStatuses = static_cast<int>(Grpc::Status::GrpcStatusMapping::MaximumValid) + 1;
...
typed_config:
  ...
  for (int i = 0; i <= static_cast<int>(Grpc::Status::GrpcStatusMapping::MaximumValid); i++) {
