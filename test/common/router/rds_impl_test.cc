  ...
  const std::string response1_json = R"EOF(
{
  ...
  auto response1 = TestUtility::parseYaml<envoy::api::v3alpha::DiscoveryResponse>(response1_json);
  ...
  const std::string response2_json = R"EOF(
{
  ...
  auto response2 = TestUtility::parseYaml<envoy::api::v3alpha::DiscoveryResponse>(response2_json);
...
TEST_F(RdsRouteConfigSubscriptionTest, CreatesNoopInitManager) {
  ...
  const auto rds =
      TestUtility::parseYaml<envoy::config::filter::network::http_connection_manager::v3alpha::Rds>(
          rds_config);
...
public:
  ...
  envoy::config::filter::network::http_connection_manager::v3alpha::Rds rds_;
  std::unique_ptr<RouteConfigProviderManagerImpl> route_config_provider_manager_;
...
virtual_hosts:
  ...
  envoy::config::filter::network::http_connection_manager::v3alpha::Rds rds2;
