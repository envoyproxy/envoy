...
#include "envoy/api/v3alpha/route/route.pb.validate.h"
...
envoy::api::v3alpha::route::RateLimit parseRateLimitFromV2Yaml(const std::string& yaml_string) {
  envoy::api::v3alpha::route::RateLimit rate_limit;
...
public:
  void setupTest(const std::string& yaml) {
    envoy::api::v3alpha::RouteConfiguration route_config;
