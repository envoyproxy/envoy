...
cleanRouteConfig(envoy::api::v3alpha::RouteConfiguration route_config) {
  ...
  // headers.
  envoy::api::v3alpha::RouteConfiguration clean_config =
      replaceInvalidHeaders<envoy::api::v3alpha::RouteConfiguration>(route_config);
  ...
  std::for_each(
      ...
      [](envoy::api::v3alpha::route::VirtualHost& virtual_host) {
        ...
        virtual_host = replaceInvalidHeaders<envoy::api::v3alpha::route::VirtualHost>(virtual_host);
        ...
        for (int i = 0; i < routes->size();) {
          ...
          if (routes->Get(i).match().path_specifier_case() ==
              envoy::api::v3alpha::route::RouteMatch::PathSpecifierCase::
