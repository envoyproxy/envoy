...
TEST_F(ScopedRouteInfoTest, Hash) {
  ...
  auto info2 = std::make_unique<ScopedRouteInfo>(scoped_route_config_, route_config_);
  ...
  auto info3 = std::make_unique<ScopedRouteInfo>(scoped_route_config_, route_config_);
