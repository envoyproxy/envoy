...
TEST_F(ScopedConfigImplTest, PickRoute) {
  ...
  ConfigConstSharedPtr route_config =
      scoped_config_impl_->getRouteConfig(scoped_key_builder_impl_->computeScopeKey(TestRequestHeaderMapImpl{
...
TEST_F(ScopedConfigImplTest, Update) {
  ...
  // Empty ScopeConfig.
  EXPECT_EQ(scoped_config_impl_->getRouteConfig(scoped_key_builder_impl_->computeScopeKey(headers)), nullptr);
  ...
  EXPECT_EQ(scoped_config_impl_->getRouteConfig(scoped_key_builder_impl_->computeScopeKey(headers)), nullptr);
  // scope_info_b_ found
  EXPECT_EQ(scoped_config_impl_->getRouteConfig(scoped_key_builder_impl_->computeScopeKey(TestRequestHeaderMapImpl{
  ...
  scoped_config_impl_->addOrUpdateRoutingScopes({scope_info_a_});
  // Found scope_info_a_.
  EXPECT_EQ(scoped_config_impl_->getRouteConfig(scoped_key_builder_impl_->computeScopeKey(headers)), scope_info_a_->routeConfig());
