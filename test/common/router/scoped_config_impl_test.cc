...
public:
  ...
  envoy::api::v3alpha::RouteConfiguration route_configuration_;
  envoy::api::v3alpha::ScopedRouteConfiguration scoped_route_config_;
  std::shared_ptr<MockConfig> route_config_;
  std::unique_ptr<ScopedRouteInfo> info_;
};

TEST_F(ScopedRouteInfoTest, Creation) {
  envoy::api::v3alpha::ScopedRouteConfiguration config_copy = scoped_route_config_;
...
public:
  ...
  std::shared_ptr<ScopedRouteInfo> makeScopedRouteInfo(const std::string& route_config_yaml) {
    envoy::api::v3alpha::ScopedRouteConfiguration scoped_route_config;
