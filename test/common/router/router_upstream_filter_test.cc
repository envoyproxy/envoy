...
TEST_F(RouterUpstreamFilterTest, UpstreamFilter) {
  ...
  static_cast<void>(add_header_filter.mutable_typed_config()->PackFrom(add_header_config));
  ...
  static_cast<void>(codec_filter.mutable_typed_config()->PackFrom(upstream_codec_config));
