...
static envoy::api::v3alpha::route::Route parseRouteFromV2Yaml(const std::string& yaml) {
...
TEST_F(StreamInfoHeaderFormatterTest, TestFormatWithUpstreamMetadataVariable) {
  ...
  auto metadata = std::make_shared<envoy::api::v3alpha::core::Metadata>(
      TestUtility::parseYaml<envoy::api::v3alpha::core::Metadata>(
          R"EOF(
        filter_metadata:
          namespace:
            key: value
...
TEST_F(StreamInfoHeaderFormatterTest, ValidateLimitsOnUserDefinedHeaders) {
  {
    envoy::api::v3alpha::RouteConfiguration route;
    envoy::api::v3alpha::core::HeaderValueOption* header =
...
TEST(HeaderParserTest, TestParseInternal) {
  ...
  for (const auto& test_case : test_cases) {
    Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HeaderValueOption> to_add;
    envoy::api::v3alpha::core::HeaderValueOption* header = to_add.Add();
...
request_headers_to_add:
  ...
  // Disable append mode.
  envoy::api::v3alpha::route::Route route = parseRouteFromV2Yaml(ymal);
