...
protected:
  ...
  // healthcheck
  envoy::service::discovery::v3alpha::HealthCheckSpecifier* createSimpleMessage() {
    envoy::service::discovery::v3alpha::HealthCheckSpecifier* msg =
        new envoy::service::discovery::v3alpha::HealthCheckSpecifier;
...
TEST_F(HdsTest, HealthCheckRequest) {
  envoy::service::discovery::v3alpha::HealthCheckRequestOrEndpointHealthResponse request;
  ...
  request.mutable_health_check_request()->mutable_capability()->add_health_check_protocols(
      envoy::service::discovery::v3alpha::Capability::HTTP);
  request.mutable_health_check_request()->mutable_capability()->add_health_check_protocols(
      envoy::service::discovery::v3alpha::Capability::TCP);
...
TEST_F(HdsTest, TestProcessMessageEndpoints) {
  ...
  message = std::make_unique<envoy::service::discovery::v3alpha::HealthCheckSpecifier>();
...
TEST_F(HdsTest, TestSendResponseOneEndpointTimeout) {
  ...
  EXPECT_EQ(msg.endpoint_health_response().endpoints_health(0).health_status(),
            envoy::api::v3alpha::core::UNHEALTHY);
