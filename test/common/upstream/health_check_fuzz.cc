...
static std::vector<uint8_t>
    GrpcHealthCheckFuzz::serializeResponse(grpc::health::v1::HealthCheckResponse::ServingStatus status) {
...
void GrpcHealthCheckFuzz::respondBytes(
  ...
  //Fuzzed response vvv (will use serializeResponse)
  ...
  //Arbitrarily Generated bytes vvv
  Buffer::OwnedImpl response;
