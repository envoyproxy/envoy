...
TEST_F(ClusterInfoImplTest, TestNoSocketOptionsDefault) {
  auto cluster = makeCluster(strictDnsClusterWithAttrJson(""));
...
TEST_F(ClusterInfoImplTest, TestMarkSocketOptions) {
  auto cluster = makeCluster(strictDnsClusterWithAttrJson(R"EOF("mark": 145)EOF"));
  auto options = cluster->info()->clusterSocketOptions();
...
TEST_F(ClusterInfoImplTest, TestTransparentSocketOptions) {
  auto cluster = makeCluster(strictDnsClusterWithAttrJson(R"EOF("src_transparent": true)EOF"));
  auto options = cluster->info()->clusterSocketOptions();
