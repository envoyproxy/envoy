...
public:
  ...
  void expectSendMessage(
      const std::vector<envoy::api::v3alpha::endpoint::ClusterStats>& expected_cluster_stats) {
...
TEST_F(LoadStatsReporterTest, ExistingClusters) {
  ...
  {
    envoy::api::v3alpha::endpoint::ClusterStats foo_cluster_stats;
  ...
  time_system_.setMonotonicTime(std::chrono::microseconds(28));
  {
    ...
    envoy::api::v3alpha::endpoint::ClusterStats bar_cluster_stats;
