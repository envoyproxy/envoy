...
TEST_P(LeastRequestLoadBalancerTest, PNC) {
  ...
  envoy::api::v3alpha::Cluster::LeastRequestLbConfig lr_lb_config;
...
TEST(LoadBalancerSubsetInfoImplTest, DefaultConfigIsDiabled) {
  auto subset_info =
      LoadBalancerSubsetInfoImpl(envoy::api::v3alpha::Cluster::LbSubsetConfig::default_instance());

  EXPECT_FALSE(subset_info.isEnabled());
  EXPECT_TRUE(subset_info.fallbackPolicy() ==
              envoy::api::v3alpha::Cluster::LbSubsetConfig::NO_FALLBACK);
...
TEST(LoadBalancerSubsetInfoImplTest, SubsetConfig) {
  ...
  auto subset_config = envoy::api::v3alpha::Cluster::LbSubsetConfig::default_instance();
  subset_config.set_fallback_policy(envoy::api::v3alpha::Cluster::LbSubsetConfig::DEFAULT_SUBSET);
  ...
  EXPECT_TRUE(subset_info.fallbackPolicy() ==
              envoy::api::v3alpha::Cluster::LbSubsetConfig::DEFAULT_SUBSET);
