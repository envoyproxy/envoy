...
inline envoy::api::v3alpha::Cluster parseClusterFromV2Json(const std::string& json_string) {
  envoy::api::v3alpha::Cluster cluster;
  TestUtility::loadFromJson(json_string, cluster);
  return cluster;
}

inline envoy::api::v3alpha::Cluster parseClusterFromV2Yaml(const std::string& yaml) {
  envoy::api::v3alpha::Cluster cluster;
  TestUtility::loadFromYaml(yaml, cluster);
  return cluster;
}

inline envoy::api::v3alpha::Cluster defaultStaticCluster(const std::string& name) {
...
inline HostSharedPtr makeTestHost(ClusterInfoConstSharedPtr cluster, const std::string& url,
  ...
  return HostSharedPtr{
      new HostImpl(cluster, "", Network::Utility::resolveUrl(url),
                   envoy::api::v3alpha::core::Metadata::default_instance(), weight,
                   envoy::api::v3alpha::core::Locality(),
                   envoy::api::v3alpha::endpoint::Endpoint::HealthCheckConfig::default_instance(),
                   0, envoy::api::v3alpha::core::UNKNOWN)};
}
...
makeTestHost(ClusterInfoConstSharedPtr cluster, const std::string& url,
  ...
  return HostSharedPtr{new HostImpl(cluster, "", Network::Utility::resolveUrl(url),
                                    envoy::api::v3alpha::core::Metadata::default_instance(), weight,
                                    envoy::api::v3alpha::core::Locality(), health_check_config, 0,
...
inline HostDescriptionConstSharedPtr makeTestHostDescription(ClusterInfoConstSharedPtr cluster,
  ...
  return HostDescriptionConstSharedPtr{new HostDescriptionImpl(
      ...
      envoy::api::v3alpha::core::Metadata::default_instance(),
...
inline envoy::api::v3alpha::core::HealthCheck
