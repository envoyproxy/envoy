...
TEST_P(HttpProtocolIntegrationTest, CustomUpstreamLocalAddressSelector) {
  ...
  config_helper_.addConfigModifier([](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
    ...
    static_cast<void>(local_address_selector_config->mutable_typed_config()->PackFrom(empty));
...
TEST_P(HttpProtocolIntegrationTest, BindConfigOverride) {
  ...
  config_helper_.addConfigModifier([this, port_value_0 = port_value_0, port_value_1 = port_value_1](
    ...
    static_cast<void>(bootstrap_address_selector_config->mutable_typed_config()->PackFrom(config));
    ...
    static_cast<void>(address_selector_config->mutable_typed_config()->PackFrom(empty));
