...
protected:
  void setup() {
    envoy::api::v3alpha::core::ConfigSource cds_config;
...
- "@type": type.googleapis.com/envoy.api.v2.Cluster
  ...
  auto response1 = TestUtility::parseYaml<envoy::api::v3alpha::DiscoveryResponse>(response1_yaml);
...
resources:
  ...
  auto response2 = TestUtility::parseYaml<envoy::api::v3alpha::DiscoveryResponse>(response2_yaml);
...
TEST_F(CdsApiImplTest, ValidateDuplicateClusters) {
  ...
  Protobuf::RepeatedPtrField<ProtobufWkt::Any> clusters;
  envoy::api::v3alpha::Cluster cluster_1;
...
TEST_F(CdsApiImplTest, ConfigUpdateWith2ValidClusters) {
  ...
  envoy::api::v3alpha::Cluster cluster_2;
...
TEST_F(CdsApiImplTest, ConfigUpdateAddsSecondClusterEvenIfFirstThrows) {
  ...
  envoy::api::v3alpha::Cluster cluster_3;
