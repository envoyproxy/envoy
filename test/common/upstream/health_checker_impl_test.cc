...
#include "envoy/api/v3alpha/core/health_check.pb.validate.h"
...
envoy::api::v3alpha::core::HealthCheck createGrpcHealthCheckConfig() {
  envoy::api::v3alpha::core::HealthCheck health_check;
...
public:
  ...
  using HostWithHealthCheckMap =
      std::unordered_map<std::string,
                         const envoy::api::v3alpha::endpoint::Endpoint::HealthCheckConfig>;
  ...
  makeHealthCheckConfig(const uint32_t port_value) {
    envoy::api::v3alpha::endpoint::Endpoint::HealthCheckConfig config;
...
TEST_F(HttpHealthCheckerImplTest, SuccessServiceCheckWithAdditionalHeaders) {
  ...
  EXPECT_CALL(*this, onHostStatus(_, HealthTransition::Unchanged)).Times(1);
  auto metadata = TestUtility::parseYaml<envoy::api::v3alpha::core::Metadata>(
      R"EOF(
        filter_metadata:
          namespace:
            key: value
...
TEST(TcpHealthCheckMatcher, loadJsonBytes) {
  {
    Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HealthCheck::Payload> repeated_payload;
