...
protected:
  ...
  envoy::api::v3alpha::Cluster eds_cluster_;
...
protected:
  ...
  envoy::api::v3alpha::ClusterLoadAssignment cluster_load_assignment_;
};
...
TEST_F(EdsTest, EndpointHealthStatus) {
  ...
  const std::vector<std::pair<envoy::api::v3alpha::core::HealthStatus, Host::Health>>
      health_status_expected = {
          {envoy::api::v3alpha::core::UNKNOWN, Host::Health::Healthy},
          {envoy::api::v3alpha::core::HEALTHY, Host::Health::Healthy},
          {envoy::api::v3alpha::core::UNHEALTHY, Host::Health::Unhealthy},
          {envoy::api::v3alpha::core::DRAINING, Host::Health::Unhealthy},
          {envoy::api::v3alpha::core::TIMEOUT, Host::Health::Unhealthy},
          {envoy::api::v3alpha::core::DEGRADED, Host::Health::Degraded},
      };
  ...
  endpoints->mutable_lb_endpoints(0)->set_health_status(envoy::api::v3alpha::core::UNHEALTHY);
  doOnConfigUpdateVerifyNoThrow(cluster_load_assignment);
  {
    auto& hosts = cluster_->prioritySet().hostSetsPerPriority()[0]->hosts();
    EXPECT_EQ(hosts.size(), health_status_expected.size());
  ...
  endpoints->mutable_lb_endpoints(health_status_expected.size() - 1)
      ->set_health_status(envoy::api::v3alpha::core::HEALTHY);
  doOnConfigUpdateVerifyNoThrow(cluster_load_assignment);
  {
    auto& hosts = cluster_->prioritySet().hostSetsPerPriority()[0]->hosts();
    EXPECT_EQ(hosts.size(), health_status_expected.size());
  ...
  endpoints->mutable_lb_endpoints(0)->set_health_status(envoy::api::v3alpha::core::HEALTHY);
  doOnConfigUpdateVerifyNoThrow(cluster_load_assignment);
  {
    auto& hosts = cluster_->prioritySet().hostSetsPerPriority()[0]->hosts();
    EXPECT_EQ(Host::Health::Unhealthy, hosts[0]->health());
  ...
  endpoints->mutable_lb_endpoints(0)->set_health_status(envoy::api::v3alpha::core::DEGRADED);
  doOnConfigUpdateVerifyNoThrow(cluster_load_assignment);
  {
    auto& hosts = cluster_->prioritySet().hostSetsPerPriority()[0]->hosts();
...
TEST_F(EdsAssignmentTimeoutTest, AssignmentTimeoutEnableDisable) {
  ...
  envoy::api::v3alpha::ClusterLoadAssignment cluster_load_assignment_lease =
