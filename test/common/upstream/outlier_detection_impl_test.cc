...
public:
  ...
  envoy::api::v3alpha::cluster::OutlierDetection empty_outlier_detection_;
  envoy::api::v3alpha::cluster::OutlierDetection outlier_detection_split_;
...
failure_percentage_threshold: 70
  ...
  envoy::api::v3alpha::cluster::OutlierDetection outlier_detection;
