...
public:
  ...
  void fillServiceWideInitialMetadata(envoy::api::v3alpha::core::GrpcService& config) {
  ...
  virtual envoy::api::v3alpha::core::GrpcService createGoogleGrpcConfig() {
    envoy::api::v3alpha::core::GrpcService config;
  ...
  envoy::api::v3alpha::core::Locality host_locality_;
