...
TEST(UtilityTest, ConfigSourceDefaultInitFetchTimeout) {
  envoy::api::v3alpha::core::ConfigSource config_source;
...
TEST(UtilityTest, TranslateApiConfigSource) {
  envoy::api::v3alpha::core::ApiConfigSource api_config_source_rest_legacy;
  ...
  EXPECT_EQ(
      envoy::api::v3alpha::core::ApiConfigSource::hidden_envoy_deprecated_UNSUPPORTED_REST_LEGACY,
  ...
  envoy::api::v3alpha::core::ApiConfigSource api_config_source_rest;
  Utility::translateApiConfigSource("test_rest_cluster", 20000, ApiType::get().Rest,
                                    api_config_source_rest);
  EXPECT_EQ(envoy::api::v3alpha::core::ApiConfigSource::REST, api_config_source_rest.api_type());
  ...
  envoy::api::v3alpha::core::ApiConfigSource api_config_source_grpc;
  Utility::translateApiConfigSource("test_grpc_cluster", 30000, ApiType::get().Grpc,
                                    api_config_source_grpc);
  EXPECT_EQ(envoy::api::v3alpha::core::ApiConfigSource::GRPC, api_config_source_grpc.api_type());
...
TEST(UtilityTest, ParseRateLimitSettings) {
  envoy::api::v3alpha::core::ApiConfigSource api_config_source;
  envoy::api::v3alpha::core::RateLimitSettings* rate_limits =
      api_config_source.mutable_rate_limit_settings();
...
TEST(UtilityTest, FactoryForGrpcApiConfigSource) {
  ...
  {
    envoy::api::v3alpha::core::ApiConfigSource api_config_source;
    api_config_source.set_api_type(envoy::api::v3alpha::core::ApiConfigSource::REST);
...

  {
    ...
    api_config_source.set_api_type(envoy::api::v3alpha::core::ApiConfigSource::GRPC);
    api_config_source.add_grpc_services()->mutable_envoy_grpc()->set_cluster_name("foo");
    envoy::api::v3alpha::core::GrpcService expected_grpc_service;
...
TEST(UtilityTest, TypedStructToBootstrap) {
  ...
  envoy::config::bootstrap::v3alpha::Bootstrap out;
  Utility::translateOpaqueConfig("", typed_config, ProtobufWkt::Struct(),
                                 ProtobufMessage::getStrictValidationVisitor(), out);
...
TEST(CheckApiConfigSourceSubscriptionBackingClusterTest, GrpcClusterTestAcrossTypes) {
  envoy::api::v3alpha::core::ConfigSource config;
  ...
  EXPECT_CALL(*cluster.info_, type()).WillOnce(Return(envoy::api::v3alpha::Cluster::EDS));
  EXPECT_THROW_WITH_MESSAGE(
      Utility::checkApiConfigSourceSubscriptionBackingCluster(cluster_map, *api_config_source),
      EnvoyException,
      "envoy::api::v2::core::ConfigSource must have a statically defined non-EDS cluster: "
