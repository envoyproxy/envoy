...
TEST(UtilityTest, TranslateApiConfigSource) {
  envoy::config::core::v3alpha::ApiConfigSource api_config_source_rest_legacy;
  ...
  EXPECT_EQ(envoy::config::core::v3alpha::ApiConfigSource::
  ...
  envoy::config::core::v3alpha::ApiConfigSource api_config_source_rest;
  Utility::translateApiConfigSource("test_rest_cluster", 20000, ApiType::get().Rest,
                                    api_config_source_rest);
  EXPECT_EQ(envoy::config::core::v3alpha::ApiConfigSource::REST, api_config_source_rest.api_type());
  ...
  envoy::config::core::v3alpha::ApiConfigSource api_config_source_grpc;
  Utility::translateApiConfigSource("test_grpc_cluster", 30000, ApiType::get().Grpc,
                                    api_config_source_grpc);
  EXPECT_EQ(envoy::config::core::v3alpha::ApiConfigSource::GRPC, api_config_source_grpc.api_type());
...
TEST(UtilityTest, ParseRateLimitSettings) {
  envoy::config::core::v3alpha::ApiConfigSource api_config_source;
  envoy::config::core::v3alpha::RateLimitSettings* rate_limits =
      api_config_source.mutable_rate_limit_settings();
...
TEST(UtilityTest, FactoryForGrpcApiConfigSource) {
  ...
  {
    envoy::config::core::v3alpha::ApiConfigSource api_config_source;
    api_config_source.set_api_type(envoy::config::core::v3alpha::ApiConfigSource::GRPC);
  ...
  {
    envoy::config::core::v3alpha::ApiConfigSource api_config_source;
    api_config_source.set_api_type(envoy::config::core::v3alpha::ApiConfigSource::REST);
...

  {
    ...
    api_config_source.set_api_type(envoy::config::core::v3alpha::ApiConfigSource::GRPC);
    api_config_source.add_grpc_services()->mutable_envoy_grpc()->set_cluster_name("foo");
    envoy::config::core::v3alpha::GrpcService expected_grpc_service;
...
TEST(UtilityTest, StructToClusterV3) {
  ProtobufWkt::Any typed_config;
  API_NO_BOOST(envoy::config::cluster::v3alpha::Cluster) cluster;
  ProtobufWkt::Struct cluster_struct;
  const std::string cluster_config_yaml = R"EOF(
  ...
  {
    API_NO_BOOST(envoy::config::cluster::v3alpha::Cluster) out;
    Utility::translateOpaqueConfig({}, cluster_struct, ProtobufMessage::getNullValidationVisitor(),
                                   out);
    EXPECT_THAT(out, ProtoEq(cluster));
  }
...
TEST(CheckApiConfigSourceSubscriptionBackingClusterTest, GrpcClusterTestAcrossTypes) {
  envoy::config::core::v3alpha::ConfigSource config;
  ...
  EXPECT_CALL(*cluster.info_, type())
      .WillOnce(Return(envoy::config::cluster::v3alpha::Cluster::EDS));
  EXPECT_THROW_WITH_MESSAGE(
      Utility::checkApiConfigSourceSubscriptionBackingCluster(cluster_map, *api_config_source),
      EnvoyException,
      "envoy::api::v2::core::ConfigSource must have a statically defined non-EDS cluster: "
