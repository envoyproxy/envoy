...
class NamedMockSubscriptionCallbacks
    : public MockSubscriptionCallbacks<envoy::api::v3alpha::ClusterLoadAssignment> {
public:
  std::string resourceName(const ProtobufWkt::Any& resource) override {
    return TestUtility::anyConvert<envoy::api::v3alpha::ClusterLoadAssignment>(resource)
        .cluster_name();
  }
};
...
void expectDeltaAndSotwUpdate(
    ...
    const std::vector<envoy::api::v3alpha::ClusterLoadAssignment>& expected_resources,
      ...
      .WillOnce(Invoke(
          [expected_resources](const Protobuf::RepeatedPtrField<ProtobufWkt::Any>& gotten_resources,
            ...
            for (size_t i = 0; i < expected_resources.size(); i++) {
              envoy::api::v3alpha::ClusterLoadAssignment cur_gotten_resource;
  ...
  EXPECT_CALL(callbacks, onConfigUpdate(_, _, _))
      .WillOnce(Invoke(
          [expected_resources, expected_removals, version](
              const Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource>& gotten_resources,
...
Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource>
wrapInResource(const Protobuf::RepeatedPtrField<ProtobufWkt::Any>& anys,
               const std::string& version) {
  Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> ret;
  for (const auto& a : anys) {
    envoy::api::v3alpha::ClusterLoadAssignment cur_endpoint;
...
void doDeltaAndSotwUpdate(SubscriptionCallbacks& watch_map,
  ...
  Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> delta_resources =
...
TEST(WatchMapTest, Basic) {
  ...
  }
  {
    ...
    Protobuf::RepeatedPtrField<ProtobufWkt::Any> updated_resources;
    envoy::api::v3alpha::ClusterLoadAssignment alice;
    alice.set_cluster_name("alice");
    updated_resources.Add()->PackFrom(alice);
    envoy::api::v3alpha::ClusterLoadAssignment carol;
    carol.set_cluster_name("carol");
    updated_resources.Add()->PackFrom(carol);
    envoy::api::v3alpha::ClusterLoadAssignment dave;
...
TEST(WatchMapTest, WatchingEverything) {
  ...
  std::vector<envoy::api::v3alpha::ClusterLoadAssignment> expected_resources1;
  expected_resources1.push_back(alice);
  expected_resources1.push_back(bob);
  std::vector<envoy::api::v3alpha::ClusterLoadAssignment> expected_resources2;
...
TEST(WatchMapTest, DeltaOnConfigUpdate) {
  ...
  // will just not trigger any onConfigUpdate at all.
  {
    ...
    envoy::api::v3alpha::ClusterLoadAssignment will_be_removed_later;
  ...
  envoy::api::v3alpha::ClusterLoadAssignment updated;
