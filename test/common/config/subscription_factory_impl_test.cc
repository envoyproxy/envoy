...
#include "envoy/api/v3alpha/core/config_source.pb.validate.h"
...
public:
  ...
  MockSubscriptionCallbacks<envoy::api::v3alpha::ClusterLoadAssignment> callbacks_;
...
class SubscriptionFactoryTestApiConfigSource
    : public SubscriptionFactoryTest,
      public testing::WithParamInterface<envoy::api::v3alpha::core::ApiConfigSource::ApiType> {};
...
TEST_F(SubscriptionFactoryTest, RestClusterEmpty) {
  ...
  config.mutable_api_config_source()->set_api_type(
      envoy::api::v3alpha::core::ApiConfigSource::REST);
...
TEST_F(SubscriptionFactoryTest, GrpcClusterEmpty) {
  ...
  config.mutable_api_config_source()->set_api_type(
      envoy::api::v3alpha::core::ApiConfigSource::GRPC);
...
TEST_F(SubscriptionFactoryTest, RestClusterSingleton) {
  ...
  EXPECT_CALL(*cluster.info_, type()).WillOnce(Return(envoy::api::v3alpha::Cluster::STATIC));
...
TEST_F(SubscriptionFactoryTest, RestClusterMultiton) {
  ...
  EXPECT_CALL(*cluster.info_, type()).WillRepeatedly(Return(envoy::api::v3alpha::Cluster::STATIC));
...
INSTANTIATE_TEST_SUITE_P(SubscriptionFactoryTestApiConfigSource,
                         ...
                         ::testing::Values(envoy::api::v3alpha::core::ApiConfigSource::REST,
                                           envoy::api::v3alpha::core::ApiConfigSource::GRPC));
