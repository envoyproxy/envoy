...
TEST_F(ConfigProviderImplTest, SharedOwnership) {
  ...
  envoy::api::v3alpha::core::ApiConfigSource config_source_proto;
  config_source_proto.set_api_type(envoy::api::v3alpha::core::ApiConfigSource::GRPC);
  ...
  config_source_proto.set_api_type(envoy::api::v3alpha::core::ApiConfigSource::REST);
