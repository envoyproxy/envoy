...
protected:
  DeltaSubscriptionStateTest()
    ...
    envoy::api::v3alpha::DeltaDiscoveryRequest cur_request = state_.getNextRequestAckless();
  ...
  UpdateAck deliverDiscoveryResponse(
    ...
    envoy::api::v3alpha::DeltaDiscoveryResponse message;
  ...
  NiceMock<MockSubscriptionCallbacks<envoy::api::v3alpha::Cluster>> callbacks_;
...
populateRepeatedResource(std::vector<std::pair<std::string, std::string>> items) {
  Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> add_to;
...
TEST_F(DeltaSubscriptionStateTest, AckGenerated) {
  ...
  {
    Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> added_resources =
...
TEST_F(DeltaSubscriptionStateTest, ResourceGoneLeadsToBlankInitialVersion) {
  {
    ...
    Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> add1_2 =
        populateRepeatedResource({{"name1", "version1A"}, {"name2", "version2A"}});
...

  {
    ...
    Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> add1_3 =
...
TEST_F(DeltaSubscriptionStateTest, InitialVersionMapFirstMessageOnly) {
  // First, verify that the first message of a new stream sends initial versions.
  {
    ...
    Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> add_all = populateRepeatedResource(
  ...
  // versions are not sent.
  {
    ...
    Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> add_all =
...
TEST_F(DeltaSubscriptionStateTest, DuplicatedAdd) {
  Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> additions =
