...
protected:
  ...
  std::unique_ptr<envoy::api::v2::DiscoveryRequest> getNextDeltaDiscoveryRequestAckless() {
...
TEST_F(SotwSubscriptionStateTest, ResourceGoneLeadsToBlankInitialVersion) {
  {
...
TEST_F(SotwSubscriptionStateTest, SubscribeAndUnsubscribeAfterReconnect) {
  Protobuf::RepeatedPtrField<envoy::api::v2::Resource> add1_2 =
      populateRepeatedResource({{"name1", "version1A"}, {"name2", "version2A"}});
  deliverDiscoveryResponse(add1_2, {}, "debugversion1");
...
TEST_F(SotwSubscriptionStateTest, InitialVersionMapFirstMessageOnly) {
...
// onConfigUpdate().
TEST_F(SotwSubscriptionStateTest, DuplicatedAdd) {
...
TEST_F(SotwSubscriptionStateTest, DuplicatedRemove) {
...
TEST_F(SotwSubscriptionStateTest, AddedAndRemoved) {
  Protobuf::RepeatedPtrField<envoy::api::v2::Resource> additions =
