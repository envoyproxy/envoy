...
TEST_F(DeltaSubscriptionImplTest, UpdateResourcesCausesRequest) {
  ...
  expectSendMessage({"name4"}, {"name1", "name2"}, Grpc::Status::GrpcStatusMapping::Ok, "", {});
  subscription_->updateResourceInterest({"name3", "name4"});
  expectSendMessage({"name1", "name2"}, {}, Grpc::Status::GrpcStatusMapping::Ok, "", {});
  subscription_->updateResourceInterest({"name1", "name2", "name3", "name4"});
  expectSendMessage({}, {"name1", "name2"}, Grpc::Status::GrpcStatusMapping::Ok, "", {});
  subscription_->updateResourceInterest({"name3", "name4"});
  expectSendMessage({"name1", "name2"}, {}, Grpc::Status::GrpcStatusMapping::Ok, "", {});
  subscription_->updateResourceInterest({"name1", "name2", "name3", "name4"});
  expectSendMessage({}, {"name1", "name2", "name3"}, Grpc::Status::GrpcStatusMapping::Ok, "", {});
