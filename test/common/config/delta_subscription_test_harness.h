...
public:
  ...
  void expectSendMessage(const std::set<std::string>& cluster_names, const std::string& version,
    ...
    expectSendMessage(cluster_names, {}, Grpc::Status::GrpcStatusMapping::Ok, "", {});
  }
  ...
  void deliverConfigUpdate(const std::vector<std::string>& cluster_names,
    ...
    if (accept) {
      ...
      expectSendMessage({}, {}, Grpc::Status::GrpcStatusMapping::Internal, "bad config", {});
    }
  ...
  void updateResourceInterest(const std::set<std::string>& cluster_names) override {
    ...
    expectSendMessage(sub, unsub, Grpc::Status::GrpcStatusMapping::Ok, "", {});
