...
public:
  ...
  void initialize() {
    EXPECT_CALL(*cluster_->upstream_local_address_selector_, getUpstreamLocalAddressImpl(_))
        .WillOnce(Return(Upstream::UpstreamLocalAddress({cluster_->source_address_, options_})));
