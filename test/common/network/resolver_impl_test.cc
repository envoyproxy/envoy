...
TEST_F(IpResolverTest, Basic) {
  envoy::api::v3alpha::core::SocketAddress socket_address;
...
TEST_F(IpResolverTest, DisallowsNamedPort) {
  ...
  EXPECT_THROW_WITH_MESSAGE(
      ...
      fmt::format("IP resolver can't handle port specifier type {}",
                  envoy::api::v3alpha::core::SocketAddress::PortSpecifierCase::kNamedPort));
}

TEST(ResolverTest, FromProtoAddress) {
  envoy::api::v3alpha::core::Address ipv4_address;
  ...
  envoy::api::v3alpha::core::Address ipv6_address;
...
public:
  ...
  resolve(const envoy::api::v3alpha::core::SocketAddress& socket_address) override {
...
private:
  ...
  std::string getPort(const envoy::api::v3alpha::core::SocketAddress& socket_address) {
    switch (socket_address.port_specifier_case()) {
    case envoy::api::v3alpha::core::SocketAddress::PortSpecifierCase::kNamedPort:
      return socket_address.named_port();
    case envoy::api::v3alpha::core::SocketAddress::PortSpecifierCase::kPortValue:
    // default to port 0 if no port value is specified
    case envoy::api::v3alpha::core::SocketAddress::PortSpecifierCase::PORT_SPECIFIER_NOT_SET:
...
TEST(ResolverTest, NonStandardResolver) {
  ...
  {
    envoy::api::v3alpha::core::Address address;
