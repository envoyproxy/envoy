...
TEST(NetworkUtility, ProtobufAddressSocketType) {
  ...
  {
    const auto kInvalidValue = static_cast<envoy::api::v2::core::SocketAddress::Protocol>(123);
    envoy::api::v2::core::Address proto_address;
    proto_address.mutable_socket_address()->set_protocol(kInvalidValue);
    EXPECT_THROW(Utility::protobufAddressSocketType(proto_address), EnvoyException);
  }
  {
    envoy::api::v2::core::Address proto_address;
