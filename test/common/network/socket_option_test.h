...
public:
  ...
  void testSetSocketOptionSuccess(
      ...
      const std::set<envoy::api::v3alpha::core::SocketOption::SocketState>& when) {
    for (auto state : when) {
    ...
    std::list<envoy::api::v3alpha::core::SocketOption::SocketState> unset_socketstates{
    ...
    unset_socketstates.remove_if(
        [&](envoy::api::v3alpha::core::SocketOption::SocketState state) -> bool {
