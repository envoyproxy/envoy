...
TEST_F(SocketOptionFactoryTest, TestBuildLiteralOptions) {
  ...
  *socket_options_proto.Add() = socket_option_proto;
  ...
  auto ipv4_socket_ip_version_textproto =
      absl::StrFormat(socket_ip_version_option_format, SOL_SOCKET, SO_KEEPALIVE, "SOCKET_IP_VERSION_IPV4");
  ASSERT_TRUE(parser.ParseFromString(ipv4_socket_ip_version_textproto, &socket_option_proto));
  *socket_options_proto.Add() = socket_option_proto;

  auto ipv6_socket_ip_version_textproto =
      absl::StrFormat(socket_ip_version_option_format, SOL_SOCKET, SO_KEEPALIVE, "SOCKET_IP_VERSION_IPV6");
