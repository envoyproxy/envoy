...
#include "third_party/quic/core/quic_packet_writer.h"
...
class FakeQuicPacketWriter : public quic::QuicPacketWriter {
 public:
  ...
  quic::QuicByteCount GetMaxPacketSize(
      const quic::QuicSocketAddress&) const override {
    return 1500;
  }
  bool SupportsReleaseTime() const override { return false; }
  bool IsBatchMode() const override { return false; }
  quic::QuicPacketBuffer GetNextWriteLocation(
      const quic::QuicIpAddress&, const quic::QuicSocketAddress&) override {
