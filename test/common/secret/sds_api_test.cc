...
TEST_F(SdsApiTest, DynamicTlsCertificateUpdateSuccess) {
  ...
  Envoy::Ssl::TlsCertificateConfigImpl tls_config =
      std::move(Ssl::TlsCertificateConfigImpl::create(*sds_api.secret(), ctx, *api_, "cert_name").value());
...
TEST_F(SdsApiTest, DynamicCertificateValidationContextUpdateSuccess) {
  ...
  auto cvc_config =
      Ssl::CertificateValidationContextConfigImpl::create(*sds_api.secret(), false, *api_, "ca_cert_name").value();
...
TEST_F(SdsApiTest, DefaultCertificateValidationContextTest) {
  ...
  auto cvc_config =
      Ssl::CertificateValidationContextConfigImpl::create(merged_cvc, false, *api_, "ca_cert_name").value();
