...
TEST_F(SdsApiTest, BasicTest) {
  ...
  const envoy::service::discovery::v3alpha::SdsDummy dummy;
...
TEST_F(SdsApiTest, DynamicTlsCertificateUpdateSuccess) {
  ...
  envoy::api::v3alpha::auth::Secret typed_secret;
...
public:
  ...
  void onConfigUpdate(const Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource>& added,
                      const Protobuf::RepeatedPtrField<std::string>& removed,
                      const std::string& version) override {
    SdsApi::onConfigUpdate(added, removed, version);
  }
  void setSecret(const envoy::api::v3alpha::auth::Secret&) override {}
  void validateConfig(const envoy::api::v3alpha::auth::Secret&) override {}
...
TEST_F(SdsApiTest, DeltaUpdateSuccess) {
  ...
  envoy::api::v3alpha::auth::Secret typed_secret;
  TestUtility::loadFromYaml(TestEnvironment::substitute(yaml), typed_secret);
  Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource> secret_resources;
...
public:
  ...
  virtual void validateCvc(const envoy::api::v3alpha::auth::CertificateValidationContext&) PURE;
};
...
public:
  ...
  MOCK_METHOD1(validateCvc, void(const envoy::api::v3alpha::auth::CertificateValidationContext&));
};
...
TEST_F(SdsApiTest, DefaultCertificateValidationContextTest) {
  ...
  auto validation_handle = sds_api.addValidationCallback(
      [&validation_callback](const envoy::api::v3alpha::auth::CertificateValidationContext& cvc) {
  ...
  envoy::api::v3alpha::auth::CertificateValidationContext default_cvc;
  ...
  envoy::api::v3alpha::auth::CertificateValidationContext merged_cvc = default_cvc;
