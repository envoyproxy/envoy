...
session_ticket_keys:
  ...
  const envoy::api::v3alpha::auth::TlsSessionTicketKeys session_ticket_keys(
...
api_config_source:
  ...
  envoy::config::grpc_credential::v3alpha::FileBasedMetadataConfig file_based_metadata_config;
  TestUtility::loadFromYaml(R"(
...
tls_certificate:
  ...
  envoy::api::v3alpha::auth::Secret tls_cert_secret;
...
validation_context:
  ...
  envoy::api::v3alpha::auth::Secret validation_secret;
...
session_ticket_keys:
  ...
  envoy::api::v3alpha::auth::Secret stek_secret;
