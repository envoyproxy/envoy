...
TEST_P(SslSocketTest, ProtocolVersions) {
  ...
  // ssl.handshake logged by both: client & server.
  testUtilV2(listener, client, "", true, "TLSv1.2", "", "", "", "ssl.handshake", 2, "",
             GetParam());
  ...
  testUtilV2(listener, client, "", true, "TLSv1", "", "", "", "ssl.handshake", 2, "",
             GetParam());
  ...
  testUtilV2(listener, client, "", true, "TLSv1.1", "", "", "", "ssl.handshake", 2, "",
             GetParam());
  ...
  testUtilV2(listener, client, "", true, "TLSv1.3", "", "", "", "ssl.handshake", 2, "",
             GetParam());
...
TEST_P(SslSocketTest, GetRequestedServerName) {
  ...
  testUtilV2(listener, client, "", true, "", "", "", "", "ssl.handshake", 2, "lyft.com",
             GetParam());
}
