...
TEST_F(SslConnectionImplTest, GetCertDigest) {
  ...
  {
    "cert_chain_file": "{{ test_srcdir }}/test/common/ssl/test_data/no_san_cert.pem",
    "private_key_file": "{{ test_srcdir }}/test/common/ssl/test_data/no_san_key.pem"
  }
  )EOF";
...
TEST_F(SslConnectionImplTest, GetNoUriWithDnsSan) {
  std::string client_ctx_json = R"EOF(
  {
    "cert_chain_file": "{{ test_srcdir }}/test/common/ssl/test_data/san_dns_cert.pem",
    "private_key_file": "{{ test_srcdir }}/test/common/ssl/test_data/san_dns_key.pem"
  }
  )EOF";
