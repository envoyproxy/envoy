...
#include "envoy/api/v3alpha/core/base.pb.validate.h"
...
TEST_F(FeatureFlagTest, FeatureFlagBasicTest) {
  envoy::api::v3alpha::core::RuntimeFeatureFlag feature_flag_proto;
...
default_value: true
  ...
  envoy::api::v3alpha::core::RuntimeFeatureFlag feature_flag_proto2;
  yaml = R"EOF(
runtime_key: "bar.foo"
default_value: false
)EOF";
...
TEST_F(FeatureFlagTest, FeatureFlagEmptyProtoTest) {
  envoy::api::v3alpha::core::RuntimeFeatureFlag empty_proto;
...
TEST_F(FeatureFlagTest, FractionalPercentBasicTest) {
  envoy::api::v3alpha::core::RuntimeFractionalPercent runtime_fractional_percent_proto;
  std::string yaml(R"EOF(
runtime_key: "foo.bar"
default_value:
  numerator: 100
  ...
  envoy::api::v3alpha::core::RuntimeFractionalPercent runtime_fractional_percent_proto2;
  yaml = (R"EOF(
runtime_key: "foo.bar"
default_value:
  numerator: 0
