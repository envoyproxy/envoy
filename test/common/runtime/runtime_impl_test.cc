...
using Random = TestBase;

TEST_F(Random, DISABLED_benchmarkRandom) {
...
TEST_F(Random, sanityCheckOfUniquenessRandom) {
  Runtime::RandomGeneratorImpl random;
...
TEST_F(UUID, sanityCheckOfUniqueness) {
