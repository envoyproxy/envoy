...
void foreachStat(int num_clusters, std::function<void(absl::string_view)> fn) {
  ...
  static const char* cluster_stats[] = {
    "bind_errors",
    "lb_healthy_panic",
  ...
  // to any requests.
  static const char* other_stats[] = {
    "http.admin.downstream_cx_length_ms", "http.admin.downstream_rq_time",
    "http.ingress_http.downstream_cx_length_ms", "http.ingress_http.downstream_rq_time",
    "listener.0.0.0.0_40000.downstream_cx_length_ms", "listener.admin.downstream_cx_length_ms"
  };
