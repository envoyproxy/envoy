...
void DefaultTagRegexTester::testRegex(const std::string& stat_name,
                                      const std::string& expected_tag_extracted_name,
 ...
 */
std::string DefaultTagRegexTester::produceTagsReverse(const std::string& metric_name,
