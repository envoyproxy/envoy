...
TEST(ConfigTest, AccessLogConfig) {
  ...
  log->set_name(Extensions::AccessLoggers::AccessLogNames::get().File);
  {
    ...
    file_access_log.mutable_log_format()->mutable_text_format_source()->set_inline_string("the format specifier");
...
public:
  ...
  accessLogConfig(const std::string& access_log_format) {
    ...
    file_access_log.mutable_log_format()->mutable_text_format_source()->set_inline_string(access_log_format);
