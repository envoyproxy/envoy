...
public:
  ...
  void configure(const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy& config) {
    config_.reset(new Config(config, factory_context_));
  }

  envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy defaultConfig() {
    envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy config;
  ...
  envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy
  accessLogConfig(const std::string& access_log_format) {
    envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy config = defaultConfig();
...
TEST_F(TcpProxyTest, DEPRECATED_FEATURE_TEST(DefaultRoutes)) {
  ...
  envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy::WeightedCluster::ClusterWeight*
