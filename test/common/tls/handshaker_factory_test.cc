...
protected:
  HandshakerFactoryTest()
    ...
    static_cast<void>(custom_handshaker->mutable_typed_config()->PackFrom(Protobuf::StringValue()));
  }
...
TEST_F(HandshakerFactoryDownstreamTest, ServerHandshakerProvidesCertificates) {
  ...
  static_cast<void>(custom_handshaker->mutable_typed_config()->PackFrom(Protobuf::BoolValue()));
