...
Note that the expired certificates are generated by setting the validity window
explicitly in the past via "-not_before"/"-not_after", because the openssl
command will not accept a non-positive "-days" parameter. This affects LibreSSL
as shipped with macOS since High Sierra (10.13), and OpenSSL itself as of 3.5.
