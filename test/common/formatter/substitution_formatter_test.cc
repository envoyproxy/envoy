...
TEST(SubstitutionFormatterTest, streamInfoFormatter) {
  ...
  }
  {
    ...
    stream_info.setDownstreamDetectedCloseType(StreamInfo::DetectedCloseType::Undefined);
    EXPECT_EQ("Undefined", ds_close_type_format.format({}, stream_info));
...

  {
    ...
    stream_info.upstreamInfo()->setUpstreamDetectedCloseType(StreamInfo::DetectedCloseType::Undefined);
    EXPECT_EQ("Undefined", us_close_type_format.format({}, stream_info));
