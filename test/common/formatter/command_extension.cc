...
absl::optional<std::string> TestFormatter::format(const HttpFormatterContext&,
                                                  const StreamInfo::StreamInfo&) const {
  return "TestFormatter";
}

ProtobufWkt::Value TestFormatter::formatValue(const HttpFormatterContext&,
                                              const StreamInfo::StreamInfo&) const {
...
absl::optional<std::string> AdditionalFormatter::format(const HttpFormatterContext&,
                                                        const StreamInfo::StreamInfo&) const {
  return "AdditionalFormatter";
}

ProtobufWkt::Value AdditionalFormatter::formatValue(const HttpFormatterContext&,
                                                    const StreamInfo::StreamInfo&) const {
  return ValueUtil::stringValue("");
}
