...
TEST_F(CodeUtilityTest, NoCanary) {
  ...
  EXPECT_EQ(19U, TestUtility::counters(cluster_store_).size());
}
...
TEST_F(CodeUtilityTest, Canary) {
  ...
  EXPECT_EQ(26U, TestUtility::counters(cluster_store_).size());
}
...
TEST_F(CodeUtilityTest, UnknownResponseCodes) {
  ...
  EXPECT_EQ(8U, TestUtility::counters(cluster_store_).size());
}
