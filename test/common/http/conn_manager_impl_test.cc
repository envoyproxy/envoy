...
TEST_F(HttpConnectionManagerImplTest, StartAndFinishSpanTraceDecisionRefresh) {
  ...
  EXPECT_CALL(*codec_, dispatch(_))
      .WillRepeatedly(Invoke([&](Buffer::Instance& data) -> Http::Status {
        ...
        EXPECT_CALL(*span, setDecision(false));
      ...
      .WillRepeatedly(Invoke([&](Buffer::Instance& data) -> Http::Status {
        ...
        EXPECT_CALL(runtime_.snapshot_,
                    featureEnabled("tracing.global_enabled",
                                   An<const envoy::type::v3::FractionalPercent&>(), _))
            .Times(0);
        EXPECT_CALL(*span, setDecision(false)).Times(0);
