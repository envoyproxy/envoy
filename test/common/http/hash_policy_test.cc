...
protected:
  ...
  std::vector<const envoy::config::route::v3::RouteAction::HashPolicy*> hash_policies_;
...
TEST_F(HashPolicyImplTest, IpHashForNullAddress) {
  ...
  ASSERT_FALSE(hash_policy_impl_->generateHash(nullptr, headers_, nullptr, nullptr).has_value());
}
