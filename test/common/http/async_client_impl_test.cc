...
public:
  AsyncClientImplTest()
    ...
    ON_CALL(*cm_.conn_pool_.host_, locality())
        .WillByDefault(ReturnRef(envoy::api::v3alpha::core::Locality().default_instance()));
  }
...
TEST_F(AsyncClientImplTest, BasicHashPolicy) {
  ...
  AsyncClient::RequestOptions options;
  Protobuf::RepeatedPtrField<envoy::api::v3alpha::route::RouteAction::HashPolicy> hash_policy;
...
public:
  AsyncStreamImpl::RouteImpl route_impl_{
      "foo", absl::nullopt,
      Protobuf::RepeatedPtrField<envoy::api::v3alpha::route::RouteAction::HashPolicy>()};
