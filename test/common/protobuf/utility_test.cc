...
TEST_F(ProtobufUtilityTest, MessageUtilHash) {
  ...
  Protobuf::Any a1;
  static_cast<void>(a1.PackFrom(s));
  ...
  Protobuf::Any a4, a5;
  static_cast<void>(a4.PackFrom(s2));
  static_cast<void>(a5.PackFrom(s3));
...
TEST_F(ProtobufUtilityTest, ValidateUnknownFieldsNestedAny) {
  ...
  static_cast<void>(cluster_type->mutable_typed_config()->PackFrom(outer));
...
TEST_F(ProtobufUtilityTest, AnyBytes) {
  {
    ...
    Protobuf::Any source_any;
    static_cast<void>(source_any.PackFrom(source));
  ...
  }
  {
    ...
    Protobuf::Any source_any;
    static_cast<void>(source_any.PackFrom(filter));
...
TEST_F(ProtobufUtilityTest, AnyConvertWrongType) {
  ...
  source_duration.set_seconds(42);
  Protobuf::Any source_any;
  static_cast<void>(source_any.PackFrom(source_duration));
...
TEST_F(ProtobufUtilityTest, UnpackToNoThrowRightType) {
  ...
  Protobuf::Any source_any;
  static_cast<void>(source_any.PackFrom(src_duration));
