...
public:
  ProtobufUtilityTest() : file_system_(Filesystem::fileSystemForTest()) {}
...
TEST_F(ProtobufUtilityTest, LoadBinaryProtoFromFile) {
  ...
  MessageUtil::loadFromFile(filename, proto_from_file, file_system_);
...
TEST_F(ProtobufUtilityTest, LoadBinaryProtoUnknownFieldFromFile) {
  ...
  EXPECT_THROW_WITH_MESSAGE(
      MessageUtil::loadFromFile(filename, proto_from_file, file_system_), EnvoyException,
...
TEST_F(ProtobufUtilityTest, LoadTextProtoFromFile_Failure) {
  ...
  envoy::config::bootstrap::v2::Bootstrap proto_from_file;
  EXPECT_THROW_WITH_MESSAGE(MessageUtil::loadFromFile(filename, proto_from_file, file_system_),
                            EnvoyException,
