...
TEST_F(TestBase, BufferHelperTest_PeekI8) {
  {
...
TEST_F(TestBase, BufferHelperTest_PeekLEI16) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_PeekLEI32) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_PeekLEI64) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_PeekLEU16) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_PeekLEU32) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_PeekLEU64) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 4, 5, 6, 7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_PeekBEI16) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_PeekBEI32) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_PeekBEI64) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 4, 5, 6, 7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_PeekBEU16) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_PeekBEU32) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_PeekBEU64) {
  {
    Buffer::OwnedImpl buffer;
    addSeq(buffer, {0, 1, 2, 3, 4, 5, 6, 7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainI8) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 0xFE});
...
TEST_F(TestBase, BufferHelperTest_DrainLEI16) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainLEI32) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainLEI64) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 4, 5, 6, 7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainLEU32) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainLEU64) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 4, 5, 6, 7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainBEI16) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainBEI32) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainBEI64) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 4, 5, 6, 7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainBEU32) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_DrainBEU64) {
  Buffer::OwnedImpl buffer;
  addSeq(buffer, {0, 1, 2, 3, 4, 5, 6, 7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF});
...
TEST_F(TestBase, BufferHelperTest_WriteI8) {
  Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteLEI16) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteLEU16) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteLEI32) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteLEU32) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteLEI64) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteBEI16) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteBEU16) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteBEI32) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteBEU32) {
  {
    Buffer::OwnedImpl buffer;
...
TEST_F(TestBase, BufferHelperTest_WriteBEI64) {
  {
    Buffer::OwnedImpl buffer;
