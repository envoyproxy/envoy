...
int main(int argc, char** argv) {
  ...
  ::setenv("TEST_RUNDIR", (Lyft::TestEnvironment::getCheckedEnvVar("TEST_SRCDIR") + "/" +
                           Lyft::TestEnvironment::getCheckedEnvVar("TEST_WORKSPACE")).c_str(),
           1);
  ...
  return Lyft::TestRunner::RunTests(argc, argv);
}
