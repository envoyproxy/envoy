...
TEST(MatcherTest, BasicUsage) {
  {
    ...
    EXPECT_EQ(matcher1.match(DataInputGetResult::NoData()), ::Envoy::Matcher::MatchResult::NoMatch);
    EXPECT_EQ(matcher2.match(DataInputGetResult::NoData()), ::Envoy::Matcher::MatchResult::NoMatch);
  }
  {
    ...
    // than the threshold.
    EXPECT_EQ(matcher1.match(DataInputGetResult::CreateString("hello")),
              ::Envoy::Matcher::MatchResult::Matched);
    EXPECT_EQ(matcher2.match(DataInputGetResult::CreateString("hello")),
              ::Envoy::Matcher::MatchResult::Matched);
  }
  {
