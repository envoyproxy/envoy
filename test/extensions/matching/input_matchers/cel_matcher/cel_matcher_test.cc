  ...
  buildMatcherTree(const std::string& cel_expr_config,
    ...
    case ExpressionType::CheckedExpression: {
      if (use_cel) {
        ...
        static_cast<void>(Protobuf::TextFormat::ParseFromString(cel_expr_config, &checked_expr));
    ...
    case ExpressionType::ParsedExpression: {
      if (use_cel) {
        ...
        static_cast<void>(Protobuf::TextFormat::ParseFromString(cel_expr_config, &parsed_expr));
...
TEST_F(CelMatcherTest, CelMatcherTypedDynamicMetadataMatched) {
  ...
  static_cast<void>(typed_metadata.PackFrom(pipe));
