...
wrapInResource(const Protobuf::RepeatedPtrField<Protobuf::Any>& anys, const std::string& version) {
  ...
  for (const auto& a : anys) {
    ...
    static_cast<void>(a.UnpackTo(&cur_endpoint));
...
TEST(WatchMapTest, Basic) {
  ...
  }
  {
    ...
    static_cast<void>(updated_resources.Add()->PackFrom(bob));
    envoy::config::endpoint::v3::ClusterLoadAssignment carol;
    carol.set_cluster_name("carol");
    static_cast<void>(updated_resources.Add()->PackFrom(carol));
  ...
  }
  {
    ...
    static_cast<void>(updated_resources.Add()->PackFrom(alice));
    envoy::config::endpoint::v3::ClusterLoadAssignment carol;
    carol.set_cluster_name("carol");
    static_cast<void>(updated_resources.Add()->PackFrom(carol));
    envoy::config::endpoint::v3::ClusterLoadAssignment dave;
    dave.set_cluster_name("dave");
    static_cast<void>(updated_resources.Add()->PackFrom(dave));
...
public:
  ...
  void SetUp() override {
    envoy::config::endpoint::v3::ClusterLoadAssignment alice;
    alice.set_cluster_name("alice");
    static_cast<void>(updated_resources_.Add()->PackFrom(alice));
...
TEST(WatchMapTest, UninterestingUpdate) {
  ...
  envoy::config::endpoint::v3::ClusterLoadAssignment alice;
  alice.set_cluster_name("alice");
  static_cast<void>(alice_update.Add()->PackFrom(alice));

  Protobuf::RepeatedPtrField<Protobuf::Any> bob_update;
  envoy::config::endpoint::v3::ClusterLoadAssignment bob;
  bob.set_cluster_name("bob");
  static_cast<void>(bob_update.Add()->PackFrom(bob));
...
TEST(WatchMapTest, DeltaOnConfigUpdate) {
  ...
  // will just not trigger any onConfigUpdate at all.
  {
    ...
    static_cast<void>(prepare_removed.Add()->PackFrom(will_be_removed_later));
  ...
  static_cast<void>(update.Add()->PackFrom(updated));
...
TEST(WatchMapTest, OnConfigUpdateXdsTpGlobCollections) {
  ...
  // verify update
  {
    ...
    static_cast<void>(update.Add()->PackFrom(resource1));
    ...
    static_cast<void>(update.Add()->PackFrom(resource2));
    ...
    static_cast<void>(update.Add()->PackFrom(ignored_resource));
...
TEST(WatchMapTest, OnConfigUpdateUsingNamespaces) {
  ...
  // verify update
  {
    ...
    static_cast<void>(update.Add()->PackFrom(resource));
