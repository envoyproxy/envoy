...
public:
  ...
  void initializeWithIntermediateLog() {
    ...
    config_helper_.addConfigModifier([this](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
      ...
      static_cast<void>(tcp_proxy->UnpackTo(&tcp_proxy_config));
      ...
      static_cast<void>(tcp_proxy->PackFrom(tcp_proxy_config));
    });
    BaseIntegrationTest::initialize();
  }
  ...
  void setupTlsInspectorFilter(absl::optional<ConfigHelper::ServerSslOptions> server_ssl_options,
    ...
    config_helper_.addConfigModifier([](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
      ...
      *alpn = "envoyalpn";
      ...
      static_cast<void>(filter->mutable_typed_config()->PackFrom(echo));
    });
