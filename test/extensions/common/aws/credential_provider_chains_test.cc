...
TEST_F(CommonCredentialsProviderChainTest, NoEnvironmentVars) {
  ...
  CommonCredentialsProviderChain chain(context_, "region", absl::nullopt,
                                        factories_);
}
...
TEST_F(CommonCredentialsProviderChainTest, MetadataDisabled) {
  ...
  CommonCredentialsProviderChain chain(context_, "region", credential_provider_config,
                                        factories_);
}
...
TEST_F(CommonCredentialsProviderChainTest, FullUriWithAuthorizationToken) {
  ...
  EXPECT_CALL(factories_,
              createContainerCredentialsProvider( _, _, _, _,
