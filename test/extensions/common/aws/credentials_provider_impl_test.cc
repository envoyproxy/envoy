...
public:
  ...
  MOCK_METHOD(
      ...
      (Server::Configuration::ServerFactoryContext&, Singleton::Manager&, CreateMetadataFetcherCb,
       absl::string_view, MetadataFetcher::MetadataReceiver::RefreshState, std::chrono::seconds,
