...
using AsyncFileManagerFactoryDeathTest = AsyncFileManagerFactoryTest;

TEST_F(AsyncFileManagerFactoryDeathTest, DiesIfConfigIsInvalid) {
...
TEST_F(AsyncFileManagerFactoryDeathTest, DiesIfThreadPoolSelectedAndUnsupported) {
  envoy::extensions::common::async_files::v3::AsyncFileManagerConfig config;
