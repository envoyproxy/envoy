  ...
  void initialize() override {
    config_helper_.addConfigModifier([this](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
      ...
      if (inner_tls_) {
        ...
        static_cast<void>(inner_socket.mutable_typed_config()->PackFrom(tls));
      } else {
        envoy::extensions::transport_sockets::raw_buffer::v3::RawBuffer raw_buffer;
        inner_socket.set_name("raw");
        static_cast<void>(inner_socket.mutable_typed_config()->PackFrom(raw_buffer));
      }
      ...
      static_cast<void>(transport_socket->mutable_typed_config()->PackFrom(proxy_proto_transport));
  ...
  void initialize() override {
    if (!disable_listener_filter_) {
      config_helper_.addConfigModifier([this](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
        ...
        static_cast<void>(ppv_filter->mutable_typed_config()->PackFrom(proxy_protocol));
      });
    }
    ...
    config_helper_.addConfigModifier([this](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
      ...
      if (!custom_tlvs_from_host_.empty()) {
        ...
        static_cast<void>(typed_metadata.PackFrom(tlvs_metadata));
