...
typed_config:
  ...
  void initialize() override {
    ...
    if (try_http3_) {
      ...
      static_cast<void>(kv_config.mutable_config()->mutable_typed_config()->PackFrom(config));
    ...
    config_helper_.addConfigModifier([&](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
      ...
      static_cast<void>(transport_socket->mutable_typed_config()->PackFrom(transport));
