...
public:
  ...
  void setupUpstreamTap(envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
    ...
    static_cast<void>(raw_transport_socket.mutable_typed_config()->PackFrom(raw_buffer_config));
    ...
    static_cast<void>(transport_socket->mutable_typed_config()->PackFrom(tap_config));
  }
