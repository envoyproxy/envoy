...
TEST_P(SslIntegrationTest, RouterRequestAndResponseWithBodyNoBufferHttp2) {
  ...
  config_helper_.setClientCodec(envoy::config::filter::network::http_connection_manager::v3alpha::
...
class SslCertficateIntegrationTest
    : public testing::TestWithParam<std::tuple<
          Network::Address::IpVersion, envoy::api::v3alpha::auth::TlsParameters::TlsProtocol>>,
...
public:
  ...
  ClientSslTransportOptions rsaOnlyClientOptions() {
    if (tls_version_ == envoy::api::v3alpha::auth::TlsParameters::TLSv1_3) {
  ...
  const envoy::api::v3alpha::auth::TlsParameters::TlsProtocol tls_version_{std::get<1>(GetParam())};
};

INSTANTIATE_TEST_SUITE_P(
    IpVersionsClientVersions, SslCertficateIntegrationTest,
    testing::Combine(testing::ValuesIn(TestEnvironment::getIpVersionsForTest()),
                     testing::Values(envoy::api::v3alpha::auth::TlsParameters::TLSv1_2,
                                     envoy::api::v3alpha::auth::TlsParameters::TLSv1_3)),
...
public:
  ...
  void setupUpstreamTap(envoy::config::bootstrap::v3alpha::Bootstrap& bootstrap) {
    ...
    envoy::api::v3alpha::core::TransportSocket raw_transport_socket;
  ...
  void setupDownstreamTap(envoy::config::bootstrap::v3alpha::Bootstrap& bootstrap) {
    ...
    envoy::api::v3alpha::core::TransportSocket ssl_transport_socket;
  ...
  envoy::config::transport_socket::tap::v3alpha::Tap
  createTapConfig(const envoy::api::v3alpha::core::TransportSocket& inner_transport) {
    envoy::config::transport_socket::tap::v3alpha::Tap tap_config;
  ...
  envoy::service::tap::v3alpha::OutputSink::Format format_{
      envoy::service::tap::v3alpha::OutputSink::PROTO_BINARY};
...
TEST_P(SslTapIntegrationTest, TwoRequestsWithBinaryProto) {
  ...
  checkStats();
  envoy::api::v3alpha::core::Address expected_local_address;
  Network::Utility::addressToProtobufAddress(*codec_client_->connection()->remoteAddress(),
                                             expected_local_address);
  envoy::api::v3alpha::core::Address expected_remote_address;
...
TEST_P(SslTapIntegrationTest, RequestWithTextProto) {
  format_ = envoy::service::tap::v3alpha::OutputSink::PROTO_TEXT;
  ConnectionCreationFunction creator = [&]() -> Network::ClientConnectionPtr {
    return makeSslClientConnection({});
  };
  const uint64_t id = Network::ConnectionImpl::nextGlobalIdForTest() + 1;
...
TEST_P(SslTapIntegrationTest, RequestWithJsonBodyAsStringUpstreamTap) {
  ...
  format_ = envoy::service::tap::v3alpha::OutputSink::JSON_BODY_AS_STRING;
  ConnectionCreationFunction creator = [&]() -> Network::ClientConnectionPtr {
    return makeSslClientConnection({});
  };
