...
void testUtil(const TestUtilOptions& options) {
  ...
  envoy::api::v3alpha::auth::DownstreamTlsContext server_tls_context;
  ...
  envoy::api::v3alpha::auth::UpstreamTlsContext client_tls_context;
...
public:
  TestUtilOptionsV2(const envoy::api::v3alpha::Listener& listener,
                    const envoy::api::v3alpha::auth::UpstreamTlsContext& client_ctx_proto,
                    bool expect_success, Network::Address::IpVersion version)
  ...
  const envoy::api::v3alpha::Listener& listener() const { return listener_; }
  const envoy::api::v3alpha::auth::UpstreamTlsContext& clientCtxProto() const {
...
private:
  const envoy::api::v3alpha::Listener& listener_;
  const envoy::api::v3alpha::auth::UpstreamTlsContext& client_ctx_proto_;
...
void configureServerAndExpiredClientCertificate(
    ...
    envoy::api::v3alpha::auth::UpstreamTlsContext& client) {
  envoy::api::v3alpha::listener::FilterChain* filter_chain = listener.add_filter_chains();
...
TEST_P(SslSocketTest, GetCertDigestInline) {
  ...
  envoy::api::v3alpha::auth::UpstreamTlsContext client_ctx;
  envoy::api::v3alpha::auth::TlsCertificate* client_cert =
...
void testTicketSessionResumption(const std::string& server_ctx_yaml1,
  ...
  envoy::api::v3alpha::auth::DownstreamTlsContext server_tls_context1;
  ...
  envoy::api::v3alpha::auth::DownstreamTlsContext server_tls_context2;
...
TEST_P(SslSocketTest, ClientAuthCrossListenerSessionResumption) {
  ...
  envoy::api::v3alpha::auth::DownstreamTlsContext tls_context1;
  ...
  envoy::api::v3alpha::auth::DownstreamTlsContext tls_context2;
...
void SslSocketTest::testClientSessionResumption(const std::string& server_ctx_yaml,
  ...
  envoy::api::v3alpha::auth::DownstreamTlsContext server_ctx_proto;
  ...
  envoy::api::v3alpha::auth::UpstreamTlsContext client_ctx_proto;
...
createProtocolTestOptions(const envoy::api::v3alpha::Listener& listener,
                          const envoy::api::v3alpha::auth::UpstreamTlsContext& client_ctx,
...
TEST_P(SslSocketTest, ProtocolVersions) {
  ...
  server_cert->mutable_private_key()->set_filename(TestEnvironment::substitute(
      "{{ test_rundir }}/test/extensions/transport_sockets/tls/test_data/san_dns_key.pem"));
  envoy::api::v3alpha::auth::TlsParameters* server_params =
      filter_chain->mutable_hidden_envoy_deprecated_tls_context()
          ->mutable_common_tls_context()
          ->mutable_tls_params();

  envoy::api::v3alpha::auth::UpstreamTlsContext client;
  envoy::api::v3alpha::auth::TlsParameters* client_params =
  ...
  client_params->set_tls_minimum_protocol_version(
      envoy::api::v3alpha::auth::TlsParameters::TLSv1_0);
  ...
  client_params->set_tls_minimum_protocol_version(
      envoy::api::v3alpha::auth::TlsParameters::TLSv1_1);
  client_params->set_tls_maximum_protocol_version(
      envoy::api::v3alpha::auth::TlsParameters::TLSv1_1);
...
TEST_P(SslSocketTest, ALPN) {
  ...
  server_cert->mutable_private_key()->set_filename(TestEnvironment::substitute(
      "{{ test_rundir }}/test/extensions/transport_sockets/tls/test_data/san_dns_key.pem"));
  envoy::api::v3alpha::auth::CommonTlsContext* server_ctx =
      filter_chain->mutable_hidden_envoy_deprecated_tls_context()->mutable_common_tls_context();

  envoy::api::v3alpha::auth::UpstreamTlsContext client;
  envoy::api::v3alpha::auth::CommonTlsContext* client_ctx = client.mutable_common_tls_context();
...
protected:
  ...
  envoy::api::v3alpha::auth::DownstreamTlsContext downstream_tls_context_;
  std::unique_ptr<ContextManagerImpl> manager_;
  Network::TransportSocketFactoryPtr server_ssl_socket_factory_;
  Network::ListenerPtr listener_;
  envoy::api::v3alpha::auth::UpstreamTlsContext upstream_tls_context_;
