...
#include "envoy/config/filter/network/client_ssl_auth/v3alpha/client_ssl_auth.pb.validate.h"
...
ip_white_list:
  ...
  envoy::config::filter::network::client_ssl_auth::v3alpha::ClientSSLAuth proto_config;
...
ip_white_list:
  ...
  ClientSslAuthConfigFactory factory;
  envoy::config::filter::network::client_ssl_auth::v3alpha::ClientSSLAuth proto_config =
      *dynamic_cast<envoy::config::filter::network::client_ssl_auth::v3alpha::ClientSSLAuth*>(
...
TEST(ClientSslAuthConfigFactoryTest, ValidateFail) {
  ...
  EXPECT_THROW(
      ClientSslAuthConfigFactory().createFilterFactoryFromProto(
          envoy::config::filter::network::client_ssl_auth::v3alpha::ClientSSLAuth(), context),
