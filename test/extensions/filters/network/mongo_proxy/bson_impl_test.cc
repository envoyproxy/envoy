...
TEST_F(BsonImplTest, InvalodDocumentTermination) {
  Buffer::OwnedImpl buffer;
...
TEST_F(BufferHelperTest, InvalidSize) {
  {
    Buffer::OwnedImpl buffer;
