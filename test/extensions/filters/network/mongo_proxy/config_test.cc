...
#include "envoy/config/filter/network/mongo_proxy/v3alpha/mongo_proxy.pb.h"
#include "envoy/config/filter/network/mongo_proxy/v3alpha/mongo_proxy.pb.validate.h"
...
TEST(MongoFilterConfigTest, ValidateFail) {
  ...
  EXPECT_THROW(MongoProxyFilterConfigFactory().createFilterFactoryFromProto(
                   envoy::config::filter::network::mongo_proxy::v3alpha::MongoProxy(), context),
...
TEST(MongoFilterConfigTest, CorrectConfigurationNoFaults) {
  ...
  envoy::config::filter::network::mongo_proxy::v3alpha::MongoProxy proto_config;
...
TEST(MongoFilterConfigTest, ValidProtoConfigurationNoFaults) {
  envoy::config::filter::network::mongo_proxy::v3alpha::MongoProxy config;
...
TEST(MongoFilterConfigTest, MongoFilterWithEmptyProto) {
  ...
  MongoProxyFilterConfigFactory factory;
  envoy::config::filter::network::mongo_proxy::v3alpha::MongoProxy config =
      *dynamic_cast<envoy::config::filter::network::mongo_proxy::v3alpha::MongoProxy*>(
