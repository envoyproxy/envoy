...
TEST(MessageMetadataTest, Fields) {
  ...
  EXPECT_THROW(metadata.frameSize(), std::bad_optional_access);
  ...
  EXPECT_THROW(metadata.protocol(), std::bad_optional_access);
  ...
  EXPECT_THROW(metadata.methodName(), std::bad_optional_access);
  ...
  EXPECT_THROW(metadata.messageType(), std::bad_optional_access);
  ...
  EXPECT_THROW(metadata.headerFlags(), std::bad_optional_access);
  ...
  EXPECT_THROW(metadata.sequenceId(), std::bad_optional_access);
  ...
  EXPECT_THROW(metadata.appExceptionType(), std::bad_optional_access);
  EXPECT_THROW(metadata.appExceptionMessage(), std::bad_optional_access);
