...
#include "envoy/config/filter/network/thrift_proxy/v3alpha/thrift_proxy.pb.h"
...
public:
  ...
  void initialize() override {
    ...
    envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProtocolOptions proto_opts;
