...
inline envoy::config::filter::network::thrift_proxy::v3alpha::TransportType
transportTypeToProto(TransportType transport_type) {
  switch (transport_type) {
  case TransportType::Framed:
    return envoy::config::filter::network::thrift_proxy::v3alpha::FRAMED;
  case TransportType::Unframed:
    return envoy::config::filter::network::thrift_proxy::v3alpha::UNFRAMED;
  case TransportType::Header:
    return envoy::config::filter::network::thrift_proxy::v3alpha::HEADER;
  default:
    NOT_REACHED_GCOVR_EXCL_LINE;
  }
}

inline envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType
protocolTypeToProto(ProtocolType protocol_type) {
  switch (protocol_type) {
  case ProtocolType::Binary:
    return envoy::config::filter::network::thrift_proxy::v3alpha::BINARY;
  case ProtocolType::Compact:
    return envoy::config::filter::network::thrift_proxy::v3alpha::COMPACT;
  default:
    NOT_REACHED_GCOVR_EXCL_LINE;
  }
}
