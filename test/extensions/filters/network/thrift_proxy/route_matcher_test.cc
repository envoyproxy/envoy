...
#include "envoy/config/filter/network/thrift_proxy/v3alpha/route.pb.validate.h"
...
envoy::config::filter::network::thrift_proxy::v3alpha::RouteConfiguration
parseRouteConfigurationFromV2Yaml(const std::string& yaml) {
  envoy::config::filter::network::thrift_proxy::v3alpha::RouteConfiguration route_config;
...
routes:
  ...
  envoy::config::filter::network::thrift_proxy::v3alpha::RouteConfiguration config =
