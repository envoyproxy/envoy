...
public:
  TestConfigImpl(envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy proto_config,
...
public:
  ...
  ThriftFilterStats stats_;
  envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy proto_config_;
