...
std::vector<envoy::config::filter::network::thrift_proxy::v3alpha::TransportType>
getTransportTypes() {
  std::vector<envoy::config::filter::network::thrift_proxy::v3alpha::TransportType> v;
  int transport = envoy::config::filter::network::thrift_proxy::v3alpha::TransportType_MIN;
  while (transport <= envoy::config::filter::network::thrift_proxy::v3alpha::TransportType_MAX) {
    v.push_back(static_cast<envoy::config::filter::network::thrift_proxy::v3alpha::TransportType>(
        transport));
    transport++;
  }
  return v;
...
std::vector<envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType>
getProtocolTypes() {
  std::vector<envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType> v;
  int protocol = envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType_MIN;
  while (protocol <= envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType_MAX) {
    v.push_back(
        static_cast<envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType>(protocol));
    protocol++;
  }
  return v;
}
...
parseThriftProxyFromV2Yaml(const std::string& yaml) {
  envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy thrift_proxy;
...
public:
  void testConfig(envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy& config) {
...
class ThriftFilterTransportConfigTest
    : public testing::TestWithParam<
          envoy::config::filter::network::thrift_proxy::v3alpha::TransportType>,
...
class ThriftFilterProtocolConfigTest
    : public testing::TestWithParam<
          envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType>,
      public ThriftFilterConfigTestBase {};
...
TEST_F(ThriftFilterConfigTest, ValidateFail) {
  EXPECT_THROW(factory_.createFilterFactoryFromProto(
                   envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy(), context_),
               ProtoValidationException);
}

TEST_F(ThriftFilterConfigTest, ValidProtoConfiguration) {
  envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy config{};
...
TEST_F(ThriftFilterConfigTest, ThriftProxyWithEmptyProto) {
  envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy config =
      *dynamic_cast<envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy*>(
