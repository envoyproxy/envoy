...
inline envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::ConnPoolSettings
createConnPoolSettings(
    ...
    envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::ConnPoolSettings::ReadPolicy
        read_policy = envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::
            ConnPoolSettings::MASTER) {
  envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::ConnPoolSettings setting{};
