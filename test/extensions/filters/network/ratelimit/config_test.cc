...
#include "envoy/config/filter/network/rate_limit/v3alpha/rate_limit.pb.h"
#include "envoy/config/filter/network/rate_limit/v3alpha/rate_limit.pb.validate.h"
...
TEST(RateLimitFilterConfigTest, ValidateFail) {
  ...
  EXPECT_THROW(RateLimitConfigFactory().createFilterFactoryFromProto(
                   envoy::config::filter::network::rate_limit::v3alpha::RateLimit(), context),
...
TEST(RateLimitFilterConfigTest, CorrectProto) {
  ...
  envoy::config::filter::network::rate_limit::v3alpha::RateLimit proto_config{};
...
TEST(RateLimitFilterConfigTest, EmptyProto) {
  ...
  envoy::config::filter::network::rate_limit::v3alpha::RateLimit empty_proto_config =
      *dynamic_cast<envoy::config::filter::network::rate_limit::v3alpha::RateLimit*>(
