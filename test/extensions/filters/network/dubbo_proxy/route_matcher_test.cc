...
routes:
  ...
  // match with mutiple set of weighted cluster metadta criteria defined
  {
  ...
  // weight cluster match with single metadta entry
  {
...
routes:
  ...
  // match with weighted cluster metadta and route action metadata
  {
