#include "envoy/config/filter/network/dubbo_proxy/v3alpha/dubbo_proxy.pb.h"
#include "envoy/config/filter/network/dubbo_proxy/v3alpha/dubbo_proxy.pb.validate.h"
#include "envoy/config/filter/network/dubbo_proxy/v3alpha/route.pb.h"
#include "envoy/config/filter/network/dubbo_proxy/v3alpha/route.pb.validate.h"
...
envoy::config::filter::network::dubbo_proxy::v3alpha::RouteConfiguration
parseRouteConfigurationFromV2Yaml(const std::string& yaml) {
  envoy::config::filter::network::dubbo_proxy::v3alpha::RouteConfiguration route_config;
  TestUtility::loadFromYaml(yaml, route_config);
  TestUtility::validate(route_config);
  return route_config;
}

envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy
parseDubboProxyFromV2Yaml(const std::string& yaml) {
  envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy config;
...
routes:
  - match:
    ...
    envoy::config::filter::network::dubbo_proxy::v3alpha::RouteConfiguration config =
...
route_config:
  ...
  {
    envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy invalid_config;
