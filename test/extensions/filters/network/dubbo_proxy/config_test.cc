...
using DubboProxyProto = envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy;
...
TEST_F(DubboFilterConfigTest, ValidateFail) {
  ...
  EXPECT_THROW(DubboProxyFilterConfigFactory().createFilterFactoryFromProto(
                   envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy(), context),
...
TEST_F(DubboFilterConfigTest, DubboProxyWithEmptyProto) {
  ...
  DubboProxyFilterConfigFactory factory;
  envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy config =
      *dynamic_cast<envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy*>(
