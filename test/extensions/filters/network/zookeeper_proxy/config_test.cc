...
enable_per_opcode_request_response_bytes: true
...
stat_prefix: test_prefix
  ...
  EXPECT_EQ(proto_config_.enable_per_opcode_request_response_bytes(), false);
...
TEST_F(ZookeeperFilterConfigTest, FullConfig) {
  ...
  EXPECT_EQ(proto_config_.enable_per_opcode_request_response_bytes(), true);
