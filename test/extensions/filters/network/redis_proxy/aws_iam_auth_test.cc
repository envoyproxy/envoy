...
TEST_F(AwsIamAuthenticatorTest, CredentialPendingAuthentication) {
  ...
  std::optional<Common::Redis::AwsIamAuthenticator::AwsIamAuthenticatorSharedPtr> authenticator =
      mock_authenticator;
  ...
  Envoy::Extensions::NetworkFilters::Common::Redis::Client::ClientPtr client = factory.create(
      ...
      Envoy::Extensions::NetworkFilters::Common::Redis::RespProtocolVersion::Resp2, absl::nullopt);
