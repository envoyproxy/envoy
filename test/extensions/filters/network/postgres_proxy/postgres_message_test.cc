...
TEST(PostgresMessage, SingleField) {
	//FullMessage<Int32> msg('B', 5);
 
	//std::unique_ptr<MessageI> msg = std::make_unique<FullMessage<Int32>>('B', 5);
	std::unique_ptr<MessageI> msg = createMsg<Int32>('B', 5);
...
TEST(PostgresMessage, SingleString) {
	std::unique_ptr<MessageI> msg = std::make_unique<FullMessage<String>>('B', 5);
...
TEST(PostgresMessage, SingleStringViaBind) {
	auto f = std::bind(createMsg<Int32>, 'B', 5);
...
TEST(PostgresMessage, SingleByte1) {
	auto f = std::bind(createMsg<Byte1>, 'B', 5);
...
TEST(PostgresMessage, SingleByteN) {
	auto f = std::bind(createMsg<ByteN>, 'B', 5);
...
TEST(PostgresMessage, EmptyArray) {
	auto f = std::bind(createMsg<Array<Int32>>, 'B', 5);
...
TEST(PostgresMessage, NoEmptyArrayOf16bitInts) {
	auto f = std::bind(createMsg<Array<Int16>>, 'B', 5);
...
TEST(PostgresMessage, NoEmptyArrayOf8bitInts) {
	auto f = std::bind(createMsg<Array<Int8>>, 'B', 5);
...
TEST(PostgresMessage, NoEmptyArrayOfStruct) {
	auto f = std::bind(createMsg<Array<FullMessage<Int8>>>, 'B', 5);
	//std::unique_ptr<MessageI> msg = std::make_unique<Array<FullMessage<Int32>>>('B', 5);
...
TEST(PostgresMessage, NoEmptyArrayOfStruct1) {
	auto f = std::bind(createMsg<Array<FullMessage<Int8, Int16>>>, 'B', 5);
	//std::unique_ptr<MessageI> msg = std::make_unique<Array<FullMessage<Int32>>>('B', 5);
...
TEST(PostgresMessage, Byte1AndString) {
	auto f = std::bind(createMsg<Byte1,String>, 'B', 5);
