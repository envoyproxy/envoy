...
impl RootContext for TestRoot {
  fn on_tick(&mut self) {
    ...
    self
      .set_shared_data("shared_data_key1", Some(b"shared_data_value0"), None)
      .unwrap();
    self
      .set_shared_data("shared_data_key1", Some(b"shared_data_value1"), None)
      .unwrap();
    self
      .set_shared_data("shared_data_key2", Some(b"shared_data_value2"), None)
      .unwrap();
