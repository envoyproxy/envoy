...
// filter virtualHostMetadata() API. Covers both the upgrade required and no authority cases.
  ...
  default_source_code:
    inline_string: |
      function envoy_on_response(response_handle)
        local metadata = response_handle:virtualHostMetadata():get("foo.bar")
  ...
  default_source_code:
    inline_string: |
      function envoy_on_request(request_handle)
        ...
        local vhost_metadata = request_handle:virtualHostMetadata():get("foo.bar")
      ...
      function envoy_on_response(response_handle)
        local vhost_metadata = response_handle:virtualHostMetadata():get("foo.bar")
        local metadata = response_handle:metadata():get("foo.bar")
