...
- match:
  ...
  StreamInfo::FilterStateImpl filter_state(nullptr, StreamInfo::FilterState::LifeSpan::FilterChain);
...
filter_state_rules:
  ...
  // Empty filter_state
  StreamInfo::FilterStateImpl filter_state1(nullptr,
                                            StreamInfo::FilterState::LifeSpan::FilterChain);
  EXPECT_TRUE(filter_conf.findVerifier(Http::TestHeaderMapImpl(), filter_state1) == nullptr);

  // Wrong selector
  StreamInfo::FilterStateImpl filter_state2(nullptr,
                                            StreamInfo::FilterState::LifeSpan::FilterChain);
  ...
  // correct selector
  StreamInfo::FilterStateImpl filter_state3(nullptr,
                                            StreamInfo::FilterState::LifeSpan::FilterChain);
  ...
  // correct selector
  StreamInfo::FilterStateImpl filter_state4(nullptr,
                                            StreamInfo::FilterState::LifeSpan::FilterChain);
