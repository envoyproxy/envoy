...
class ExtractorRuntimeGuradTest : public testing::Test {
public:
...
TEST_F(ExtractorRuntimeGuradTest, TestDefaultHeaderLocationWithValidJWTEndedWithSpaceAndMoreCharachters) {
