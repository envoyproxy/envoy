...
public:
  ...
  void initialize() override {
    config_helper_.addConfigModifier([this](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
      ...
      // 1. Set up header_to_metadata filter config (Fake Cache)
      ...
      // 2. Set up ext_authz filter config
      ...
      ext_authz_proto.set_check_response_metadata_key("cached_authz_response");
