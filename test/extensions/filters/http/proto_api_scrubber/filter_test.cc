...
protected:
  ...
  void setupFilterConfig(absl::string_view config_pb,
    ...
    static_cast<void>(Protobuf::TextFormat::ParseFromString(config_pb, &proto_config_));
  ...
  apikeys::CreateApiKeyRequest makeCreateApiKeyRequest(absl::string_view pb = R"pb(
    ...
    static_cast<void>(Envoy::Protobuf::TextFormat::ParseFromString(pb, &request));
    return request;
  }
  ...
  ScrubRequest makeScrubRequestWithAny(absl::string_view sensitive_secret) {
    ...
    static_cast<void>(request.mutable_any_field()->PackFrom(sensitive_msg));
    return request;
  }
...
TEST_F(ProtoApiScrubberScrubbingTest, ScrubRequestAnyField) {
  ...
  static_cast<void>(request.any_field().UnpackTo(&inner_message));
  ...
  static_cast<void>(scrubbed_request.any_field().UnpackTo(&scrubbed_inner));
