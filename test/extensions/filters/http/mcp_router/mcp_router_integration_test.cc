...
// Test notifications/resources/list_changed is forwarded to all backends.
TEST_P(McpRouterIntegrationTest, NotificationResourcesListChangedFanout) {
  initializeFilter();
...
// Test notifications/tools/list_changed is forwarded to all backends.
TEST_P(McpRouterIntegrationTest, NotificationToolsListChangedFanout) {
  initializeFilter();
...
// Test notifications/progress is forwarded to all backends.
TEST_P(McpRouterIntegrationTest, NotificationProgressFanout) {
  initializeFilter();
