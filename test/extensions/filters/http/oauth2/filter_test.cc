...
public:
  ...
  MOCK_METHOD(void, asyncGetAccessToken,
              (const std::string&, const std::string&, const std::string&, const std::string&, Envoy::Extensions::HttpFilters::Oauth2::AuthType));
};
...
public:
  ...
  FilterConfigSharedPtr getConfig(bool forward_bearer_token = true) {
    ...
    p.set_auth_type(envoy::extensions::filters::http::oauth2::v3::OAuth2Config_AuthType_URL_ENCODED_BODY);
