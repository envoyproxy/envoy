...
// Validates the behavior of the cookie validator when the combination of some fields could be same.
TEST_F(OAuth2Test, CookieValidatorSameHmacEncoding) {
  TestScopedRuntime scoped_runtime;
  scoped_runtime.mergeValues({
...
TEST_F(OAuth2Test, OAuthTestFullFlowPostWithParametersLegacyEncodingHmacEncoding) {
  TestScopedRuntime scoped_runtime;
  scoped_runtime.mergeValues({
      {"envoy.reloadable_features.oauth_use_url_encoding", "false"},
      {"envoy.reloadable_features.hmac_hex_encoding_only", "false"},
...
TEST_F(OAuth2Test, OAuthTestFullFlowPostWithParametersHmacEncoding) {
  TestScopedRuntime scoped_runtime;
  scoped_runtime.mergeValues({
      {"envoy.reloadable_features.oauth_use_url_encoding", "true"},
      {"envoy.reloadable_features.hmac_hex_encoding_only", "false"},
...
TEST_F(OAuth2Test, OAuthAccessTokenSucessWithTokens_oauth_use_standard_max_age_valueHmacEncoding) {
  TestScopedRuntime scoped_runtime;
  scoped_runtime.mergeValues({
      {"envoy.reloadable_features.oauth_use_standard_max_age_value", "false"},
      {"envoy.reloadable_features.hmac_hex_encoding_only", "false"},
...
TEST_F(OAuth2Test, OAuthAccessTokenSucessWithTokens_oauth_make_token_cookie_httponlyHmacEncoding) {
  TestScopedRuntime scoped_runtime;
  scoped_runtime.mergeValues({
      {"envoy.reloadable_features.oauth_make_token_cookie_httponly", "false"},
      {"envoy.reloadable_features.hmac_hex_encoding_only", "false"},
