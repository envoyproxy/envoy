...
public:
  ...
  void SetUp() override {
    const envoy::config::filter::http::adaptive_concurrency::v3alpha::AdaptiveConcurrency config;
  ...
  envoy::config::filter::http::adaptive_concurrency::v3alpha::AdaptiveConcurrency
  makeConfig(const std::string& yaml_config) {
    envoy::config::filter::http::adaptive_concurrency::v3alpha::AdaptiveConcurrency proto;
