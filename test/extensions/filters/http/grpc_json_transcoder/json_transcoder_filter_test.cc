...
protected:
  ...
  std::string makeProtoDescriptor(std::function<void(FileDescriptorSet&)> process) {
    ...
    static_cast<void>(descriptor_set.ParseFromString(
        api_->fileSystem()
    ...
    static_cast<void>(descriptor_set.SerializeToOstream(&file));
...
TEST_F(GrpcJsonTranscoderFilterTest, TranscodingUnaryPost) {
  ...
  static_cast<void>(request.ParseFromString(frames[0].data_->toString()));
...
TEST_F(GrpcJsonTranscoderFilterTest, ForwardUnaryPostGrpc) {
  ...
  static_cast<void>(forwarded_request.ParseFromString(frames[0].data_->toString()));
  ...
  static_cast<void>(forwarded_response.ParseFromString(frames[0].data_->toString()));
...
TEST_F(GrpcJsonTranscoderFilterTestWithLargerBuffer, TranscodingStreamPostWithLargeBufferHttpBody) {
  ...
  expected_second_request.mutable_nested()->mutable_content()->set_data(
      std::string(JsonTranscoderConfig::MaxStreamedPieceSize, 'X'));
  static_cast<void>(request.ParseFromString(frames[1].data_->toString()));
  ...
  static_cast<void>(request.ParseFromString(frames[2].data_->toString()));
