#include "envoy/config/filter/http/fault/v3alpha/fault.pb.h"
#include "envoy/config/filter/http/fault/v3alpha/fault.pb.validate.h"
...
TEST(FaultFilterConfigTest, ValidateFail) {
  ...
  envoy::config::filter::http::fault::v3alpha::HTTPFault fault;
  fault.mutable_abort();
...
TEST(FaultFilterConfigTest, FaultFilterCorrectProto) {
  envoy::config::filter::http::fault::v3alpha::HTTPFault config;
