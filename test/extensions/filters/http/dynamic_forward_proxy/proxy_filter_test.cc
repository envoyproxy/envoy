...
public:
  ProxyFilterTest() {
    ...
    envoy::config::filter::http::dynamic_forward_proxy::v3alpha::FilterConfig proto_config;
...
TEST_F(ProxyFilterTest, HostRewrite) {
  ...
  envoy::config::filter::http::dynamic_forward_proxy::v3alpha::PerRouteConfig proto_config;
