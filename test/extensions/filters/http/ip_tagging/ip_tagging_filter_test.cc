 ...
 ip_tags_path: "{{ test_rundir }}/test/extensions/filters/http/ip_tagging/test_data/ip_tags_internal_request.json"
  ...
  auto provider1 =
      ip_tags_registry1->get(IpTaggingFilterConfigPeer::ipTagsPath(*config1),
                             ...
                             *api_, dispatcher_, ip_tags_registry1);
  auto provider2 =
...
//   initializeFilter(test_case.yaml_config_, cb_added_nullopt);
...
//   std::string reloaded_ip_tags_file_path = TestEnvironment::substitute(test_case.reloaded_ip_tags_file_path_);
//   std::cerr << "source_ip_tags_file_path: " << source_ip_tags_file_path << std::endl;
//   std::cerr << "reloaded_ip_tags_file_path: " << reloaded_ip_tags_file_path << std::endl;
