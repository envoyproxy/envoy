...
//                             proto_config1);
//   auto config1 = std::make_shared<IpTaggingFilterConfig>(proto_config1, ip_tags_registry,
//   "prefix.",
//                                                          *stats_.rootScope(), runtime_, *api_,
//                                                          dispatcher_, validation_visitor_);
...
//   auto config2 = std::make_shared<IpTaggingFilterConfig>(proto_config2, ip_tags_registry,
//   "prefix.",
//                                                          *stats_.rootScope(), runtime_, *api_,
//                                                          dispatcher_, validation_visitor_);
...
//  request_type: external
//  ip_tags_path: "{{ test_rundir
//  }}/test/extensions/filters/http/ip_tagging/test_data/ip_tags_both.json" )EOF";
//   envoy::extensions::filters::http::ip_tagging::v3::IPTagging proto_config2;
//   TestUtility::loadFromYaml(TestEnvironment::substitute(config2_string), proto_config2);
//   auto config2 = std::make_shared<IpTaggingFilterConfig>(proto_config2, ip_tags_registry,
//   "prefix.",
