...
#include "test/proto/scrubbing.pb.h"
...
class ScrubbingUtilTest : public ::testing::Test {
protected:
...
TEST_F(ScrubbingUtilTest, IsEmptyStruct_EmptyStruct) {
...
TEST_F(ScrubbingUtilTest, IsEmptyStruct_NonEmptyStruct) {
  ProtobufWkt::Struct message_struct;
  message_struct.mutable_fields()->insert({kTypeProperty, ProtobufWkt::Value()});
...
TEST_F(ScrubbingUtilTest, IsLabelName_ValidLabel) { EXPECT_TRUE(IsLabelName("{label}")); }

TEST_F(ScrubbingUtilTest, IsLabelName_EmptyString) { EXPECT_FALSE(IsLabelName("")); }

TEST_F(ScrubbingUtilTest, GetLabelName_RemovesCurlyBraces) {
  EXPECT_EQ(GetLabelName("{test}"), "test");
}

TEST_F(ScrubbingUtilTest, GetLabelName_NoCurlyBraces) { EXPECT_EQ(GetLabelName("test"), "test"); }

TEST_F(ScrubbingUtilTest, GetLabelName_EmptyString) { EXPECT_EQ(GetLabelName(""), ""); }

TEST_F(ScrubbingUtilTest, GetMonitoredResourceLabels_BasicExtraction) {
...
TEST_F(ScrubbingUtilTest, StringToDirectiveMap_CorrectMapping) {
  const auto& map = StringToDirectiveMap();

  EXPECT_EQ(map.size(), 2);
  EXPECT_EQ(map.at(kScrubRedact), ScrubbedMessageDirective::SCRUB_REDACT);
  EXPECT_EQ(map.at(kScrub), ScrubbedMessageDirective::SCRUB);
}

TEST_F(ScrubbingUtilTest, ScrubbedMessageDirectiveFromString_ValidDirective) {
  auto directive = ScrubbedMessageDirectiveFromString(kScrubRedact);
  ASSERT_TRUE(directive.has_value());
  EXPECT_EQ(directive.value(), ScrubbedMessageDirective::SCRUB_REDACT);

  directive = ScrubbedMessageDirectiveFromString(kScrub);
  ASSERT_TRUE(directive.has_value());
  EXPECT_EQ(directive.value(), ScrubbedMessageDirective::SCRUB);
}

TEST_F(ScrubbingUtilTest, ScrubbedMessageDirectiveFromString_InvalidDirective) {
  auto directive = ScrubbedMessageDirectiveFromString("invalid_directive");
  EXPECT_FALSE(directive.has_value());
}

TEST_F(ScrubbingUtilTest, GetMonitoredResourceLabels_MissingLabelsInResource) {
  GetMonitoredResourceLabels("project/*/bucket/{bucket}/object/{object}",
...
TEST_F(ScrubbingUtilTest, GetMonitoredResourceLabels_ExtraSegmentsInResource) {
  GetMonitoredResourceLabels("project/*/bucket/{bucket}/object/{object}",
...
TEST_F(ScrubbingUtilTest, GetMonitoredResourceLabels_WithNoLabels) {
...
TEST_F(ScrubbingUtilTest, GetMonitoredResourceLabels_EmptyLabelExtractor) {
...
TEST_F(ScrubbingUtilTest, RedactStructRecursively_InvalidPath) {
  Struct message_struct = CreateNestedStruct({"level1", "level2"}, "value");
...
TEST_F(ScrubbingUtilTest, RedactStructRecursively_ValidPath) {
  Struct message_struct = CreateNestedStruct({"level1", "level2"}, "value");
...
TEST_F(ScrubbingUtilTest, RedactStructRecursively_MissingIntermediateField) {
...
TEST_F(ScrubbingUtilTest, RedactStructRecursively_EmptyPathPiece) {
  Struct message_struct = CreateNestedStruct({"level1", "level2"}, "value");
...
TEST_F(ScrubbingUtilTest, RedactStructRecursively_NullptrMessageStruct) {
  std::vector<std::string> path_pieces = {"level1"};
...
TEST_F(ScrubbingUtilTest, FindSingularLastValue_SingleStringField) {
  Field field;
  field.set_name("id");
  field.set_number(1);
...
TEST_F(ScrubbingUtilTest, FindSingularLastValue_RepeatedStringField) {
  Field field;
...
TEST_F(ScrubbingUtilTest, FindSingularLastValue_RepeatedMessageField) {
  Field field;
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_string) {
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_double) {
  EXPECT_EQ(1,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_float) {
  EXPECT_EQ(2,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_int64) {
  EXPECT_EQ(3,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_uint64) {
  EXPECT_EQ(4,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_int32) {
  EXPECT_EQ(5,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_fixed64) {
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_fixed32) {
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_bool) {
  EXPECT_EQ(5,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_uint32) {
  EXPECT_EQ(8,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_sfixed64) {
  EXPECT_EQ(6, ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_sfixed32) {
  EXPECT_EQ(7, ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_sint32) {
  EXPECT_EQ(5,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_sint64) {
  EXPECT_EQ(6,
            ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_OK_DefaultValue) {
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_Error_EmptyPath) {
  EXPECT_LT(ExtractRepeatedFieldSize(*request_type_, type_finder_, GetFieldMaskWith(""),
                                     test_request_raw_proto_),
            0);
}

TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_Error_NonRepeatedField) {
  EXPECT_LT(ExtractRepeatedFieldSize(*request_type_, type_finder_, GetFieldMaskWith("bucket.ratio"),
                                     test_request_raw_proto_),
            0);
}

TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_Error_UnknownField) {
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_Error_NonLeafPrimitiveTypeField) {
  EXPECT_LT(ExtractRepeatedFieldSize(*request_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_Error_NonLeafMapField) {
...
TEST_F(ScrubbingUtilTest, ExtractRepeatedFieldSize_Error_NonLeafRepeatedField) {
  EXPECT_LT(ExtractRepeatedFieldSize(*response_type_, type_finder_,
...
TEST_F(ScrubbingUtilTest, ExtractStringFieldValue_Error_EmptyPath) {
  EXPECT_THAT(ExtractStringFieldValue(*request_type_, type_finder_, "", test_request_raw_proto_),
              StatusIs(absl::StatusCode::kInvalidArgument));
}

TEST_F(ScrubbingUtilTest, ExtractStringFieldValue_Error_UnknownField) {
...
TEST_F(ScrubbingUtilTest, ExtractStringFieldValue_Error_RepeatedStringLeafNode) {
  EXPECT_THAT(ExtractStringFieldValue(*request_type_, type_finder_, "repeated_strings",
                                      test_request_raw_proto_),
              StatusIs(absl::StatusCode::kInvalidArgument));
}

TEST_F(ScrubbingUtilTest, ExtractStringFieldValue_Error_NonStringLeafNode) {
...
TEST_F(ScrubbingUtilTest, ExtractStringFieldValue_Error_InvalidTypeFinder) {
