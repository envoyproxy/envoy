...
#include "envoy/extensions/filters/common/rbac/matchers/v3/upstream_ip_matcher.pb.h"
...
void upstreamIpTestsBasicPolicySetup(RoleBasedAccessControlFilterTest& test,
  ...
  for (const auto& ip : upstream_ips) {
    envoy::extensions::filters::common::rbac::matchers::v3::UpstreamIpMatcher matcher;
