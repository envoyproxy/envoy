...
// Tests simple upstream_ip ALLOW permission policy with ONLY upstream ip metadata in the filter state.
...
// Tests simple upstream_ip DENY permission policy with ONLY upstream ip metadata in the filter state.
