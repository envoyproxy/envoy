...
void ExtProcIntegrationTest::addDownstreamExtProcFilter(
  ...
  static_cast<void>(ext_proc_filter.mutable_typed_config()->PackFrom(proto_config));
...
void ExtProcIntegrationTest::initializeConfig(
  ...
  config_helper_.addConfigModifier([this, cluster_endpoints, config_option](
    ...
    if (config_option.add_metadata) {
      ...
      static_cast<void>(typed_md->mutable_typed_value()->PackFrom(typed_md_to_stuff));

      static_cast<void>(set_metadata_filter.mutable_typed_config()->PackFrom(set_metadata_config));
  ...
  *(md_val.mutable_struct_value()) = test_md_struct;
  ...
  processGenericMessage(
      *grpc_upstreams_[0], true, [md_val](const ProcessingRequest& req, ProcessingResponse& resp) {
        ...
        static_cast<void>(fwd_typed_metadata.UnpackTo(&typed_md_from_req));
...
void ExtProcIntegrationTest::prependExtProcCompositeFilter(const Protobuf::Message& match_input) {
  ...
  static_cast<void>(extension_config->mutable_typed_config()->PackFrom(composite_config));
  ...
  static_cast<void>(input->mutable_typed_config()->PackFrom(match_input));
  ...
  static_cast<void>(typed_config->mutable_typed_config()->PackFrom(proto_config_));
  ...
  static_cast<void>(composite_filter.mutable_typed_config()->PackFrom(extension_with_matcher));
