...
TEST_P(ExtProcIntegrationTest, GetAndCloseStreamWithTracing) {
  ...
  config_helper_.addConfigModifier([&](HttpConnectionManager& cm) {
    ...
    static_cast<void>(tracing->mutable_provider()->mutable_typed_config()->PackFrom(test_config));
  });
  ...
  void initializeConfig() {
    ...
    config_helper_.addConfigModifier([this](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
      ...
      if (old_protocol_options.http_filters().empty()) {
        ...
        static_cast<void>(http_filter->mutable_typed_config()->PackFrom(
      ...
      static_cast<void>(ext_proc_filter->mutable_typed_config()->PackFrom(proto_config_));
      for (int i = old_protocol_options.http_filters_size() - 1; i > 0; --i) {
        old_protocol_options.mutable_http_filters()->SwapElements(i, i - 1);
      }
      static_cast<void>((*cluster->mutable_typed_extension_protocol_options())
                            ["envoy.extensions.upstreams.http.v3.HttpProtocolOptions"]
...
TEST_P(ExtProcIntegrationTest, PerRouteGrpcService) {
  ...
  config_helper_.addConfigModifier([this](HttpConnectionManager& cm) {
    ...
    if (clientType() == Grpc::ClientType::EnvoyGrpc) {
      ...
      static_cast<void>(logging_filter.mutable_typed_config()->PackFrom(logging_filter_config));
...
TEST_P(ExtProcIntegrationTest, SendClusterMetadata) {
  ...
  config_helper_.addConfigModifier([&](envoy::config::bootstrap::v3::Bootstrap& bootstrap) {
    ...
    static_cast<void>(any_val.PackFrom(struct_val));
...
TEST_P(ExtProcIntegrationTest, MappedAttributeBuilder) {
  ...
  static_cast<void>(modifier_config->mutable_typed_config()->PackFrom(builder));
...
TEST_P(ExtProcIntegrationTest, RetryOnDifferentHost) {
  ...
  static_cast<void>(host_predicate->mutable_typed_config()->PackFrom(previous_hosts_config));
