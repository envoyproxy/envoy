...
//   EXPECT_EQ(expected, engine.handleAction(connection, headers, info, nullptr));
// }
...
//   Envoy::Network::Address::InstanceConstSharedPtr addr =
//       Envoy::Network::Utility::parseInternetAddress("1.2.3.4", 123, false);
//   checkEngineLog(engine, RBAC::RoleBasedAccessControlEngine::LogDecision::Undecided, conn,
//   headers,
//                  info);
