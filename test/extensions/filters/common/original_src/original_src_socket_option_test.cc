...
TEST_F(OriginalSrcSocketOptionTest, TestSetOptionPreBindSetsAddress) {
  ...
  EXPECT_EQ(option->setOption(socket_, envoy::api::v3alpha::core::SocketOption::STATE_PREBIND),
            true);
}
...
TEST_F(OriginalSrcSocketOptionTest, TestSetOptionNotPrebindDoesNotSetAddress) {
  ...
  EXPECT_EQ(option->setOption(socket_, envoy::api::v3alpha::core::SocketOption::STATE_LISTENING),
            true);
}
...
TEST_F(OriginalSrcSocketOptionTest, TestOptionDetailsNotSupported) {
  ...
  auto details =
      option->getOptionDetails(socket_, envoy::api::v3alpha::core::SocketOption::STATE_PREBIND);
