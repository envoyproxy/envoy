...
//         path_prefix_{"/bar"},
//         timeout_{},
//         allowed_request_headers_{Matchers::StringMatcher{":method"},
//         Matchers::StringMatcher{":path"}},
//         allowed_client_headers_{Matchers::StringMatcher{"foo"},
//         Matchers::StringMatcher{":status"}},
//         allowed_upstream_headers_{Matchers::StringMatcher{"bar"}},
//         authorization_headers_to_add_{},
//         async_client_{},
//         async_request_{&async_client_},
//         client_(cluster_manager_, cluster_name_, timeout_, path_prefix_,
...
//   const auto* x_content_type =
//   message_ptr->headers().get(Http::Headers::get().XContentTypeOptions); ASSERT_NE(x_content_type,
//   nullptr); EXPECT_EQ(x_content_type->value().getStringView(), "foobar");
// }
...
//       TestCommon::makeAuthzResponse(CheckStatus::OK, Http::Code::OK, empty_body,
//       expected_headers);
...
// parsed. TEST_F(ExtAuthzHttpClientTest, AuthorizationRequestErrorParsingStatusCode) {
//   Http::MessagePtr check_response(new Http::ResponseMessageImpl(
