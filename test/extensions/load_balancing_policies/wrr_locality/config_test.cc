...
TEST(WrrLocalityConfigTest, ValidateSuccess) {
  ...
  static_cast<void>(cswrr_config.mutable_typed_config()->PackFrom(cswrr_config_msg));
  ...
  *(wrr_locality_config_msg.mutable_endpoint_picking_policy()
  ...
  static_cast<void>(wrr_locality_config.mutable_typed_config()->PackFrom(wrr_locality_config_msg));
...
TEST(WrrLocalityConfigTest, ValidateFailureUnsupportedEndpointPickingPolicy) {
  ...
  static_cast<void>(epp_config.mutable_typed_config()->PackFrom(epp_config_msg));
