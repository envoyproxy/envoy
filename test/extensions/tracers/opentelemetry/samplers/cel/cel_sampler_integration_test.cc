...
public:
  CELSamplerIntegrationTest() : HttpIntegrationTest(Http::CodecType::HTTP1, GetParam()) {
...
INSTANTIATE_TEST_SUITE_P(IpVersions, CELSamplerIntegrationTest,
                         testing::ValuesIn(TestEnvironment::getIpVersionsForTest()),
                         TestUtility::ipTestParamsToString);

// Sends a request with traceparent and tracestate header.
TEST_P(CELSamplerIntegrationTest, TestWithTraceparentAndTracestate) {
...
TEST_P(CELSamplerIntegrationTest, TestWithTraceparentOnly) {
...
TEST_P(CELSamplerIntegrationTest, TestWithoutTraceparentAndTracestate) {
  Http::TestRequestHeaderMapImpl request_headers{
