...
class DynatraceResourceDetectorIntegrationTest
    : public Envoy::HttpIntegrationTest,
      public testing::TestWithParam<Network::Address::IpVersion> {
public:
  DynatraceResourceDetectorIntegrationTest()
...
INSTANTIATE_TEST_SUITE_P(IpVersions, DynatraceResourceDetectorIntegrationTest,
                         testing::ValuesIn(TestEnvironment::getIpVersionsForTest()),
                         TestUtility::ipTestParamsToString);

// Verify Envoy starts even when the Dynatrace resource detector wasn't able to detect any
// attributes
TEST_P(DynatraceResourceDetectorIntegrationTest, TestWithNoDynatraceDeployed) {
