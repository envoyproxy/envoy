// A header formatter module missing envoy_dynamic_module_on_header_formatter_new,
// used to check that an unresolvable ABI symbol is reported as a module load failure.
#include <stdbool.h>
#include <stddef.h>
#include <string.h>
