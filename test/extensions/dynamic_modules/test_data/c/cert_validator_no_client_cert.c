...
// This is a cert validator module that returns NoClientCertificate detailed status.
...
envoy_dynamic_module_on_cert_validator_do_verify_cert_chain(
  ...
  result.detailed_status =
      envoy_dynamic_module_type_cert_validator_client_validation_status_NoClientCertificate;
  result.tls_alert = 0;
...
static const char digest_data[] = "cert_validator_no_client_cert";
