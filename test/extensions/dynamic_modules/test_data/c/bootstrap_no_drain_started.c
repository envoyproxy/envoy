...
// A bootstrap extension that is missing envoy_dynamic_module_on_bootstrap_extension_drain_started.
...
// envoy_dynamic_module_on_bootstrap_extension_drain_started is intentionally missing.
