// Cert validator fake that omits envoy_dynamic_module_on_cert_validator_config_destroy. Used to
...
// Intentionally NOT defining envoy_dynamic_module_on_cert_validator_config_destroy.
