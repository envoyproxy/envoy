...
// Test module that returns StopAndBuffer from encode_data and on_upstream_data.
...
envoy_dynamic_module_on_upstream_http_tcp_bridge_encode_data(
  ...
  (void)bridge_module_ptr;
  (void)end_of_stream;
  return envoy_dynamic_module_type_upstream_http_tcp_bridge_status_StopAndBuffer;
}
