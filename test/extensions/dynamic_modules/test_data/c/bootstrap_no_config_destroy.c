...
// A bootstrap extension that is missing envoy_dynamic_module_on_bootstrap_extension_config_destroy.
...
// envoy_dynamic_module_on_bootstrap_extension_config_destroy is intentionally missing.
