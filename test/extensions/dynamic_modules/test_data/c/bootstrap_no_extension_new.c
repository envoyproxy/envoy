...
// A bootstrap extension that is missing envoy_dynamic_module_on_bootstrap_extension_new.
...
// envoy_dynamic_module_on_bootstrap_extension_new is intentionally missing.
