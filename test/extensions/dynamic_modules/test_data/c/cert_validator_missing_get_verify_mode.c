// Cert validator fake that omits envoy_dynamic_module_on_cert_validator_get_ssl_verify_mode. Used
...
// Intentionally NOT defining envoy_dynamic_module_on_cert_validator_get_ssl_verify_mode.
