...
DEFINE_FUZZER(const uint8_t* buf, size_t len) {
  ...
  Gzip::Decompressor::ZlibDecompressorImpl decompressor;

  // Select target compression level. We can't use ConsumeEnum() since the range
  // is non-contiguous.
  const Envoy::Compressor::ZlibCompressorImpl::CompressionLevel compression_levels[] = {
  ...
  const Envoy::Compressor::ZlibCompressorImpl::CompressionLevel target_compression_level =
  ...
  const Envoy::Compressor::ZlibCompressorImpl::CompressionStrategy compression_strategies[] = {
      Envoy::Compressor::ZlibCompressorImpl::CompressionStrategy::Filtered,
      Envoy::Compressor::ZlibCompressorImpl::CompressionStrategy::Huffman,
      Envoy::Compressor::ZlibCompressorImpl::CompressionStrategy::Rle,
      Envoy::Compressor::ZlibCompressorImpl::CompressionStrategy::Standard,
  };
  const Envoy::Compressor::ZlibCompressorImpl::CompressionStrategy target_compression_strategy =
  ...
  while (!provider_empty) {
    ...
    compressor.compress(buffer, provider_empty ? Envoy::Compressor::State::Finish
                                               : Envoy::Compressor::State::Flush);
