...
TEST_P(CredentialInjectorUpstreamIntegrationTest, InjectProxyAuthorizationHeader) {
  ...
  static_cast<void>(filter_config.mutable_typed_config()->PackFrom(credential_injector_config));
  ...
  config_helper_.addConfigModifier([&](envoy::config::bootstrap::v3::Bootstrap& bootstrap) -> void {
    ...
    static_cast<void>(filter->mutable_typed_config()->PackFrom(proxy_config));
