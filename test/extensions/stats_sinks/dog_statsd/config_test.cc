...
TEST_P(DogStatsdConfigLoopbackTest, ValidUdpIp) {
  ...
  envoy::api::v3alpha::core::Address& address = *sink_config.mutable_address();
  envoy::api::v3alpha::core::SocketAddress& socket_address = *address.mutable_socket_address();
  socket_address.set_protocol(envoy::api::v3alpha::core::SocketAddress::UDP);
