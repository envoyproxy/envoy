...
public:
  ...
  using MetricsServiceCallbacks =
      Grpc::AsyncStreamCallbacks<envoy::service::metrics::v3alpha::StreamMetricsResponse>;
...
TEST_F(GrpcMetricsStreamerImplTest, BasicFlow) {
  ...
  envoy::service::metrics::v3alpha::StreamMetricsMessage message_metrics1;
  ...
  callbacks1->onReceiveMessage(
      std::make_unique<envoy::service::metrics::v3alpha::StreamMetricsResponse>());
}
...
public:
  // GrpcMetricsStreamer
  MOCK_METHOD1(send, void(envoy::service::metrics::v3alpha::StreamMetricsMessage& message));
};
