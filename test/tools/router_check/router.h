...
private:
   ...
   */
  static void assignUniqueRouteNames(envoy::api::v3alpha::RouteConfiguration& route_config);
  /**
   ...
   */
  static void assignRuntimeFraction(envoy::api::v3alpha::RouteConfiguration& route_config);
