...
load(":envoy_select.bzl", "envoy_select_admin_functionality", "envoy_select_admin_html", "envoy_select_disable_logging", "envoy_select_enable_http3", "envoy_select_google_grpc", "envoy_select_hot_restart", "envoy_select_static_extension_registration", "envoy_select_envoy_mobile_request_compression")
