...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_google_ortools = dict(
        project_name = "or-tools",
        project_desc = "Software suite for combinatorial optimization.",
        project_url = "https://github.com/google/or-tools",
        version = "2384738a951561bf905f3435651310841c309b4c",
        sha256 = "b374f96f4509ab8c6c185bb497f4284c3b309bcaf87d1478eb4ddda009d1f12d",
        strip_prefix = "or-tools-{version}",
        urls = ["https://github.com/google/or-tools/archive/{version}.zip"],
        use_category = ["dataplane_ext"],
        extensions = ["envoy.filters.http.grpc_json_transcoder", "envoy.filters.http.grpc_field_extraction"],
        release_date = "2023-01-19",
        cpe = "N/A",
        license = "Apache-2.0",
        license_url = "https://github.com/google/or-tools/blob/stable/LICENSE",
    ),
    com_google_proto_field_extraction = dict(
        project_name = "proto-field-extraction",
        project_desc = "Library that supports the extraction from protobuf binary",
        project_url = "https://github.com/grpc-ecosystem/proto-field-extraction",
        version = "598807946f248917db4b7d2e7249de3e4eee0003",
        sha256 = "791501e8ba94b91017ecba56e17e83d8de828ba883ed559ba7cc47229ca3b31f",
        strip_prefix = "proto-field-extraction-{version}",
        urls = ["https://github.com/grpc-ecosystem/proto-field-extraction/archive/{version}.zip"],
        use_category = ["dataplane_ext"],
        extensions = ["envoy.filters.http.grpc_json_transcoder", "envoy.filters.http.grpc_field_extraction"],
    ...
    com_google_protoprocessinglib = dict(
        ...
        version = "09e6cf5da15c8b9d32c6706b2517890200110bc8",
        sha256 = "38c0a012cbf6ab98615c398f775f07b19addd03442c2811ea35a878f671aedbc",
