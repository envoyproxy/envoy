...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    grpc_httpjson_transcoding = dict(
        ...
        use_category = ["dataplane_ext"],
        extensions = ["envoy.filters.http.grpc_json_transcoder", "envoy.filters.http.grpc_field_extraction", "envoy.filters.http.proto_message_logging"],
    ...
    ocp = dict(
        ...
        use_category = ["dataplane_ext"],
        extensions = ["envoy.filters.http.grpc_field_extraction", "envoy.filters.http.proto_message_logging"],
