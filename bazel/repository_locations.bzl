...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    envoy_toolshed = dict(
        ...
        version = "bazel-0.0.1",
        sha256 = "ed9314a378d78b84741a7c275ca41e3c75c9216447d59efc4f8d091a26d9640f",
        strip_prefix = "toolshed-{version}/bazel",
        urls = ["https://github.com/envoyproxy/toolshed/archive/refs/tags/{version}.tar.gz"],
        use_category = ["build"],
        release_date = "2023-09-24",
        cpe = "N/A",
        license = "Apache-2.0",
        license_url = "https://github.com/envoyproxy/envoy/blob/{version}/LICENSE",
    ),
    rules_fuzzing = dict(
    ...
    com_github_rules_proto_grpc = dict(
        ...
        urls = ["https://github.com/rules-proto-grpc/rules_proto_grpc/releases/download/4.4.0/rules_proto_grpc-{version}.tar.gz"],
        use_category = ["dataplane_ext"],
    ...
    com_github_google_quiche = dict(
        ...
        version = "7db381c8d8ba3f334ca1ec95a86f2a45b11c5948",
        sha256 = "9e74805d23fd81736b9601ada2735c6532a3abadb8f809fe2cd7e07a40817056",
