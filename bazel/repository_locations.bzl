...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    envoy_examples = dict(
        ...
        version = "0.0.14",
        sha256 = "d4bca0fd62b27891dcb1a1db251840797862dbdf4e87894d97240bf13bc3417b",
    ...
    antlr4_cpp_runtime = dict(
        project_name = "ANTLR4 C++ Runtime",
        project_desc = "C++ runtime for ANTLR4",
        ...
        cpe = "N/A",
        license = "BSD-3-Clause",
        license_url = "https://github.com/antlr/antlr4/blob/{version}/LICENSE.txt",
    ),
