...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_bufbuild_protovalidate_cc = dict(
        project_name = "protovalidate-cc",
        project_desc = "Protocol Buffer validation library for C++ (CEL-based successor to PGV)",
        project_url = "https://github.com/bufbuild/protovalidate-cc",
        version = "0.9.0",
        sha256 = "eaf28b2d91cbd3367575546c2e9011bff26d6b08b26a16ef6b69283bbdf51e82",
    ...
    com_github_bufbuild_protovalidate = dict(
        ...
        project_desc = "Protocol Buffer Validation - Protocol Buffer definitions",
        project_url = "https://github.com/bufbuild/protovalidate",
        version = "0.14.2",
        sha256 = "8bb61a2c02c5b8442afbefb43edf885c52d1732a96579ad3af73a4bacbc36077",
        strip_prefix = "protovalidate-{version}",
        urls = ["https://github.com/bufbuild/protovalidate/archive/refs/tags/v{version}.tar.gz"],
        use_category = ["api", "dataplane_core", "controlplane"],
        release_date = "2025-07-21",
        cpe = "N/A",
        license = "Apache-2.0",
