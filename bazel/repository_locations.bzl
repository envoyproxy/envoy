...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_intel_isa_l = dict(
        project_name = "isa-l",
        project_desc = "Intel(R) Intelligent Storage Acceleration Library",
        project_url = "https://github.com/intel/isa-l",
        version = "2.30.0",
    ...
    com_github_netwide_assembler_nasm = dict(
        project_name = "nasm",
        project_desc = "NASM, the Netwide Assembler",
        project_url = "https://github.com/netwide-assembler/nasm",
        version = "nasm-2.15.05",
        sha256 = "9182a118244b058651c576baa9d0366ee05983c4d4ae1d9ddd3236a9f2304997",
        strip_prefix = "{version}",
        urls = ["https://www.nasm.us/pub/nasm/releasebuilds/2.15.05/{version}.tar.gz"],
        use_category = ["controlplane", "dataplane_core"],
