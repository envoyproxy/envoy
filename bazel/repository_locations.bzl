...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_luajit2_luajit2 = dict(
        ...
        version = "2.1-20230410",
        sha256 = "77bbcbb24c3c78f51560017288f3118d995fe71240aa379f5818ff6b166712ff",
        strip_prefix = "luajit2-{version}",
        urls = ["https://github.com/openresty/luajit2/archive/v{version}.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = ["envoy.filters.http.lua"],
        release_date = "2023-04-10",
        cpe = "cpe:2.3:a:luajit2_project:luajit2:*",
        license = "luajit2",
        license_url = "https://github.com/openresty/luajit2/blob/{version}/COPYRIGHT",
    ),
