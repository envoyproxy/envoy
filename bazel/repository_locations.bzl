...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    depend_on_what_you_use = dict(
        project_name = "depend_on_what_you_use",
        project_desc = "DWYU is a Bazel aspect for C++ projects making sure the headers your Bazel targets are using are aligned with their dependency lists",
        project_url = "https://github.com/martis42/depend_on_what_you_use",
        version = "0.8.0",
        sha256 = "2922f9b3a6435a14f4e05098e2324098acfb4f2da78d74f0a3e98543df241b16",
        strip_prefix = "depend_on_what_you_use-{version}",
        urls = ["https://github.com/martis42/depend_on_what_you_use/releases/download/{version}/depend_on_what_you_use-{version}.tar.gz"],
        use_category = ["build"],
        release_date = "2025-03-16",
        license = "MIT",
        license_url = "https://github.com/martis42/depend_on_what_you_use/blob/main/LICENSE",
    ),
    dwyu_pcpp = dict(
        project_name = "dwyu_pcpp",
        project_url = "https://github.com/ned14/pcpp",
        project_desc = "A pure universal Python C (pre-)preprocessor implementation very useful for pre-preprocessing header only C++ libraries into single file includes.",
