...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    llvm_source = dict(
        ...
        urls = ["https://github.com/llvm/llvm-project/archive/{version}.tar.gz"],
        use_category = ["build", "controlplane", "dataplane_core"],
        release_date = "2024-06-19",
        cpe = "cpe:2.3:a:llvm:llvm:*",
        license = "Apache-2.0",
        license_url = "https://github.com/llvm/llvm-project/blob/{version}/LICENSE.TXT",
    ),
