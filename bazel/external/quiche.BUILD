...
envoy_cc_library(
    ...
    hdrs = ["quiche/quic/platform/api/quic_server_stats.h"],
    repository = "@envoy",
    tags = ["nofips"],
    visibility = ["//visibility:public"],
    deps = [":quiche_common_platform_server_stats"],
)
...
envoy_cc_library(
    ...
    visibility = ["//visibility:public"],
    deps = [
        ":quiche_common_platform_default_quiche_platform_impl_stream_buffer_allocator_impl_lib",
        ":quiche_common_platform_export",
    ],
)
