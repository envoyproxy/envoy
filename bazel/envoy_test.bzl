...
_TEST_BENCHMARK_MAIN = Label("//test/benchmark:main")
...
def envoy_cc_fuzz_test(
    ...
    validate_repository("envoy_cc_fuzz_test", repository)
...
def envoy_cc_test(
        ...
        exec_properties = {}):
    # Deprecated: keep accepting `repository` for compatibility with downstream callers.
    validate_repository("envoy_cc_test", repository)
...
def envoy_cc_test_library(
        ...
        **kargs):
    # Deprecated: keep accepting `repository` for compatibility with downstream callers.
    validate_repository("envoy_cc_test_library", repository)
    exec_properties = exec_properties | select({
        _ENGFLOW_RBE_X86_64: {"Pool": rbe_pool} if rbe_pool else {},
        "//conditions:default": {},
    })
...
def envoy_cc_benchmark_binary(
        ...
        **kargs):
    # Deprecated: keep accepting `repository` for compatibility with downstream callers.
    validate_repository("envoy_cc_benchmark_binary", repository)
    envoy_cc_test_binary(
        name,
        deps = deps + [_TEST_BENCHMARK_MAIN],
        repository = repository,
        **kargs
    )
...
def envoy_cc_benchmark_dyn_module_binary(
        ...
        **kargs):
    # Deprecated: keep accepting `repository` for compatibility with downstream callers.
    validate_repository("envoy_cc_benchmark_dyn_module_binary", repository)
    envoy_cc_test_binary(
        name,
        deps = deps + [_TEST_BENCHMARK_MAIN],
        repository = repository,
...
def envoy_benchmark_test(
        ...
        **kargs):
    # Deprecated: keep accepting `repository` for compatibility with downstream callers.
    validate_repository("envoy_benchmark_test", repository)
    exec_properties = exec_properties | select({
        _ENGFLOW_RBE_X86_64: {"Pool": rbe_pool} if rbe_pool else {},
        "//conditions:default": {},
    })
