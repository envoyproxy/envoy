...
def envoy_proto_descriptor(name, out, srcs = [], external_deps = []):
    ...
    if "well_known_protos" in external_deps:
        srcs.append("@protobuf//src/google/protobuf:any.proto")
        srcs.append("@protobuf//src/google/protobuf:api.proto")
        srcs.append("@protobuf//src/google/protobuf:descriptor.proto")
        srcs.append("@protobuf//src/google/protobuf:duration.proto")
        srcs.append("@protobuf//src/google/protobuf:empty.proto")
        srcs.append("@protobuf//src/google/protobuf:field_mask.proto")
        srcs.append("@protobuf//src/google/protobuf:source_context.proto")
        srcs.append("@protobuf//src/google/protobuf:struct.proto")
        srcs.append("@protobuf//src/google/protobuf:timestamp.proto")
        srcs.append("@protobuf//src/google/protobuf:type.proto")
        srcs.append("@protobuf//src/google/protobuf:wrappers.proto")
        srcs.append("@protobuf//src/google/protobuf/compiler:plugin.proto")
        has_protobuf_deps = True
        protobuf_include_marker = "@protobuf//src/google/protobuf:any.proto"
