...
/*
 * BSSL:
 * https://github.com/google/boringssl/blob/098695591f3a2665fccef83a3732ecfc99acdcdd/src/include/openssl/evp.h#L135-L137
...
extern "C" int EVP_PKEY_id(const EVP_PKEY* pkey) {
  ...
  switch (ossl_id) {
  case ossl_EVP_PKEY_DSA:
    return EVP_PKEY_DSA;
  case ossl_EVP_PKEY_EC:
    return EVP_PKEY_EC;
  case ossl_EVP_PKEY_ED25519:
    return EVP_PKEY_ED25519;
  case ossl_EVP_PKEY_HKDF:
    return EVP_PKEY_HKDF;
  case ossl_EVP_PKEY_NONE:
    return EVP_PKEY_NONE;
  case ossl_EVP_PKEY_RSA:
    return EVP_PKEY_RSA;
  case ossl_EVP_PKEY_RSA_PSS:
    return EVP_PKEY_RSA_PSS;
  case ossl_EVP_PKEY_X25519:
