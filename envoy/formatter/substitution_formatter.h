...
using FormatterProviderResult = absl::StatusOr<std::unique_ptr<FormatterProvider>>;
...
public:
   ...
   *
   * @return FormatterProviderResult substitution provider for the parsed command or an error
   * status.
   */
