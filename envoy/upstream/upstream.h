...
public:
  ...
  /**
   * @return bool if true the cluster is created by a custom implementation and doesn't want it to be removed
   * during CDS events. The deletion of the cluster is controlled by the custom
   * implementation.
   */
