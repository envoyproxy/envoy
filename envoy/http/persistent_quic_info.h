...
// across its HTTP/3 connection pools. This an opaque place holder is needed so that the memory can
// be passed around while the QUICHE members which are behind ENVOY_ENABLE_QUIC preprocessor in the
// actual implementation can be hidden from the Envoy intefaces.
