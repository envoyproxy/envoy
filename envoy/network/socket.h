 ...
 * in certain cases.
 * TODO(soulxu): Since there are more than address infos inside the provider, this will be renamed as
 * ConnectionInfoProvider. Ref https://github.com/envoyproxy/envoy/issues/17168
 */
