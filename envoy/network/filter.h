...
public:
  ...
  /**
   * Overwrite the default use original dst setting for current connection. This allow the listener
   * filter to control whether the connection should be forwarded to other listeners based on the
   * original destination address or not.
