...
/**
 * An interface through which a UDP socket, especially a QUIC socket, can
 * postpone reading during hot restart until the parent instance is drained.
 */
class RegisterParentDrainedCallbackInterface {
public:
  /**
...
protected:
  virtual ~RegisterParentDrainedCallbackInterface() = default;
};
