...
public:
   ...
   * @param socket_index supplies the socket/worker index to fetch. When using reuse port sockets
   ...
   */
  virtual int duplicateParentListenSocket(const std::string& address, uint32_t socket_index) PURE;
