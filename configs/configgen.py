...
generate_config(SCRIPT_DIR,
                'envoy_front_proxy_v3.template.yaml',
                '{}/envoy_front_proxy.v3.yaml'.format(OUT_DIR),
...
generate_config(SCRIPT_DIR,
                'envoy_double_proxy_v3.template.yaml',
                '{}/envoy_double_proxy.v3.yaml'.format(OUT_DIR),
                tracing=tracing_enabled)
...
generate_config(SCRIPT_DIR,
                'envoy_service_to_service_v3.template.yaml',
