...
* If the issue is detected and a fix is available within 5 days of the introduction of the
  vulnerability, the fix will be publicly reviewed and landed on main. A courtesy e-mail will be
...
* If the vulnerability has been in existence for more than 5 days, we will activate the security
  ...
  be merged onto main as soon as a fix is available.

We advise distributors and operators working from the main branch to allow at least 3 days soak
