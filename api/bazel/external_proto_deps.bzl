...
EXTERNAL_PROTO_IMPORT_BAZEL_DEP_MAP = {
    "google/api/expr/v1alpha1/checked.proto": "@googleapis//google/api/expr/v1alpha1:checked_proto",
    "google/api/expr/v1alpha1/syntax.proto": "@googleapis//google/api/expr/v1alpha1:syntax_proto",
...
EXTERNAL_PROTO_GO_BAZEL_DEP_MAP = {
    # Note @googleapis are point to @go_googleapis.
    #
    # It is aligned to xDS dependency to suppress the conflicting package heights error between
    # @xds//xds/type/matcher/v3:pkg_go_proto
    # @envoy_api//envoy/config/rbac/v3:pkg_go_proto
    #
    # TODO(https://github.com/bazelbuild/rules_go/issues/1986): update to
    #    @googleapis when the bug is resolved. Also see the note to
    #    go_googleapis in https://github.com/bazelbuild/rules_go/blob/master/go/dependencies.rst#overriding-dependencies
    "@googleapis//google/api/expr/v1alpha1:checked_proto": "@org_golang_google_genproto_googleapis_api//expr/v1alpha1",
    "@googleapis//google/api/expr/v1alpha1:syntax_proto": "@org_golang_google_genproto_googleapis_api//expr/v1alpha1",
...
EXTERNAL_PROTO_CC_BAZEL_DEP_MAP = {
    "@googleapis//google/api/expr/v1alpha1:checked_proto": "@googleapis//google/api/expr/v1alpha1:checked_cc_proto",
    "@googleapis//google/api/expr/v1alpha1:syntax_proto": "@googleapis//google/api/expr/v1alpha1:syntax_cc_proto",
