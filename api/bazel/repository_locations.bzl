...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    # Minimal stub for external dependencies that still reference PGV during transition
    com_envoyproxy_protoc_gen_validate = dict(
        project_name = "protoc-gen-validate (stub)",
        project_desc = "Minimal stub for PGV during protovalidate transition",
        project_url = "https://github.com/bufbuild/protoc-gen-validate",
        use_category = ["api"],
        # Using version 1.0.4 which should have working Bazel files for external deps
    ...
    rules_buf = dict(
        ...
        version = "0.5.0",
        sha256 = "19ca4b0359f03c41563054d54812602fcf925e86d62832581cba8c524ee419b1",
