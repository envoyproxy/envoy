...
* upstream: added support for :ref:`slow start mode <arch_overview_load_balancing_slow_start>`, which allows to progressively increase traffic for new endpoints.
