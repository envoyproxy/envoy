...
* build: added visibility rules for upstream. If these cause visibility related breakage, see notes in :repo:`BUILD <https://github.com/envoyproxy/envoy/blob/release/v1.16/BUILD>`.
