...
* http: disable the integration between :ref:`ExtensionWithMatcher <v1.18.4:envoy_v3_api_msg_extensions.common.matching.v3.ExtensionWithMatcher>`
...
-------------------------
*Normally occurs at the end of the* :ref:`deprecation period <v1.18.4:deprecated>`
