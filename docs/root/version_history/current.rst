...
* http: added support for :ref:`max_header_list_size <envoy_v3_api_field_config.core.v3.Http2ProtocolOptions.max_header_list_size>` for :ref:`Http2ProtocolOptions <envoy_v3_api_field_config.core.v3.Http2ProtocolOptions>`.
