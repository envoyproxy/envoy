...
* router: added an optional :ref:`alt_header_name <envoy_v3_api_field_config.core.v3.UpstreamHttpProtocolOptions.alt_header_name>` to support setting SNI value from an arbitrary header other than host/authority.
