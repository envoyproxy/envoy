...
* ext_authz filter: added :ref:`match <envoy_v3_api_field_extensions.filters.http.ext_authz.v3.ExtAuthz.match>` field to support enabling the filter based on request header and body matching.
