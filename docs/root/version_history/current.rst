...
* watchdog: watchdog action extension that signals an abort to a particular thread to kill the process. See ref:`Abort Action <envoy_v3_api_file_envoy/extensions/watchdog/abort_action/v3alpha/abort_action.proto>`.
