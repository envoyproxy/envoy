...
* crash support: restore crash context when processing requests or responses due to a filter's callback if the callback doesn't already restore the context.
