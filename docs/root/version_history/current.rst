...
* outlier_detection: max_ejection_time_jitter configuration added to allow adding a random value to the ejection time to prevent 'thundering herd' scenarios. Defaults to 0 so as to not break existing deployments.
