...
* jwt_authn: added support to enable standard padding in the forwarded JWT payload specified by :ref:`async_fetch <envoy_v3_api_field_extensions.filters.http.jwt_authn.v3.JwtProvider.complete_padding_in_forward_payload>`.
