...
* watchdog: support multiple watchdog configurations for different worker threads and for auxiliary threads :ref:`MultiWatchdog<envoy_v3_api_field_config.bootstrap.v3.Bootstrap.multi_watchdog>`.
