...
* tls: added support for allowing that all trust CA doesn't have to have CRL even if any trust CA has CRL with :ref:`only_verify_final_certificate_crl <envoy_v3_api_field_extensions.transport_sockets.tls.v3.CertificateValidationContext.only_verify_final_certificate_crl>`.
