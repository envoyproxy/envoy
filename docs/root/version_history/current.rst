...
* ext_authz_filter: added :ref:`destination_labels <envoy_v3_api_field_extensions.filters.http.ext_authz.v3.ExtAuthz.destination_labels>` option to configure labels of destination service.
