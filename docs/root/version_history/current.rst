...
* jwt_authn: added support to add padding in the forwarded JWT payload specified by :ref:`add_padding_in_forward_payload_header <envoy_v3_api_field_extensions.filters.http.jwt_authn.v3.JwtProvider.add_padding_in_forward_payload_header>`.
