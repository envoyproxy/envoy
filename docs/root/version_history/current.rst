...
* http: added :ref:`cluster_header <envoy_v3_api_field_config.route.v3.RouteAction.WeightedCluster.ClusterWeight.cluster_header>` to allow routing to the weighted cluster specified in the request_header.
