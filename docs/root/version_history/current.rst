...
* listener: reject to listen both on the IPv4-mapped IPv6 address and the corresponding IPv4 address. The runtime flag ``envoy.reloadable_features.reject_duplicated_ipv4_mapped_address_and_ipv4_address`` can be used to revert this behavior.
