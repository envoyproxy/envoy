...
* loadbalancer: added the ability to specify the hash_key for a host when using a consistent hashing loadbalancer (ringhash, maglev) using the :ref:`filter_metadata <envoy_api_msg_core.Metadata>` e.g.: ``"envoy.lb": {"hash_key": "..."}``.
