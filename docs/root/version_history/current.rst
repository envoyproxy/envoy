...
* http: added :ref:`headers_to_add <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.ResponseMapper.headers_to_add>` to http_connection_manager to allow :ref:`local reply mappers <config_http_conn_man_local_reply>` to add/append/override response HTTP headers.
