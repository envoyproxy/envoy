...
* network: added a :ref:`headers field <envoy_v3_api_field_extensions.filters.network.tcp_proxy.v3.TcpProxy.TunnelingConfig.headers>` for setting additional headers to the HTTP requests for TCP proxing.
