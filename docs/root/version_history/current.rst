...
* watchdog: support separate watchdog configuration for worker threads and for the main thread :ref:`MultiWatchdog<envoy_v3_api_field_config.bootstrap.v3.Bootstrap.multi_watchdog>`.
