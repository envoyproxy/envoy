...
* http: changed the http status code to 504 from 408 if :ref:`max_stream_duration <envoy_api_field_core.HttpProtocolOptions.max_stream_duration>` in the cluster config is fired.
