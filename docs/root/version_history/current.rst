...
* mongo_proxy: the list of commands to produce metrics for is now configurable via :ref:`configuration <envoy_v3_api_field_extensions.filters.network.mongo_proxy.v3.MongoProxy.commands>`.
