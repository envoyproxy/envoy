...
* config: add `envoy.features.allow_deprecated_features` runtime flag, which matches the behaviour of compile-time flag `ENVOY_DISABLE_DEPRECATED_FEATURES`, i.e. use of deprecated fields will cause a crash.
