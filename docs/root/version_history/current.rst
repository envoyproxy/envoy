...
* cluster: added :ref:`wait_for_dns_on_init <envoy_v3_api_field_config.cluster.v3.Cluster.wait_for_dns_on_init>`, which allows clusters to not-block server initialization on DNS resolution. It is true by default, which preserves existing behavior.
