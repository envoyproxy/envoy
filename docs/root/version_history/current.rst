...
* thrift_proxy: added per upstream metrics within :ref:`thrift router <envoy_v3_api_field_extensions.filters.network.thrift_proxy.router.v3.Router>` for messagetype in request/response.
