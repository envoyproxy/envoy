...
* udp: added :ref:`max_packet_size <envoy_v3_api_field_config.listener.v3.UdpListenerConfig.max_packet_size>`
  listener configuration to allow configuration of downstream max UDP datagram size. Also added
  :ref:`max_packet_size <envoy_v3_api_field_extensions.filters.udp.udp_proxy.v3.UdpProxyConfig.max_packet_size>`
