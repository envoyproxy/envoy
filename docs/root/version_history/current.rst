...
* build: an :ref:`Ubuntu based debug image <install_binaries>`_ is built and published in DockerHub.
...
* build: Alpine based debug image is deprecated in favor of :ref:`Ubuntu based debug image <install_binaries>`_.
