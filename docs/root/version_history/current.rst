...
* rbac: added :ref:`custom_cel_vocabulary_config<envoy_v3_api_field_config.rbac.v3.RBAC.custom_cel_vocabulary_config>` along with extension category ``extension_category_envoy.expr.custom_cel_vocabulary`` for using a custom CEL vocabulary in RBAC Policy conditions. Added reference implementation for custom_cel_vocabulary_config :ref:`envoy.expr.custom_cel_vocabulary.extended_request <extension_envoy.expr.custom_cel_vocabulary.extended_request>`.
