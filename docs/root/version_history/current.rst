...
* router: added support for percent decoding the request path before matching with regex using the new field :ref:`percent_decode_input <envoy_v3_api_field_type.matcher.v3.RegexMatcher.percent_decode_input>`.
