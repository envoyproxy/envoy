...
* sxg_filter: added filter to transform response to SXG package. This can be enabled by setting up a valid configuration in :ref:`<envoy_v3_api_field_extensions.filters.http.sxg.v3alpha.SXG.>`.
