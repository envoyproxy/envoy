...
* http: added :ref: `referer_sanitization <config_http_conn_man_headers_referer>` in connection manager. Guarded by default enabled ``envoy.reloadable_features.sanitize_http_header_referer`` flag.
