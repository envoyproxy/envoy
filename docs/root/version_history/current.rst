...
* http: added support for :ref:`:ref:`prefetching <envoy_v3_api_msg_config.cluster.v3.Cluster.PrefetchPolicy>`. Prefetching is off by default, but recomended clusters serving latency-sensitive traffic, especially if using HTTP/1.1.
