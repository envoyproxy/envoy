...
* tls: added support for allowing that all trust CA doesn't have to have CRL even if any trust CA has CRL with :ref:`crl_verify_all <envoy_v3_api_field_extensions.transport_sockets.tls.v3.CertificateValidationContext.custom_validator_config>`
