...
* router: added error-specific metrics for internal redirection failures when encountering failure to recreate the stream, mishandling of request bodies, and streaming requests.
