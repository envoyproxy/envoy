...
* http: added support for :ref:`max_requests_connection <envoy_v3_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.max_requests_connection` for downstream connection.
