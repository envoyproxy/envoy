...
* original_dst*: added support for :ref:`Original Destination <config_listener_filters_original_dst_filter>` on Windows. This enables the use of Envoy as a sidecar proxy on Windows.
