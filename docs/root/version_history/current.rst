...
* listener: reject to listen both on the ipv4-mapped ipv6 address and the corresponding ipv4 address. The runtime flag `envoy.reloadable_features.reject_duplicated_ipv4_mapped_address_and_ipv4_address` is added for this.
