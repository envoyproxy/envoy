...
* health_check: added option to use :ref:`no_traffic_healthy_interval <envoy_v3_api_msg_config.core.v3.HealthCheck.no_traffic_healthy_interval>` which allows a different no traffic interval when the host is healthy.
