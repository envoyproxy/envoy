...
* rbac: added :ref:`matcher</envoy_v3_api_field_config.rbac.v3.Permission.matcher>` along with extension category :ref:`<extension_category_envoy.rbac.matchers>` for custom RBAC permission matchers.
