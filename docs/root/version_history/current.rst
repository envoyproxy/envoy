...
* dns_resolver: added :ref:`use_resolvers_as_fallback<envoy_v3_api_msg_extensions.network.dns_resolver.cares.v3.CaresDnsResolverConfig.use_resolvers_as_fallback>` to the c-ares DNS resolver.
