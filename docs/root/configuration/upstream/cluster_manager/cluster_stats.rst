...
.. csv-table::
  ...
  upstream_rq_per_cx_http1, Gauge, Running average of requests handled per HTTP/1.1 upstream connection (multiplied by 100 for precision). Emitted periodically (default: every 10 minutes) to track connection efficiency
