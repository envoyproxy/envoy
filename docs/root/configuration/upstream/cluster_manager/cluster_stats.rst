...
.. csv-table::
  ...
  upstream_rq_drop_overload, Counter, Total requests dropped and resulted in an immediate 503 due to :ref:`drop_overloads<envoy_v3_api_field_config.endpoint.v3.ClusterLoadAssignment.Policy.drop_overloads>`
