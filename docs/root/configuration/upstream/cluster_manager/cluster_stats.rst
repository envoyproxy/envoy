...
.. csv-table::
  ...
  upstream_cx_max_duration_exceeded, Counter, Total times that the connection was drained and closed because it was open for longer than the cluster's max connection duration
