...
%DYNAMIC_METADATA(NAMESPACE:KEY*):Z%
  ...
  UDP
    ...
    * ``bytes_sent``: Total number of downstream bytes sent to the upstream in the session. *Deprecated, use %BYTES_SENT% instead.*
    * ``bytes_received``: Total number of downstream bytes received from the upstream in the session. *Deprecated, use %BYTES_RECEIVED% instead.*
    ...
    * ``bytes_sent``: Total number of downstream bytes sent to the upstream in UDP proxy. *Deprecated, use %BYTES_SENT% instead.*
    * ``bytes_received``: Total number of downstream bytes received from the upstream in UDP proxy. *Deprecated, use %BYTES_RECEIVED% instead.*
