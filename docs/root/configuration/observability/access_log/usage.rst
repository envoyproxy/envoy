...
%UPSTREAM_WIRE_BYTES_SENT%
  ...
  TCP
    Total number of bytes sent to the upstream by the tcp stream.
...
%UPSTREAM_WIRE_BYTES_RECEIVED%
  ...
  TCP
    Total number of bytes received from the upstream by the tcp stream.
...
%DOWNSTREAM_WIRE_BYTES_SENT%
  ...
  TCP
    Total number of bytes sent to the downstream by the tcp stream.
...
%DOWNSTREAM_WIRE_BYTES_RECEIVED%
  ...
  TCP
    Total number of bytes received from the downstream by the tcp stream.
