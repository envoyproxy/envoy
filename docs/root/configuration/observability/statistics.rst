...
.. csv-table::
  ...
  state, Gauge, Current :ref:`State <envoy_api_field_admin.v3.ServerInfo.state>` of the Server.
  ...
  version, Gauge, Integer represented version number based on SCM revision or :ref:`stats_server_version_override <envoy_api_field_config.bootstrap.v3.Bootstrap.stats_server_version_override>` if set.
