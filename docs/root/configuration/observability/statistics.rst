...
.. csv-table::
  ...
  envoy_bug_failures, Counter, Number of envoy bug failures detected in a release build. If this increments, file or report the issue as there may be a serious issue.
