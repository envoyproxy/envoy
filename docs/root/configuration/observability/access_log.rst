...
* :ref:`v3 API reference <envoy_api_msg_config.accesslog.v3.AccessLog>`
...
%RESPONSE_FLAGS%
  ...
  HTTP and TCP
    ...
    * **URX**: The request was rejected because the :ref:`upstream retry limit (HTTP) <envoy_api_field_config.route.v3.RetryPolicy.num_retries>`  or :ref:`maximum connect attempts (TCP) <envoy_api_field_extensions.filters.network.tcp_proxy.v3.TcpProxy.max_connect_attempts>` was reached.
  HTTP only
    ...
    * **IH**: The request was rejected because it set an invalid value for a
      :ref:`strictly-checked header <envoy_api_field_extensions.filters.http.router.v3.Router.strict_check_headers>` in addition to 400 response code.
...
%DOWNSTREAM_REMOTE_ADDRESS%
  ...
  .. note::
    ...
    :ref:`proxy proto <envoy_api_field_config.listener.v3.FilterChain.use_proxy_proto>` or :ref:`x-forwarded-for
...
%DOWNSTREAM_DIRECT_REMOTE_ADDRESS%
  ...
  .. note::
    ...
    been inferred from :ref:`proxy proto <envoy_api_field_config.listener.v3.FilterChain.use_proxy_proto>`
...
%DYNAMIC_METADATA(NAMESPACE:KEY*):Z%
  HTTP
    :ref:`Dynamic Metadata <envoy_api_msg_config.core.v3.Metadata>` info,
