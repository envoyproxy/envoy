...
configured :ref:`route table <envoy_api_msg_config.route.v3.RouteConfiguration>`. In addition to forwarding and
redirection, the filter also handles retry, statistics, etc.

* :ref:`v3 API reference <envoy_api_msg_extensions.filters.http.router.v3.Router>`
...
x-envoy-max-retries
^^^^^^^^^^^^^^^^^^^
If a :ref:`route config retry policy <envoy_api_field_config.route.v3.RouteAction.retry_policy>` or a
:ref:`virtual host retry policy <envoy_api_field_config.route.v3.VirtualHost.retry_policy>` is in place, Envoy will default to retrying
...
* The route timeout (set via :ref:`config_http_filters_router_x-envoy-upstream-rq-timeout-ms` or the
  :ref:`timeout <envoy_api_field_config.route.v3.RouteAction.timeout>` in route configuration or set via
  `grpc-timeout header <https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md>`_  by specifying
  :ref:`max_grpc_timeout <envoy_api_field_config.route.v3.RouteAction.timeout>` in route configuration) **includes** all
...
* Envoy uses a fully jittered exponential back-off algorithm for retries with a default base
  ...
  :ref:`retry back-off <envoy_api_field_config.route.v3.RetryPolicy.retry_back_off>`.
...
<envoy_api_field_config.route.v3.RouteAction.retry_policy>` or the :ref:`virtual host retry policy <envoy_api_field_config.route.v3.VirtualHost.retry_policy>`).
...
connect-failure
  ...
  * **NOTE:** A connection failure/timeout is a the TCP level, not the request level. This does not
    ...
    configuration <envoy_api_field_config.route.v3.RouteAction.retry_policy>` or via
    :ref:`virtual host retry policy <envoy_api_field_config.route.v3.VirtualHost.retry_policy>`.
...
retriable-status-codes
  ...
  in either :ref:`the retry policy <envoy_api_field_config.route.v3.RetryPolicy.retriable_status_codes>`
...
retriable-headers
  ...
  :ref:`the retry policy <envoy_api_field_config.route.v3.RetryPolicy.retriable_headers>` or in the
...
configuration <envoy_api_field_config.route.v3.RouteAction.retry_policy>` or via the
:ref:`virtual host retry policy <envoy_api_field_config.route.v3.VirtualHost.retry_policy>`.

Note that retry policies can also be applied at the :ref:`route level
<envoy_api_field_config.route.v3.RouteAction.retry_policy>` or the
:ref:`virtual host level <envoy_api_field_config.route.v3.VirtualHost.retry_policy>`.
...
header or the :ref:`route config retry policy <envoy_api_field_config.route.v3.RouteAction.retry_policy>`) or the
:ref:`virtual host retry policy <envoy_api_field_config.route.v3.VirtualHost.retry_policy>`.
...
via :ref:`retry policy configuration <envoy_api_field_config.route.v3.RetryPolicy.retriable_headers>`.
...
This should not be confused with :ref:`alt_stat_name <envoy_api_field_config.cluster.v3.Cluster.alt_stat_name>` which
...
<envoy_api_field_config.route.v3.RouteAction.timeout>` or gRPC client timeout set via `grpc-timeout header
<https://github.com/grpc/grpc/blob/master/doc/PROTOCOL-HTTP2.md>`_  by specifying :ref:`max_grpc_timeout
<envoy_api_field_config.route.v3.RouteAction.timeout>`. The timeout must be specified in millisecond
...
<envoy_api_field_config.route.v3.HedgePolicy.hedge_on_per_try_timeout>`. This means that a retry
...
:ref:`include_request_attempt_count <envoy_api_field_config.route.v3.VirtualHost.include_request_attempt_count>`
flag is set to true.
...
:ref:`include_attempt_count_in_response <envoy_api_field_config.route.v3.VirtualHost.include_attempt_count_in_response>`
flag is set to true.
...
<envoy_api_field_config.route.v3.RouteAction.timeout>`, in that order.
...
If the route utilizes :ref:`prefix_rewrite <envoy_api_field_config.route.v3.RouteAction.prefix_rewrite>`
or :ref:`regex_rewrite <envoy_api_field_config.route.v3.RouteAction.regex_rewrite>`,
...
.. csv-table::
  ...
  upstream_rq_retry_overflow, Counter, Total requests not retried due to circuit breaking or exceeding the :ref:`retry budgets <envoy_api_field_config.cluster.v3.CircuitBreakers.Thresholds.retry_budget>`
