...
* :ref:`v3 API reference <envoy_api_msg_extensions.filters.http.csrf.v3.CsrfPolicy>`
...
<envoy_api_field_extensions.filters.http.csrf.v3.CsrfPolicy.filter_enabled>` field.
...
:ref:`shadow_enabled <envoy_api_field_extensions.filters.http.csrf.v3.CsrfPolicy.shadow_enabled>` field.
