...
:ref:`ajax_request_matcher <envoy_v3_api_field_extensions.filters.http.oauth2.v3.OAuth2Config.ajax_request_matcher>` can be used to specify requests for which
