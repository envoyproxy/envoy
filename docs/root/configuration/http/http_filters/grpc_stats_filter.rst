...
* :ref:`v3 API reference <envoy_api_msg_extensions.filters.http.grpc_stats.v3.FilterConfig>`
...
* This filter can be enabled to emit a :ref:`filter state object
  <envoy_api_msg_extensions.filters.http.grpc_stats.v3.FilterObject>`
...
:ref:`individual_method_stats_allowlist <envoy_api_field_extensions.filters.http.grpc_stats.v3.FilterConfig.individual_method_stats_allowlist>`
and :ref:`stats_for_all_methods <envoy_api_field_extensions.filters.http.grpc_stats.v3.FilterConfig.stats_for_all_methods>`.
