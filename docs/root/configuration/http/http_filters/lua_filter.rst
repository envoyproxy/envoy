...
.. note::
  ...
  supports 5.1 with some 5.2 features and additional architectures. Envoy can be built with luajit2
  support by using the following bazel option: ``--//source/extensions/filters/common/lua:luajit2=1``.
