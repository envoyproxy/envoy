...
The audience provider configuration :ref:`v3 API reference <envoy_v3_api_enum_value_config.gcp_authn.v3.GcpAuthnFilterConfig.AudienceProvider>` is used to specify how the audience URL will be provided. The default provider is :ref:`CLUSTER_METADATA<envoy_v3_api_enum_value_config.gcp_authn.v3.GcpAuthnFilterConfig.AudienceProvider.CLUSTER_METADATA>.`, where the audience URL will be provided through cluster's metadata field :ref:`Metadata<envoy_v3_api_msg_config.core.v3.metadata>`.
