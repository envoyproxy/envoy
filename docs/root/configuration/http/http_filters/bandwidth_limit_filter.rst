...
.. csv-table::
  ...
  request_incoming_size, Counter, Size in bytes of incoming request data to bandwidth limiter
  request_allowed_size, Counter, Size in bytes of outgoing request data from bandwidth limiter
