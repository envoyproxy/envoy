...
.. csv-table::
   ...
   dropped_headers_with_underscores, Counter, Total number of dropped headers with names containing underscores. This action is configured by setting the :ref:`headers_with_underscores_action config setting <envoy_api_field_config.core.v3.HttpProtocolOptions.headers_with_underscores_action>`.
