...
.. csv-table::
   ...
   keepalive_timeout, Counter, Total number of connections closed due to :ref:`keepalive timeout <envoy_v3_api_field_config.core.v3.Http2ProtocolOptions.connection_keepalive_timeout>`
