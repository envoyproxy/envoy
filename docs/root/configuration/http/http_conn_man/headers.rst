...
<envoy_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.add_user_agent>` option is
...
<envoy_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.server_name>` option.
...
feature you need to set the :ref:`user_agent <envoy_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.add_user_agent>` option to true.
...
:ref:`use_http_header <envoy_api_field_config.cluster.v3.Cluster.OriginalDstLbConfig.use_http_header>`.
...
:ref:`forward_client_cert_details<envoy_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.forward_client_cert_details>`
and the
:ref:`set_current_client_cert_details<envoy_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.set_current_client_cert_details>`
...
<envoy_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.skip_xff_append>`
...
2. XFF is what Envoy uses to determine whether a request is internal origin or external origin.
   ...
   * **NOTE**: If an internal service proxies an external request to another internal service, and
     ...
     :ref:`use_remote_address <envoy_api_field_extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.use_remote_address>` is set. This will cause
...
* Stable :ref:`access logging <config_access_log>` via the
  :ref:`v3 API runtime filter<envoy_api_field_config.accesslog.v3.AccessLogFilter.runtime_filter>`.
...
:ref:`v3 <envoy_api_msg_config.route.v3.RouteConfiguration>` API documentation.
...
:ref:`prefix_rewrite <envoy_api_field_config.route.v3.RouteAction.prefix_rewrite>`,
:ref:`regex_rewrite <envoy_api_field_config.route.v3.RouteAction.regex_rewrite>`, and
:ref:`host_rewrite <envoy_api_field_config.route.v3.RouteAction.host_rewrite>`.
...
%UPSTREAM_METADATA(["namespace", "key", ...])%
    Populates the header with :ref:`EDS endpoint metadata <envoy_api_field_config.endpoint.v3.LbEndpoint.metadata>` from the
