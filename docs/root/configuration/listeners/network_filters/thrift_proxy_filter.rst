...
* :ref:`v3 API reference <envoy_api_msg_extensions.filters.network.thrift_proxy.v3.ThriftProxy>`
...
Cluster's :ref:`extension_protocol_options<envoy_api_field_config.cluster.v3.Cluster.typed_extension_protocol_option>`
keyed by `envoy.filters.network.thrift_proxy`. The
:ref:`ThriftProtocolOptions<envoy_api_msg_extensions.filters.network.thrift_proxy.v3.ThriftProtocolOptions>`
message describes the available options.

Thrift Request Metadata
-----------------------

The :ref:`HEADER transport<envoy_api_enum_value_extensions.filters.network.thrift_proxy.v3.TransportType.HEADER>`
and :ref:`TWITTER protocol<envoy_api_enum_value_extensions.filters.network.thrift_proxy.v3.ProtocolType.TWITTER>`
...
:ref:`headers <envoy_api_field_extensions.filters.network.thrift_proxy.v3.RouteMatch.headers>`.
