...
* :ref:`v3 API reference <envoy_api_msg_extensions.filters.network.ratelimit.v3.RateLimit>`
...
.. csv-table::
  ...
  of :ref:`failure_mode_deny <envoy_api_field_extensions.filters.network.ratelimit.v3.RateLimit.failure_mode_deny>` set to false."
