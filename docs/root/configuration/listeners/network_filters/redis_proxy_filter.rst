...
* :ref:`v3 API reference <envoy_api_msg_extensions.filters.network.redis_proxy.v3.RedisProxy>`
...
changed to microseconds by setting the configuration parameter :ref:`latency_in_micros <envoy_api_field_extensions.filters.network.redis_proxy.v3.RedisProxy.latency_in_micros>` to true.
