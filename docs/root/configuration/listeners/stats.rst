...
.. csv-table::
   ...
   ssl.connection_error, Counter, "| Total TLS connection errors not including failed
   ...
   ssl.fail_verify_no_cert, Counter, "| Total TLS connections that failed because of missing 
   | client certificate"
   ...
   ssl.fail_verify_cert_hash, Counter, "| Total TLS connections that failed certificate
