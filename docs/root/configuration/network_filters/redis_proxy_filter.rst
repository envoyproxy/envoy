...
changed to microseconds by providing the configuration parameter :ref:`latency_in_micros <envoy_api_msg_config.filter.network.redis_proxy.v2.RedisProxy>` as true.
