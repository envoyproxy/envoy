...
.. http:get:: /stats
  ...
  Works like ``filter`` except that the regex is specified in the
  :ref:`Google RE2 <https://github.com/google/re2>` syntax rather
  than as Ecmascript, and is substantially faster.
