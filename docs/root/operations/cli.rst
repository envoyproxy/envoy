...
.. option:: --mongo-bson-max-depth <integer>

  *(optional)* The maximum depth of BSON documents that the :ref:`Mongo proxy filter <config_network_filters_mongo_proxy>`
  will decode. Defaults to 128.
