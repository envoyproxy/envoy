...
propagating the spans generated by the Skywalking tracer to a Skywalking cluster.
...
The Skywalking collector provides a web UI for viewing the collected traces on port ``9411``.
...
.. code-block:: console
    ...
    skywalking_envoy-front-proxy_1   /docker-entrypoint.sh /usr ... Up             0.0.0.0:10000->10000/tcp
    skywalking_service-1_1           python3 /code/service.py       Up (healthy)
    skywalking_service-2_1           python3 /code/service.py       Up (healthy)
    skywalking_skywalking_1          start-skywalking               Up (healthy)   9410/tcp, 0.0.0.0:9411->9411/tcp
