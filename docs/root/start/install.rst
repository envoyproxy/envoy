...
.. code-block:: console
   ...
   $ apt-get update
   $ apt-get install -y debian-keyring debian-archive-keyring apt-transport-https curl lsb-release
   $ curl -1sLf 'https://deb.dl.getenvoy.io/public/gpg.8115BA8E629CC074.key' | gpg --dearmor -o /usr/share/keyrings/getenvoy-keyring.gpg
