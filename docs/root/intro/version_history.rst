...
* ext_authz: added :ref:`configurable ability <envoy.config.filter.http.ext_authz.v2.ExtAuthz.metadata_context_namespaces` to send dynamic metadata to the `ext_authz` service.
