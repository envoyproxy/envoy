...
* ext_authz: added an configurable option to make the gRPC service cross-compatible with V2Alpha. Note that this feature is already deprecated. It should be used briefly, and only when transitioning from alpha to V2 release version. 
