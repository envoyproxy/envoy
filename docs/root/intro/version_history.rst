...
* http: Added a default 1 hour idle timeout to upstream and downstream connections. HTTP connections with no stream and no activity will be closed after 1 hour unless the default is overridden.
