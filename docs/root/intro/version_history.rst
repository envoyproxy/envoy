...
* performance: stats symbol table implementation (enabled by default; to test it, add "--use-fake-symbol-table 1" to the command-line arguments when starting Envoy).
