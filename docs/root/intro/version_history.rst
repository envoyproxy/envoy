...
* http: added :ref:`max_connection_duration <envoy_api_field_config.filter.network.http_connection_manager.v2.HttpConnectionManager.max_connection_duration>` to configure max connection duration for downstream connections.
