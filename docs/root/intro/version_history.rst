...
* tls: add support for :ref:`generic string matcher <envoy_api_field_cert.v2.CertificateValidationContext.match_subject_alt_name>` for subject alternative names.
