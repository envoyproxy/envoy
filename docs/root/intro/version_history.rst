...
* http: added :ref:`max_connection_duration <max_connection_duration <envoy_api_field_core.HttpProtocolOptions.max_connection_duration>` to configure max connection duration for downstream connections.
