...
* router: added new :ref:`retriable-request-headers <envoy_api_msg_route.RetryPolicy.RetriableRequestHeaders>` to retry policies. Retries can now be configured to only trigger on request header match.
