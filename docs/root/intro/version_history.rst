...
* upstream: added support for host weighting and :ref:`locality weighting <arch_overview_load_balancing_locality_weighted_lb>` in :ref:`ring hash <arch_overview_load_balancing_types_ring_hash>`.
