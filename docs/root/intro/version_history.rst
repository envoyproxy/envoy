...
* router: added :ref:`auto_sni <envoy_api_field_core.UpstreamProtocolOptions.auto_sni>` to support setting SNI to transport socket for new upstream connections based on the downstream HTTP host/authority header.
