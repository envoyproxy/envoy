...
.. csv-table::
   ...
   connection.peer_certificate, string, URL-encoded PEM-encoded peer certificate in the downstream TLS connection if present
...
.. csv-table::
   ...
   upstream.peer_certificate, string, URL-encoded PEM-encoded peer certificate in the upstream TLS connection if present
