...
.. csv-table::
  ...
  inactive,  the resource pressure is low enough that no action needs to be taken
  scaling,   the resource pressure is higher than desireable but below the critical point
