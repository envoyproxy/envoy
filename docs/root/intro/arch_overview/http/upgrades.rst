...
that if doing non-wildcard domain matching for CONNECT requests, the domain to match on may need to
include the port (e.g. "hostname:port") to successfully match.
