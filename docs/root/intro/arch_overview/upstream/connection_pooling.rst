...
both IPv4 and IPv6 addresses. The returned address will be sorted according the the Happy Eyeballs
...
Eventually an attemp will succeed to one of the address in which case that connection will be used, or else
all attempts will have failed in which case a connection error will be reported.
