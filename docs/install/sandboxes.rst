...
<https://github.com/lyft/envoy/blob/master/example/docker-compose.yml>`_). Moreover, notice
...
<https://github.com/lyft/envoy/blob/master/example/front-envoy.json>`_). In turn the service
envoys route the  request to the flask app via the loopback address (routes setup in
`service-envoy.json
<https://github.com/lyft/envoy/blob/master/example/service-envoy.json>`_). This setup
