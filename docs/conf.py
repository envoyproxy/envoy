...
image_tag_name = os.environ['DOCKER_IMAGE_TAG_NAME']
...
# Setup code-block substitutions
substitutions = [("|docker_image_tag_name|", image_tag_name)]
if "pre-release" in release_level:
    substitutions += [("|envoy_docker_image|", "envoy-dev:latest"),
                      ("|envoy_windows_docker_image|", "envoy-windows-dev:latest")]
else:
    substitutions += [(f"|envoy_docker_image|", "envoy:{image_tag_name}"),
                      (f"|envoy_windows_docker_image|", "envoy-windows:{image_tag_name}")]
...
rst_epilog = f"""
.. |DOCKER_IMAGE_TAG_NAME| replace:: {image_tag_name}
"""
