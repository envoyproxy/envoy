...
* The following macros are available:
  ...
  - `ENVOY_NOTIFICATION`: logs and increments a stat. These should be used where it may be useful
    to detect if an efficient condition is met in production, for example before rolling out a
