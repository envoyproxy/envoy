...
* Switch the [VERSION](https://github.com/envoyproxy/data-plane-api/blob/master/VERSION) from a
...
* Create a [tagged release](https://github.com/envoyproxy/envoy/releases). The release should
  ...
  the [VERSION](https://github.com/envoyproxy/data-plane-api/blob/master/VERSION).**
...
* If possible post on Twitter (either have Matt do it or contact caniszczyk@ on Slack and have the
  Envoy account post).
* Do a new PR to update the [VERSION](https://github.com/envoyproxy/data-plane-api/blob/master/VERSION)
