...
BENCHMARK_FILE_PREFIX=benchmark-$BENCHMARK_GIT_SHA
...
CARES_FILE_PREFIX=c-ares-$CARES_VERSION
...
NGHTTP2_FILE_PREFIX=nghttp2-$NGHTTP2_VERSION
...
YAMLCPP_FILE_PREFIX=yaml-cpp-$YAMLCPP_GIT_SHA
