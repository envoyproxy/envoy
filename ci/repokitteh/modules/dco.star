...
Full information can be found in the [contribution guidelines](https://github.com/envoyproxy/envoy/blob/master/CONTRIBUTING.md#dco-sign-your-work)
...
def send_dco_message(sender):
  github.issue_create_comment(DCO_MESSAGE % sender)
