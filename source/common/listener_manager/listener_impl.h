...
public:
  ...
  create(ListenerComponentFactory& factory, Network::Address::InstanceConstSharedPtr address,
         ...
         Network::Socket::OptionsSharedPtr deferred_options = nullptr);
...
private:
  ListenSocketFactoryImpl(ListenerComponentFactory& factory,
                          ...
                          uint32_t num_sockets, Network::Socket::OptionsSharedPtr deferred_options,
  ...
  // Options whose contents may be generated by the listener factory, such as in
  // ActiveQuicListenerFactory::doFinalPreWorkerInit
  const Network::Socket::OptionsSharedPtr deferred_options_;
