...
RUNTIME_GUARD(envoy_reloadable_features_network_rate_limit_dynamic_downstream_ip);
...
constexpr absl::Flag<bool>* runtime_features[] = {
  ...
  &FLAGS_envoy_reloadable_features_network_rate_limit_dynamic_downstream_ip,
