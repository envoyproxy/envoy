...
// TODO(doujiang24) reset this to true when it keep strict backward compatibility.
FALSE_RUNTIME_GUARD(envoy_reloadable_features_enable_strict_dns_sub_cluster_for_dfp_cluster);
