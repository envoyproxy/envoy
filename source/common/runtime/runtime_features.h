...
class FeatureFlag {
public:
  FeatureFlag(const envoy::api::v3alpha::core::RuntimeFeatureFlag& feature_flag_proto,
...
public:
  FractionalPercent(
      const envoy::api::v3alpha::core::RuntimeFractionalPercent& fractional_percent_proto,
      Runtime::Loader& runtime)
