...
ActiveTcpClient::ActiveTcpClient(Envoy::ConnectionPool::ConnPoolImplBase& parent,
  ...
  connection_->setConnectionStats({host->cluster().upstreamStats()->upstream_cx_rx_bytes_total_,
                                   host->cluster().upstreamStats()->upstream_cx_rx_bytes_buffered_,
                                   host->cluster().upstreamStats()->upstream_cx_tx_bytes_total_,
                                   host->cluster().upstreamStats()->upstream_cx_tx_bytes_buffered_,
                                   &host->cluster().upstreamStats()->bind_errors_, nullptr});
