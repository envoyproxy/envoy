...
private:
  ...
  // anything else. Each field of a message, element of a repeated field and entry of a map is
  // redacted as it is walked here, or dropped in emitNextField when redacting it means clearing it.
