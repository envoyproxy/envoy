...
public:
   ...
   */
  virtual absl::StatusOr<bool> verifySignature(absl::string_view hash, PKeyObject& key,
   ...
   */
  virtual absl::StatusOr<std::vector<uint8_t>> sign(absl::string_view hash, PKeyObject& key,
                                                    const std::vector<uint8_t>& text) PURE;
   ...
   * @return pointer to EVP_PKEY public key
   */
  virtual PKeyObjectPtr importPublicKeyDER(const std::vector<uint8_t>& key) PURE;
   ...
   * @return pointer to EVP_PKEY private key
   */
  virtual PKeyObjectPtr importPrivateKeyDER(const std::vector<uint8_t>& key) PURE;
};
