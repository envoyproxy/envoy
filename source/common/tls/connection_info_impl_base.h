...
public:
  ...
  const std::string& sha256PeerCertificateChainDigests() const override;
  const std::string& sha1PeerCertificateDigest() const override;
  const std::string& sha1PeerCertificateChainDigests() const override;
  const std::string& serialNumberPeerCertificate() const override;
  const std::string& serialNumbersPeerCertificates() const override;
...
protected:
  ...
  mutable std::string cached_sha_256_peer_certificate_digests_;
  mutable std::string cached_sha_1_peer_certificate_digest_;
  mutable std::string cached_sha_1_peer_certificate_digests_;
  mutable std::string cached_serial_number_peer_certificate_;
  mutable std::string cached_serial_numbers_peer_certificates_;
