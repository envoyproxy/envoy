...
Utility::protobufAddressToAddress(const envoy::api::v3alpha::core::Address& proto_address) {
  switch (proto_address.address_case()) {
  case envoy::api::v3alpha::core::Address::AddressCase::kSocketAddress:
  ...
  case envoy::api::v3alpha::core::Address::AddressCase::kPipe:
...
void Utility::addressToProtobufAddress(const Address::Instance& address,
                                       envoy::api::v3alpha::core::Address& proto_address) {
...
Address::SocketType
Utility::protobufAddressSocketType(const envoy::api::v3alpha::core::Address& proto_address) {
  switch (proto_address.address_case()) {
  case envoy::api::v3alpha::core::Address::AddressCase::kSocketAddress: {
    const auto protocol = proto_address.socket_address().protocol();
    switch (protocol) {
    case envoy::api::v3alpha::core::SocketAddress::TCP:
      return Address::SocketType::Stream;
    case envoy::api::v3alpha::core::SocketAddress::UDP:
