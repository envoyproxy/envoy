...
Ipv4Instance::Ipv4Instance(const sockaddr_in* address, const std::string& sock_interface)
...
Ipv4Instance::Ipv4Instance(const std::string& address, const std::string& sock_interface)
    : Ipv4Instance(address, 0, sock_interface) {}

Ipv4Instance::Ipv4Instance(const std::string& address, uint32_t port,
                           const std::string& sock_interface)
    : InstanceBase(Type::Ip, sock_interface) {
...
Ipv4Instance::Ipv4Instance(uint32_t port, const std::string& sock_interface)
    : InstanceBase(Type::Ip, sock_interface) {
  memset(&ip_.ipv4_.address_, 0, sizeof(ip_.ipv4_.address_));
  ip_.ipv4_.address_.sin_family = AF_INET;
  ip_.ipv4_.address_.sin_port = htons(port);
...
Ipv6Instance::Ipv6Instance(const std::string& address, const std::string& sock_interface)
...
Ipv6Instance::Ipv6Instance(uint32_t port, const std::string& sock_interface)
