...
public:
  SocketOptionImpl(envoy::config::core::v3alpha::SocketOption::SocketState in_state,
  ...
  bool setOption(Socket& socket,
                 envoy::config::core::v3alpha::SocketOption::SocketState state) const override;
...
private:
  const envoy::config::core::v3alpha::SocketOption::SocketState in_state_;
