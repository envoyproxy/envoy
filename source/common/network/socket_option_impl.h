...
public:
  SocketOptionImpl(envoy::api::v3alpha::core::SocketOption::SocketState in_state,
  ...
  bool setOption(Socket& socket,
                 envoy::api::v3alpha::core::SocketOption::SocketState state) const override;
...
private:
  const envoy::api::v3alpha::core::SocketOption::SocketState in_state_;
