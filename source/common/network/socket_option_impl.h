...
#define ENVOY_SOCKET_SO_ORIGINAL_DST ENVOY_MAKE_SOCKET_OPTION_NAME(IPPROTO_IP, SO_ORIGINAL_DST)
#else
...
#define ENVOY_SOCKET_IP6T_SO_ORIGINAL_DST                                                          \
  ENVOY_MAKE_SOCKET_OPTION_NAME(IPPROTO_IPV6, IP6T_SO_ORIGINAL_DST)
#else
