...
public:
  ...
  /**
   * TODO(jamessynge) Consider making this absl::optional<int> length, or modifying the create() methods
   *                  below to return absl::optional<CidrRange> (the latter is probably better).
