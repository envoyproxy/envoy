...
public:
  ...
  static Address::InstanceConstSharedPtr
  protobufAddressToAddress(const envoy::api::v3alpha::core::Address& proto_address);
  ...
  protobufAddressSocketType(const envoy::api::v3alpha::core::Address& proto_address);
