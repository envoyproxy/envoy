...
InstanceConstSharedPtr resolveProtoAddress(const envoy::api::v3alpha::core::Address& address) {
...
InstanceConstSharedPtr
resolveProtoSocketAddress(const envoy::api::v3alpha::core::SocketAddress& socket_address) {
