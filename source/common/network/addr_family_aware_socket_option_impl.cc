...
bool AddrFamilyAwareSocketOptionImpl::setOption(
    Socket& socket, envoy::api::v3alpha::core::SocketOption::SocketState state) const {
...
absl::optional<Socket::Option::Details> AddrFamilyAwareSocketOptionImpl::getOptionDetails(
    const Socket& socket, envoy::api::v3alpha::core::SocketOption::SocketState state) const {
...
bool AddrFamilyAwareSocketOptionImpl::setIpSocketOption(
    Socket& socket, envoy::api::v3alpha::core::SocketOption::SocketState state,
