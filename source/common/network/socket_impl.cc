...
IoHandlePtr SocketInterface::createSocket(Address::SocketType socket_type, Address::Type addr_type,
...
IoHandlePtr SocketInterface::createSocket(Address::SocketType socket_type,
                                          const Address::InstanceConstSharedPtr addr) {
  Address::IpVersion ip_version = addr->ip() ? addr->ip()->version() : Address::IpVersion::v4;
  IoHandlePtr io_handle = SocketInterface::createSocket(socket_type, addr->type(), ip_version);
...
SocketImpl::SocketImpl(Address::SocketType type, Address::Type addr_type,
                       Address::IpVersion version)
    : io_handle_(SocketInterface::createSocket(type, addr_type, version)) {}

SocketImpl::SocketImpl(Address::SocketType socket_type, const Address::InstanceConstSharedPtr addr)
    : io_handle_(SocketInterface::createSocket(socket_type, addr)) {}
