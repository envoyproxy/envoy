...
Config::RouteImpl::RouteImpl(
    const Config& parent,
    const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy::DeprecatedV1::TCPRoute&
        config)
    : parent_(parent) {
...
Config::WeightedClusterEntry::WeightedClusterEntry(
    const Config& parent, const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy::
...
Config::SharedConfig::SharedConfig(
    const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy& config,
...
Config::Config(const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy& config,
               Server::Configuration::FactoryContext& context)
  ...
  if (config.has_hidden_envoy_deprecated_deprecated_v1()) {
    for (const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy::DeprecatedV1::TCPRoute&
  ...
  if (!config.cluster().empty()) {
    envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy::DeprecatedV1::TCPRoute
        default_route;
  ...
  if (routes_.empty() && config.has_weighted_clusters()) {
    ...
    for (const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy::WeightedCluster::
