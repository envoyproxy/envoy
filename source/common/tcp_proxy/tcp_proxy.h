...
public:
  ...
  class SharedConfig {
  public:
    SharedConfig(const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy& config,
  ...
  Config(const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy& config,
         Server::Configuration::FactoryContext& context);
...
private:
  ...
  public:
    WeightedClusterEntry(const Config& parent,
                         const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy::
