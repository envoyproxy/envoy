...
using CreateMessageDataFunc = std::function<
    std::unique_ptr<google::protobuf::field_extraction::MessageData>()>;
...
absl::StatusOr<MaybeParseGrpcMessageOutput> MaybeParseGrpcMessage(
    CreateMessageDataFunc& factory, Envoy::Buffer::Instance& request_in);
