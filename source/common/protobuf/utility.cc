...
void MessageUtil::recursivePgvCheck(const Protobuf::Message& message, bool recurse_into_any) {
...
public:
  ProtovalidateCheckVisitor()
      : validator_(getProtovalidateValidatorFactory().NewValidator(&arena_)) {}
