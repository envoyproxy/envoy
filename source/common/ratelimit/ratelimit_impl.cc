...
GrpcFactoryImpl::GrpcFactoryImpl(const envoy::service::ratelimit::v2::RateLimitServiceConfig& config,
  ...
  if (config.service_specifier_case() == envoy::service::ratelimit::v2::RateLimitServiceConfig::kClusterName) {
