...
DetectorSharedPtr DetectorImplFactory::createForCluster(
    Cluster& cluster, const envoy::api::v3alpha::Cluster& cluster_config,
...
DetectorConfig::DetectorConfig(const envoy::api::v3alpha::cluster::OutlierDetection& config)
    : interval_ms_(
...
DetectorImpl::DetectorImpl(const Cluster& cluster,
                           const envoy::api::v3alpha::cluster::OutlierDetection& config,
