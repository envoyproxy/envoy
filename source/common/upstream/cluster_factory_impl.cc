...
Stats::ScopePtr generateStatsScope(const envoy::api::v3alpha::Cluster& config,
                                   Stats::Store& stats) {
...
std::pair<ClusterSharedPtr, ThreadAwareLoadBalancerPtr> ClusterFactoryImplBase::create(
    const envoy::api::v3alpha::Cluster& cluster, ClusterManager& cluster_manager,
...
ClusterFactoryImplBase::selectDnsResolver(const envoy::api::v3alpha::Cluster& cluster,
...
ClusterFactoryImplBase::create(const envoy::api::v3alpha::Cluster& cluster,
                               ClusterFactoryContext& context) {
