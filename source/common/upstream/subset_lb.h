...
public:
  SubsetLoadBalancer(
      ...
      const absl::optional<envoy::api::v3alpha::Cluster::RingHashLbConfig>& lb_ring_hash_config,
...
private:
  ...
  void initSelectorFallbackSubset(const envoy::api::v3alpha::Cluster::LbSubsetConfig::
  ...
  const absl::optional<envoy::api::v3alpha::Cluster::RingHashLbConfig> lb_ring_hash_config_;
  const absl::optional<envoy::api::v3alpha::Cluster::LeastRequestLbConfig> least_request_config_;
  ...
  const envoy::api::v3alpha::Cluster::LbSubsetConfig::LbSubsetFallbackPolicy fallback_policy_;
