...
public:
  ...
  createForCluster(Cluster& cluster, const envoy::config::cluster::v3alpha::Cluster& cluster_config,
...
public:
  DetectorConfig(const envoy::config::cluster::v3alpha::OutlierDetection& config);
...
public:
  ...
  create(const Cluster& cluster, const envoy::config::cluster::v3alpha::OutlierDetection& config,
...
private:
  DetectorImpl(const Cluster& cluster,
