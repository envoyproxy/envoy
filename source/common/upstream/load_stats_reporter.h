...
class LoadStatsReporter : Grpc::TypedAsyncStreamCallbacks<envoy::service::load_stats::v2::LoadStatsResponse>,
...
public:
  ...
  void onReceiveMessage(std::unique_ptr<envoy::service::load_stats::v2::LoadStatsResponse>&& message) override;
