...
public:
  ...
  create(const envoy::api::v3alpha::core::HealthCheck& health_check_config,
...
public:
  ...
  loadProtoBytes(const Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HealthCheck::Payload>&
                     byte_array);
...
public:
  TcpHealthCheckerImpl(const Cluster& cluster, const envoy::api::v3alpha::core::HealthCheck& config,
                       Event::Dispatcher& dispatcher, Runtime::Loader& runtime,
                       Runtime::RandomGenerator& random, HealthCheckEventLoggerPtr&& event_logger);
