...
public:
  ...
  const envoy::api::v2::Cluster::CustomClusterType& clusterType() const override {
...
public:
  ...
  virtual LoadBalancerFactorySharedPtr loadBalancerFactory() override { return nullptr; }
