...
public:
  ...
  static std::unique_ptr<ClusterTrafficStats>
  ...
  std::unique_ptr<ClusterTrafficStats>& trafficStats() const override { return traffic_stats_; }
...
private:
  ...
  mutable std::unique_ptr<ClusterTrafficStats> traffic_stats_;
