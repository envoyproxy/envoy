...
#include "envoy/api/v3alpha/cluster/circuit_breaker.pb.h"
...
getSourceAddress(const envoy::api::v3alpha::Cluster& cluster,
...
uint64_t parseFeatures(const envoy::api::v3alpha::Cluster& config) {
  uint64_t features = 0;
  if (config.has_http2_protocol_options()) {
    features |= ClusterInfoImpl::Features::HTTP2;
  }
  if (config.protocol_selection() == envoy::api::v3alpha::Cluster::USE_DOWNSTREAM_PROTOCOL) {
...
Network::TcpKeepaliveConfig parseTcpKeepaliveConfig(const envoy::api::v3alpha::Cluster& config) {
  const envoy::api::v3alpha::core::TcpKeepalive& options =
...
parseClusterSocketOptions(const envoy::api::v3alpha::Cluster& config,
                          const envoy::api::v3alpha::core::BindConfig bind_config) {
...
parseExtensionProtocolOptions(const envoy::api::v3alpha::Cluster& config,
                              ProtobufMessage::ValidationVisitor& validation_visitor) {
...
HostDescriptionImpl::HostDescriptionImpl(
    ...
    : cluster_(cluster), hostname_(hostname), address_(dest_address),
      canary_(Config::Metadata::metadataValue(metadata, Config::MetadataFilters::get().ENVOY_LB,
                  ...
                  .bool_value()),
      metadata_(std::make_shared<envoy::api::v3alpha::core::Metadata>(metadata)),
      locality_(locality),
...
void HostImpl::setEdsHealthFlag(envoy::api::v3alpha::core::HealthStatus health_status) {
  switch (health_status) {
  case envoy::api::v3alpha::core::UNHEALTHY:
    FALLTHRU;
  case envoy::api::v3alpha::core::DRAINING:
    FALLTHRU;
  case envoy::api::v3alpha::core::TIMEOUT:
    healthFlagSet(Host::HealthFlag::FAILED_EDS_HEALTH);
    break;
  case envoy::api::v3alpha::core::DEGRADED:
...
ClusterInfoImpl::ClusterInfoImpl(
    const envoy::api::v3alpha::Cluster& config,
    const envoy::api::v3alpha::core::BindConfig& bind_config, Runtime::Loader& runtime,
    ...
    : runtime_(runtime), name_(config.name()), type_(config.type()),
      ...
      cluster_type_(config.has_cluster_type()
                        ? absl::make_optional<envoy::api::v3alpha::Cluster::CustomClusterType>(
                              config.cluster_type())
                        : absl::nullopt),
      factory_context_(
          std::make_unique<FactoryContextImpl>(*stats_scope_, runtime, factory_context)) {
  switch (config.lb_policy()) {
  case envoy::api::v3alpha::Cluster::ROUND_ROBIN:
    lb_type_ = LoadBalancerType::RoundRobin;
    break;
  case envoy::api::v3alpha::Cluster::LEAST_REQUEST:
    lb_type_ = LoadBalancerType::LeastRequest;
    break;
  case envoy::api::v3alpha::Cluster::RANDOM:
    lb_type_ = LoadBalancerType::Random;
    break;
  case envoy::api::v3alpha::Cluster::RING_HASH:
    lb_type_ = LoadBalancerType::RingHash;
    break;
  case envoy::api::v3alpha::Cluster::hidden_envoy_deprecated_ORIGINAL_DST_LB:
    if (config.type() != envoy::api::v3alpha::Cluster::ORIGINAL_DST) {
      throw EnvoyException(
          fmt::format("cluster: LB policy {} is not valid for Cluster type {}. 'ORIGINAL_DST_LB' "
                      "is allowed only with cluster type 'ORIGINAL_DST'",
                      envoy::api::v3alpha::Cluster::LbPolicy_Name(config.lb_policy()),
                      envoy::api::v3alpha::Cluster::DiscoveryType_Name(config.type())));
    }
    ...
    break;
  case envoy::api::v3alpha::Cluster::MAGLEV:
    lb_type_ = LoadBalancerType::Maglev;
    break;
  case envoy::api::v3alpha::Cluster::CLUSTER_PROVIDED:
    if (config.has_lb_subset_config()) {
      throw EnvoyException(
          fmt::format("cluster: LB policy {} cannot be combined with lb_subset_config",
                      envoy::api::v3alpha::Cluster::LbPolicy_Name(config.lb_policy())));
  ...
  if (config.protocol_selection() == envoy::api::v3alpha::Cluster::USE_CONFIGURED_PROTOCOL) {
  ...
  if (config.has_eds_cluster_config()) {
    if (config.type() != envoy::api::v3alpha::Cluster::EDS) {
...
const Network::Address::InstanceConstSharedPtr
ClusterImplBase::resolveProtoAddress(const envoy::api::v3alpha::core::Address& address) {
  try {
    return Network::Address::resolveProtoAddress(address);
  } catch (EnvoyException& e) {
    if (info_->type() == envoy::api::v3alpha::Cluster::STATIC ||
        info_->type() == envoy::api::v3alpha::Cluster::EDS) {
...
ClusterInfoImpl::ResourceManagers::ResourceManagers(const envoy::api::v3alpha::Cluster& config,
                                                    Runtime::Loader& runtime,
                                                    const std::string& cluster_name,
                                                    Stats::Scope& stats_scope) {
  managers_[enumToInt(ResourcePriority::Default)] =
      load(config, runtime, cluster_name, stats_scope, envoy::api::v3alpha::core::DEFAULT);
  managers_[enumToInt(ResourcePriority::High)] =
      load(config, runtime, cluster_name, stats_scope, envoy::api::v3alpha::core::HIGH);
}
...
ResourceManagerImplPtr ClusterInfoImpl::ResourceManagers::load(
  ...
  const auto it = std::find_if(
      ...
      [priority](const envoy::api::v3alpha::cluster::CircuitBreakers::Thresholds& threshold) {
...
void PriorityStateManager::updateClusterPrioritySet(
  ...
  std::map<envoy::api::v3alpha::core::Locality, HostVector, LocalityLess> hosts_per_locality;
...
getDnsLookupFamilyFromCluster(const envoy::api::v3alpha::Cluster& cluster) {
...
getDnsLookupFamilyFromEnum(envoy::api::v3alpha::Cluster::DnsLookupFamily family) {
  switch (family) {
  case envoy::api::v3alpha::Cluster::V6_ONLY:
    return Network::DnsLookupFamily::V6Only;
  case envoy::api::v3alpha::Cluster::V4_ONLY:
    return Network::DnsLookupFamily::V4Only;
  case envoy::api::v3alpha::Cluster::AUTO:
