...
createUpstreamLocalAddressSelector(
  ...
  if (local_address_selector_config) {
    ...
    static_cast<void>(typed_extension.mutable_typed_config()->PackFrom(default_config));
    local_address_selector_factory =
...
absl::StatusOr<Network::UpstreamTransportSocketFactoryPtr> createTransportSocketFactory(
  ...
  if (!config.has_transport_socket()) {
    ...
    static_cast<void>(transport_socket.mutable_typed_config()->PackFrom(raw_buffer));
