...
public:
  ...
  create(const envoy::api::v3alpha::Cluster& cluster, ClusterManager& cluster_manager,
   ...
   */
  Network::DnsResolverSharedPtr selectDnsResolver(const envoy::api::v3alpha::Cluster& cluster,
                                                  ClusterFactoryContext& context);

  // Upstream::ClusterFactory
  std::pair<ClusterSharedPtr, ThreadAwareLoadBalancerPtr>
  create(const envoy::api::v3alpha::Cluster& cluster, ClusterFactoryContext& context) override;
...
private:
  ...
  virtual std::pair<ClusterImplBaseSharedPtr, ThreadAwareLoadBalancerPtr> createClusterWithConfig(
      const envoy::api::v3alpha::Cluster& cluster, const ConfigProto& proto_config,
      ClusterFactoryContext& context,
      Server::Configuration::TransportSocketFactoryContext& socket_factory_context,
      Stats::ScopePtr&& stats_scope) PURE;
};
