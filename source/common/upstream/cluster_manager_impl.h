...
public:
  ...
  bool addOrUpdateCluster(const envoy::api::v3alpha::Cluster& cluster,
  ...
  const envoy::api::v3alpha::core::BindConfig& bindConfig() const override { return bind_config_; }
...
private:
  ...
  struct ClusterData {
    ClusterData(const envoy::api::v3alpha::Cluster& cluster_config, const std::string& version_info,
    ...
    const envoy::api::v3alpha::Cluster cluster_config_;
  ...
  void loadCluster(const envoy::api::v3alpha::Cluster& cluster, const std::string& version_info,
