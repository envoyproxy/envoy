...
public:
  static CdsApiPtr create(const envoy::api::v3alpha::core::ConfigSource& cds_config,
...
private:
  ...
  std::string resourceName(const ProtobufWkt::Any& resource) override {
    return MessageUtil::anyConvert<envoy::api::v3alpha::Cluster>(resource).name();
  }

  CdsApiImpl(const envoy::api::v3alpha::core::ConfigSource& cds_config, ClusterManager& cm,
