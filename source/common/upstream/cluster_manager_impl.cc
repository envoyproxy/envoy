...
ClusterManagerImpl::ClusterManagerImpl(
  ...
  for (const auto& cluster : bootstrap.static_resources().clusters()) {
    ...
    if (cluster.type() != envoy::api::v3alpha::Cluster::EDS ||
        (cluster.type() == envoy::api::v3alpha::Cluster::EDS &&
...
bool ClusterManagerImpl::addOrUpdateCluster(const envoy::api::v3alpha::Cluster& cluster,
...
void ClusterManagerImpl::loadCluster(const envoy::api::v3alpha::Cluster& cluster,
...
CdsApiPtr
ProdClusterManagerFactory::createCds(const envoy::api::v3alpha::core::ConfigSource& cds_config,
                                     ClusterManager& cm) {
