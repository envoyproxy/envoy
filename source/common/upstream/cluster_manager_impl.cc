...
ClusterManagerImpl::ClusterManagerImpl(
    ...
    : factory_(factory), runtime_(runtime), stats_(stats), tls_(tls),
      ...
      common_lb_config_pool_(std::make_shared<SharedPool::ObjectSharedPool<const envoy::config::cluster::v3::Cluster::CommonLbConfig, MessageUtil, MessageUtil>>(main_thread_dispatcher)) {
  if (admin.has_value()) {
