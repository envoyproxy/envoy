...
void ConnectionManagerImpl::ActiveStream::decodeHeaders(HeaderMapPtr&& headers, bool end_stream) {
  ...
  // broken the path into pieces if applicable. NOTE: Currently the HTTP/1.1 codec only does this when
  // the allow_absolute_url flag is enabled on the HCM. https://tools.ietf.org/html/rfc7230#section-5.3
