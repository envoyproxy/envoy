...
HashPolicyImpl::HashPolicyImpl(
    absl::Span<const envoy::api::v3alpha::route::RouteAction::HashPolicy* const> hash_policies) {
  ...
  for (auto* hash_policy : hash_policies) {
    ...
    case envoy::api::v3alpha::route::RouteAction::HashPolicy::PolicySpecifierCase::kHeader:
      hash_impls_.emplace_back(
          new HeaderHashMethod(hash_policy->header().header_name(), hash_policy->terminal()));
      break;
    case envoy::api::v3alpha::route::RouteAction::HashPolicy::PolicySpecifierCase::kCookie: {
    ...
    case envoy::api::v3alpha::route::RouteAction::HashPolicy::PolicySpecifierCase::
      ...
      break;
    case envoy::api::v3alpha::route::RouteAction::HashPolicy::PolicySpecifierCase::kQueryParameter:
