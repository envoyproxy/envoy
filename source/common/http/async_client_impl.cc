...
const std::list<Router::HeaderAddition> AsyncStreamImpl::NullVirtualHost::response_headers_to_add_;
const std::list<Http::LowerCaseString>
    AsyncStreamImpl::NullVirtualHost::response_headers_to_remove_;
