...
const Router::PathMatcherSharedPtr AsyncStreamImpl::RouteEntryImpl::extension_path_matcher_;
const Router::PathRewriterSharedPtr AsyncStreamImpl::RouteEntryImpl::extension_path_rewriter_;
