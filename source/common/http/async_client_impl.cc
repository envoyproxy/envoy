...
const AsyncStreamImpl::NullSharedConfig AsyncStreamImpl::NullVirtualHost::route_configuration_;
...
const std::list<LowerCaseString> AsyncStreamImpl::NullSharedConfig::internal_only_headers_;
