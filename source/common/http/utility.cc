...
Http2Settings
Utility::parseHttp2Settings(const envoy::api::v3alpha::core::Http2ProtocolOptions& config) {
  Http2Settings ret;
...
Http1Settings
Utility::parseHttp1Settings(const envoy::api::v3alpha::core::Http1ProtocolOptions& config) {
  Http1Settings ret;
...
MessagePtr Utility::prepareHeaders(const envoy::api::v3alpha::core::HttpUri& http_uri) {
