...
class LegacyPermissiveHttpParserImpl : public Parser {
public:
  LegacyPermissiveHttpParserImpl(MessageType type, ParserCallbacks* data);
  ~LegacyPermissiveHttpParserImpl() override;
