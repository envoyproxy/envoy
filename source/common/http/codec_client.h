...
public:
   ...
   */
  RequestStreamEncoder& newStream(ResponseStreamDecoder& response_decoder);
...
private:
  ...
  struct ActiveRequest : LinkedObject<ActiveRequest>,
    ...
    ActiveRequest(CodecClient& parent, ResponseStreamDecoder& inner)
        : ResponseStreamDecoderWrapper(inner), parent_(parent) {}
