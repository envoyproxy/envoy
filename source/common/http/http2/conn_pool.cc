...
ConnPoolImpl::ActiveClient::ActiveClient(ConnPoolImpl& parent)
  ...
  parent_.conn_connect_ms_ = std::make_unique<Stats::Timespan>(
      parent_.host_->cluster().stats().upstream_cx_connect_, parent_.dispatcher_.timeSource());
  ...
  conn_length_ = std::make_unique<Stats::Timespan>(
      parent_.host_->cluster().stats().upstream_cx_length_, parent_.dispatcher_.timeSource());
