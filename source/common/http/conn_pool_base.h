...
public:
  ...
  void initialize(Upstream::Host::CreateConnectionData& data, HttpConnPoolImplBase& parent) {
    ...
    InstantiatedClusterStats& stats = *parent_.host()->cluster().stats();
    codec_client_->setConnectionStats(
        {stats.upstream_cx_rx_bytes_total_,
         stats.upstream_cx_rx_bytes_buffered_,
         stats.upstream_cx_tx_bytes_total_,
         stats.upstream_cx_tx_bytes_buffered_,
         &stats.bind_errors_, nullptr});
  }
