...
public:
  ...
  void onEvent(Network::ConnectionEvent event) override {
    parent_.onConnectionEvent(
        *this, codec_client_->connectionFailureReason(), event, /*purge_pending_streams*/
        !(event == Network::ConnectionEvent::LocalClose && close_after_goaway_));
  }
  ...
  bool close_after_goaway_{false};
};
