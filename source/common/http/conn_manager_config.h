...
public:
   ...
   * @param validate_header_values indicates whether or not the codec should validate the values of
   * each HTTP header (NOTE: this argument only affects the H/1.1 codec; the H/2 codec always does
   * this)
  ...
  virtual ServerConnectionPtr createCodec(Network::Connection& connection,
                                          ...
                                          const bool validate_header_values) PURE;
