...
public:
  ...
  void set_min_time_before_purge_allowed(absl::Duration min_time_before_purge_allowed) {
  ...
  absl::Duration MinTimeBeforePurgeAllowed() const { return min_time_before_purge_allowed_; };
