...
void ActiveStreamDecoderFilter::injectDecodedDataToFilterChain(Buffer::Instance& data,
  ...
  if (Runtime::runtimeFeatureEnabled(
    ...
    ENVOY_STREAM_LOG(trace, "injectDecodedDataToFilterChain with end_stream updated: {}",
                     parent_, end_stream);
  }
...
void ActiveStreamEncoderFilter::injectEncodedDataToFilterChain(Buffer::Instance& data,
  ...
  if (Runtime::runtimeFeatureEnabled(
    ...
    ENVOY_STREAM_LOG(trace, "injectEncodedDataToFilterChain with end_stream updated: {}",
                     parent_, end_stream);
  }
