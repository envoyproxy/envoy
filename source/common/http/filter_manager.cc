...
void ActiveStreamDecoderFilter::setUpstreamOverrideHost(absl::string_view host, bool strict) {
  parent_.upstream_override_host_ = std::make_pair(std::move(host), strict);
}
