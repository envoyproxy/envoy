...
public:
  ...
  struct HeaderData : public HeaderMatcher {
    HeaderData(const envoy::api::v3alpha::route::HeaderMatcher& config);
   ...
   */
  static std::vector<HeaderUtility::HeaderDataPtr>
  buildHeaderDataVector(const Protobuf::RepeatedPtrField<envoy::api::v3alpha::route::HeaderMatcher>&
                            header_matchers) {
  ...
  static std::vector<Http::HeaderMatcherSharedPtr> buildHeaderMatcherVector(
      const Protobuf::RepeatedPtrField<envoy::api::v3alpha::route::HeaderMatcher>&
          header_matchers) {
