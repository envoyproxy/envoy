 ...
 */
Http2Settings parseHttp2Settings(const envoy::api::v3alpha::core::Http2ProtocolOptions& config);

/**
 * @return Http1Settings An Http1Settings populated from the
 * envoy::api::v2::core::Http1ProtocolOptions config.
 */
Http1Settings parseHttp1Settings(const envoy::api::v3alpha::core::Http1ProtocolOptions& config);
 ...
 */
MessagePtr prepareHeaders(const envoy::api::v3alpha::core::HttpUri& http_uri);
