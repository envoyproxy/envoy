...
struct ActiveStreamDecoderFilter : public ActiveStreamFilterBase,
  ...
  void injectDecodedDataToFilterChain(Buffer::Instance& data, bool end_stream, bool update_state_end_stream = false) override;
...
struct ActiveStreamEncoderFilter : public ActiveStreamFilterBase,
  ...
  void injectEncodedDataToFilterChain(Buffer::Instance& data, bool end_stream, bool update_state_end_stream = false) override;
