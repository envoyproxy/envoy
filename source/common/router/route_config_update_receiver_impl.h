...
public:
  ...
  void initializeVhosts(const envoy::api::v3alpha::RouteConfiguration& route_configuration);
  void
  removeVhosts(std::unordered_map<std::string, envoy::api::v3alpha::route::VirtualHost>& vhosts,
               const Protobuf::RepeatedPtrField<std::string>& removed_vhost_names);
  void
  updateVhosts(std::unordered_map<std::string, envoy::api::v3alpha::route::VirtualHost>& vhosts,
  ...
  bool onRdsUpdate(const envoy::api::v3alpha::RouteConfiguration& rc,
                   const std::string& version_info) override;
  bool
  onVhdsUpdate(const Protobuf::RepeatedPtrField<envoy::api::v3alpha::Resource>& added_resources,
  ...
  const envoy::api::v3alpha::RouteConfiguration& routeConfiguration() override {
...
private:
  ...
  std::unordered_map<std::string, envoy::api::v3alpha::route::VirtualHost> virtual_hosts_;
