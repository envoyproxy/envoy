...
RdsRouteConfigProviderImpl::RdsRouteConfigProviderImpl(
    const Json::Object& config, const std::string& manager_identifier, Runtime::Loader& runtime, Upstream::ClusterManager& cm,
    ...
    : RestApiFetcher(cm, config.getString("cluster"), dispatcher, random,
      ...
      route_config_provider_manager_(route_config_provider_manager), manager_identifier_(manager_identifier) {
...
Router::RouteConfigProviderSharedPtr RouteConfigProviderManagerImpl::getRouteConfigProvider(
  ...
  const std::string manager_identifier = config.getString("route_config_name") + ":" + config.getString("cluster");
  ...
  if (it == route_config_providers_.end()) {
    std::shared_ptr<RdsRouteConfigProviderImpl> new_provider{new RdsRouteConfigProviderImpl(
        config, manager_identifier, runtime_, cm, dispatcher_, random_, local_info_, scope, stat_prefix, tls_, *this)};
