...
StaticRouteConfigProviderImpl::StaticRouteConfigProviderImpl(
    const envoy::api::v3alpha::RouteConfiguration& config,
...
RdsRouteConfigSubscription::RdsRouteConfigSubscription(
    const envoy::config::filter::network::http_connection_manager::v3alpha::Rds& rds,
...
void RdsRouteConfigSubscription::onConfigUpdate(
  ...
  auto route_config =
      MessageUtil::anyConvert<envoy::api::v3alpha::RouteConfiguration>(resources[0]);
...
void RdsRouteConfigProviderImpl::validateConfig(
    const envoy::api::v3alpha::RouteConfiguration& config) const {
...
RouteConfigProviderPtr RouteConfigProviderManagerImpl::createStaticRouteConfigProvider(
    const envoy::api::v3alpha::RouteConfiguration& route_config,
    Server::Configuration::FactoryContext& factory_context) {
  auto provider =
