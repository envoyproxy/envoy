...
public:
  ...
  public:
    QueryParameterMatcher(const envoy::api::v3alpha::route::QueryParameterMatcher& config);
  ...
  parsePriority(const envoy::api::v3alpha::core::RoutingPriority& priority);
  ...
  parseDirectResponseCode(const envoy::api::v3alpha::route::Route& route);
   ...
   */
  static std::string parseDirectResponseBody(const envoy::api::v3alpha::route::Route& route,
                                             Api::Api& api);
