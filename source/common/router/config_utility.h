...
public:
  ...
  /**
   * Returns ResponseFlag enum parsed from the route's direct_response.
   * @param route supplies the Route configuration.
   * @return absl::optional<StreamInfo::ResponseFlag> ResponseFlag from the route's
   * direct_response if specified, or an empty absl::optional otherwise.
   */
  static absl::optional<StreamInfo::ResponseFlag>
