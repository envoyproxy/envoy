...
public:
  ExpressionAction(const envoy::config::route::v3::RateLimit::Action::Expression& action,
...
public:
  RateLimitPolicyEntryImpl(RateLimitPolicyImpl& policy,
...
private:
  ...
  std::unique_ptr<ProtobufWkt::Arena> builder_arena_;
