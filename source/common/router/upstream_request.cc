...
void UpstreamRequest::cleanUp() {
  ...
  while (downstream_data_disabled_ != 0) {
    ...
    parent_.cluster()->upstreamStats()->upstream_flow_control_drained_total_.inc();
...
void UpstreamRequest::onStreamMaxDurationReached() {
  upstream_host_->cluster().upstreamStats()->upstream_rq_max_duration_reached_.inc();
...
void UpstreamRequest::DownstreamWatermarkManager::onAboveWriteBufferHighWatermark() {
  ...
  parent_.parent_.cluster()->upstreamStats()->upstream_flow_control_paused_reading_total_.inc();
...
void UpstreamRequest::DownstreamWatermarkManager::onBelowWriteBufferLowWatermark() {
  ...
  parent_.parent_.cluster()->upstreamStats()->upstream_flow_control_resumed_reading_total_.inc();
...
void UpstreamRequest::disableDataFromDownstreamForFlowControl() {
  ...
  parent_.cluster()->upstreamStats()->upstream_flow_control_backed_up_total_.inc();
