...
public:
  ...
  const envoy::api::v2::route::VirtualHost& config() const { return config_; }
...
private:
  ...
  const envoy::api::v2::route::VirtualHost config_;
};
...
public:
  ...
  RetryPolicyImpl(const envoy::api::v2::route::VirtualHost& config);
