...
// Sentinel value to represent an unset std::duration, in lieu of using absl::optional.
...
private:
  ...
  // value that was not provided. This takes less memory than using absl::optional.
