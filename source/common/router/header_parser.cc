...
HeaderFormatterPtr
parseInternal(const envoy::api::v3alpha::core::HeaderValueOption& header_value_option) {
...
HeaderParserPtr HeaderParser::configure(
    const Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HeaderValueOption>&
        headers_to_add) {
...
HeaderParserPtr HeaderParser::configure(
    const Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HeaderValueOption>& headers_to_add,
