...
bool RouteConfigUpdateReceiverImpl::onRdsUpdate(const envoy::api::v3alpha::RouteConfiguration& rc,
...
void RouteConfigUpdateReceiverImpl::initializeVhosts(
    const envoy::api::v3alpha::RouteConfiguration& route_configuration) {
...
void RouteConfigUpdateReceiverImpl::removeVhosts(
    std::unordered_map<std::string, envoy::api::v3alpha::route::VirtualHost>& vhosts,
...
void RouteConfigUpdateReceiverImpl::updateVhosts(
  ...
  for (const auto& resource : added_resources) {
    envoy::api::v3alpha::route::VirtualHost vhost =
        MessageUtil::anyConvert<envoy::api::v3alpha::route::VirtualHost>(resource.resource());
...
void RouteConfigUpdateReceiverImpl::rebuildRouteConfig(
    const std::unordered_map<std::string, envoy::api::v3alpha::route::VirtualHost>& vhosts,
