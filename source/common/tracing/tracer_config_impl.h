...
public:
  ...
  ConnectionManagerTracingConfig(Tracing::OperationName operation_name,
                                 ...
                                 bool disable_trace_context_propagation = false)
      : operation_name_(operation_name), custom_tags_(std::move(custom_tags)),
        ...
        disable_trace_context_propagation_(disable_trace_context_propagation) {}
  ...
  bool disableTraceContextPropagation() const { return disable_trace_context_propagation_; }
  ...
  bool disable_trace_context_propagation_{};
};
