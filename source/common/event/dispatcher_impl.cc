...
DispatcherImpl::DispatcherImpl()
    : DispatcherImpl(Buffer::WatermarkInstanceFactoryPtr{new Buffer::WatermarkBufferFactory}) {}

DispatcherImpl::DispatcherImpl(Buffer::WatermarkInstanceFactoryPtr&& factory)
