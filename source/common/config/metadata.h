...
public:
   ...
   */
  static const ProtobufWkt::Value&
  metadataValue(const envoy::api::v3alpha::core::Metadata& metadata, const std::string& filter,
   ...
   */
  static const ProtobufWkt::Value&
  metadataValue(const envoy::api::v3alpha::core::Metadata& metadata,
   ...
   */
  static ProtobufWkt::Value& mutableMetadataValue(envoy::api::v3alpha::core::Metadata& metadata,
  ...
  static bool metadataLabelMatch(const LabelSet& label_set,
                                 const envoy::api::v3alpha::core::Metadata& host_metadata,
...
public:
  ...
  TypedMetadataImpl(const envoy::api::v3alpha::core::Metadata& metadata) { populateFrom(metadata); }
...
protected:
   ...
   */
  void populateFrom(const envoy::api::v3alpha::core::Metadata& metadata) {
