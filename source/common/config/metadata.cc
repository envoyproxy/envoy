...
Metadata::metadataValue(const envoy::api::v3alpha::core::Metadata& metadata,
...
ProtobufWkt::Value& Metadata::mutableMetadataValue(envoy::api::v3alpha::core::Metadata& metadata,
