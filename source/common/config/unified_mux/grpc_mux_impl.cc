...
void GrpcMuxDelta::sendGrpcMessage(void* msg_proto_ptr, SubscriptionState& sub_state) {
  ...
  if (sub_state.dynamicContextChanged() || !any_request_sent_yet_in_current_stream() ||
