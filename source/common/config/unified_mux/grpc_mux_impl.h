...
protected:
  ...
  virtual void sendGrpcMessage(void* msg_proto_ptr, SubscriptionState& sub_state) PURE;
...
protected:
  ...
  void sendGrpcMessage(void* msg_proto_ptr, SubscriptionState& sub_state) override;
