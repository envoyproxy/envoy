...
public:
   ...
   * reflection. For example, the _api_internal_do_not_use field generated by
  ...
  /**
   * Access the deprecated fields stored in the _api_internal_do_not_use field
   * of a message generated via VersionConverter::upgrade().
   *
