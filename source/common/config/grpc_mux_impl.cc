...
void GrpcMuxImpl::onEstablishmentFailure() {
  // Try to connect all of subscribed clusters which are included on grpc_service. If all of
  // attempts were failed, It may cause EnvoyException and notify all watches that connection
