...
public:
  /**
   * Translate a v1 JSON cluster manager object to v2 envoy::bootstrap::v2::Bootstrap.
   * @param json_cluster_manager source v1 JSON cluster manager object.
   * @param bootstrap destination v2 envoy::bootstrap::v2::Bootstrap.
   */
  ...
  /**
   * Translate a v1 JSON static config object to v2 envoy::bootstrap::v2::Bootstrap.
