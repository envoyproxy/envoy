...
public:
  static absl::StatusOr<DecodedResourceImplPtr> fromResource(OpaqueResourceDecoder& resource_decoder,
...
struct DecodedResourcesWrapper {
  ...
  static absl::StatusOr<std::unique_ptr<DecodedResourcesWrapper>> create(OpaqueResourceDecoder& resource_decoder,
