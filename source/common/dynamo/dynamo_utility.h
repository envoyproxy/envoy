...
public:
   ...
   * The stats format is "<stat_prefix>table.<table_name>.capacity.<operation>.__partition_id=<partition_id>".
   ...
   * 2. If the stats string with <table_name> is longer than the stats MAX_NAME_SIZE, we will truncate the table name to
