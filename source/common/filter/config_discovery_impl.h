...
class DownstreamNetworkDynamicFilterConfigProviderImpl
    : public NetworkDynamicFilterConfigProviderImplBase<FactoryCtx, NeutralNetworkFilterConfigFactory> {
public:
  using NetworkDynamicFilterConfigProviderImplBase<FactoryCtx, NeutralNetworkFilterConfigFactory>
        ::NetworkDynamicFilterConfigProviderImplBase;
  ...
  void validateMessage(const std::string& config_name, const Protobuf::Message& message,
    ...
    const bool is_terminal_filter = factory->isTerminalFilterByProto(message, this->server_context_);
    Config::Utility::validateTerminalFilters(config_name, factory_name, this->filter_chain_type_,
                                             is_terminal_filter, this->last_filter_in_filter_chain_);
  }
};
...
protected:
  ...
  void validateFilters(const std::string&, const std::string&, const std::string&,
