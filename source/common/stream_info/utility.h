...
public:
  ...
  constexpr static absl::string_view DROP_OVERLOAD_NO_HEALTHY_ENDPOINT = "DONHE";
  ...
  constexpr static absl::string_view DROP_OVERLOAD_NO_HEALTHY_ENDPOINT_LONG =
  ...
  static constexpr std::array CORE_RESPONSE_FLAGS{
      ...
      FlagStrings{DROP_OVERLOAD_NO_HEALTHY_ENDPOINT, DROP_OVERLOAD_NO_HEALTHY_ENDPOINT_LONG,
                  CoreResponseFlag::DropOverloadNoHealthyEndpoint},
  };
