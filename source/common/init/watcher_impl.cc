...
WatcherHandleImpl::WatcherHandleImpl(absl::string_view handle_name, absl::string_view name,
    ...
    : handle_name_(handle_name), name_(name), fn_has_parameter_(true), exfn_(std::move(fn)) {}
...
WatcherImpl::WatcherImpl(absl::string_view name, ExtraReadyFn fn)
    : name_(name), fn_has_parameter_(true), exfn_(std::make_shared<ExtraReadyFn>(std::move(fn))) {}
