...
void SecretManagerImpl::addStaticSecret(const envoy::api::v2::auth::Secret& secret) {
  ...
  // envoy::api::v2::auth::Secret::TypeCase::kTrustedCa is not supported, as static trusted ca
...
TrustedCaConfigProviderSharedPtr SecretManagerImpl::findOrCreateTrustedCaProvider(
    const envoy::api::v2::core::ConfigSource& sds_config_source, const std::string& config_name,
    Server::Configuration::TransportSocketFactoryContext& secret_provider_context) {
