...
public:
  ...
  void addStaticSecret(const envoy::api::v3alpha::auth::Secret& secret) override;
  ...
  TlsCertificateConfigProviderSharedPtr createInlineTlsCertificateProvider(
      const envoy::api::v3alpha::auth::TlsCertificate& tls_certificate) override;
  ...
  TlsSessionTicketKeysConfigProviderSharedPtr createInlineTlsSessionTicketKeysProvider(
      const envoy::api::v3alpha::auth::TlsSessionTicketKeys& tls_session_ticket_keys) override;
...
private:
  ...
  public:
    ...
    findOrCreate(const envoy::api::v3alpha::core::ConfigSource& sds_config_source,
