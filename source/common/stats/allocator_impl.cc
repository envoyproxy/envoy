...
public:
  StatsSharedImpl(StatName name, AllocatorImpl& alloc, absl::string_view tag_extracted_name,
      ...
      : MetricImpl<BaseClass>(name, tag_extracted_name, tags, stat_name_tags, alloc.symbolTable()),
        alloc_(alloc) {}
...
public:
  CounterImpl(StatName name, AllocatorImpl& alloc, absl::string_view tag_extracted_name,
              const std::vector<Tag>& tags, const StatNameTagVector& stat_name_tags)
      : StatsSharedImpl(name, alloc, tag_extracted_name, tags, stat_name_tags) {}
...
CounterSharedPtr AllocatorImpl::makeCounter(StatName name, absl::string_view tag_extracted_name,
  ...
  auto counter =
      CounterSharedPtr(new CounterImpl(name, *this, tag_extracted_name, tags, stat_name_tags));
...
GaugeSharedPtr AllocatorImpl::makeGauge(StatName name, absl::string_view tag_extracted_name,
  ...
  auto gauge = GaugeSharedPtr(
      new GaugeImpl(name, *this, tag_extracted_name, tags, stat_name_tags, import_mode));
