...
private:
  ...
  createChannel(const envoy::api::v3alpha::core::GrpcService::GoogleGrpc& config);
  ...
  const Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HeaderValue> initial_metadata_;
