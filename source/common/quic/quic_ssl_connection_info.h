...
public:
  ...
  const std::string& issuerPeerCertificateHash() const override { return EMPTY_STRING; }
  const std::string& issuerPeerCertificateSerial() const override { return EMPTY_STRING; }
