...
void EnvoyQuicClientSession::StartDraining() {
  ENVOY_CONN_LOG(trace, "Failed to migrate to the default network {}. Drain the connection on network {}.", *this, migration_manager().default_network(), migration_manager().current_network());
