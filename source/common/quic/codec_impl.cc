...
QuicHttpServerConnectionImpl::QuicHttpServerConnectionImpl(
    EnvoyQuicServerSession& quic_session, Http::ServerConnectionCallbacks& callbacks, const envoy::config::core::v3::Http3ProtocolOptions& http3_options, const uint32_t /*max_request_headers_kb*/,
...
<<<<<<< Updated upstream:source/common/quic/codec_impl.cc
=======
std::unique_ptr<Http::ClientConnection>
QuicHttpClientConnectionFactoryImpl::createQuicClientConnection(
    Network::Connection& connection, Http::ConnectionCallbacks& callbacks, const envoy::config::core::v3::Http3ProtocolOptions& http3_options, const uint32_t max_request_headers_kb) {
  return std::make_unique<Quic::QuicHttpClientConnectionImpl>(
      dynamic_cast<Quic::EnvoyQuicClientSession&>(connection), callbacks, http3_options, max_request_headers_kb);
}
...
QuicHttpServerConnectionFactoryImpl::createQuicServerConnection(
  ...
  return std::make_unique<Quic::QuicHttpServerConnectionImpl>(
      ...
      dynamic_cast<Http::ServerConnectionCallbacks&>(callbacks), http3_options, max_request_headers_kb, headers_with_underscores_action);
}
...
>>>>>>> Stashed changes:source/extensions/quic_listeners/quiche/codec_impl.cc
} // namespace Quic
} // namespace Envoy
