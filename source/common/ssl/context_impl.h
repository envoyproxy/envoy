...
public:
  virtual bssl::UniquePtr<SSL> newSsl(std::string overrideServerNameIndication = "") const;
...
public:
  ...
  bssl::UniquePtr<SSL> newSsl(std::string overrideServerNameIndication = "") const override;
