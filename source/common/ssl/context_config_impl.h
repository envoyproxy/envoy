...
public:
  ...
  bool disableCertificateExpirationVerification() const override {
    return disable_certificate_expiration_verification_;
  };
...
private:
  ...
  const bool disable_certificate_expiration_verification_;
