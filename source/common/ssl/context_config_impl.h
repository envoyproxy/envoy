...
public:
  ...
  const bssl::UniquePtr<X509_CRL>& certificateRevocationList() const override { return certificate_revocation_list_; }
...
private:
  ...
  const bssl::UniquePtr<X509_CRL> certificate_revocation_list_;
