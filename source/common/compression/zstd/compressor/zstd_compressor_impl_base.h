...
private:
  ...
  virtual void compressPreprocess() PURE;

  virtual void compressProcess(const Buffer::RawSlice& input_slice, Buffer::Instance& accumulation_buffer) PURE;

  virtual void compressPostprocess() PURE;
