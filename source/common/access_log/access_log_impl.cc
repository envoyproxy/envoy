...
bool GrpcStatusFilter::evaluate(const StreamInfo::StreamInfo& info, const Http::HeaderMap&,
  ...
  //
  // If none of those options exist, it will default to Grpc::Status::GrpcStatusMapping::Unknown.
  ...
  Grpc::Status::GrpcStatus status = Grpc::Status::GrpcStatusMapping::Unknown;
