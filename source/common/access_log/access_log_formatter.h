...
protected:
  std::string formatMetadata(const envoy::api::v3alpha::core::Metadata& metadata) const;
  ProtobufWkt::Value formatMetadataValue(const envoy::api::v3alpha::core::Metadata& metadata) const;
