...
public:
  ...
  virtual int mbxIsCryptoMbApplicable(int64u features) PURE;
  virtual mbx_status mbxNistp256EcdsaSignSslMb8(int8u* pa_sign_r[8], int8u* pa_sign_s[8],
                                                const int8u* const pa_msg[8],
                                                const BIGNUM* const pa_eph_skey[8],
                                                const BIGNUM* const pa_reg_skey[8],
                                                int8u* p_buffer) PURE;
  virtual mbx_status
  mbxRsaPrivateCrtSslMb8(const int8u* const from_pa[8], int8u* const to_pa[8],
  ...
  virtual mbx_status mbxRsaPublicSslMb8(const int8u* const from_pa[8], int8u* const to_pa[8],
