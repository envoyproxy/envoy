...
public:
  ...
  public:
    SessionStateImpl(std::optional<std::string> address, const EnvelopeSessionStateFactory& factory)
...
private:
  std::optional<std::string> parseAddress(Envoy::Http::RequestHeaderMap& headers) const;
