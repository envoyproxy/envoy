...
void HeaderBasedSessionStateFactory::SessionStateImpl::onUpdateHeader(
...
HeaderBasedSessionStateFactory::SessionStateImpl::onUpdateData(absl::string_view, Buffer::Instance&,
                                                               bool) {
