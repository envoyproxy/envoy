...
// Next 4 bytes of file should be "0002".
constexpr std::array<char, 4> ExpectedCacheVersionId = {'0', '0', '0', '2'};

} // namespace

CacheFileFixedBlock::CacheFileFixedBlock()
    : file_id_(ExpectedFileId), cache_version_id_(ExpectedCacheVersionId) {}
