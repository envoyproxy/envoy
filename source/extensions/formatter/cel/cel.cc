...
CELFormatter::format(const Envoy::Formatter::HttpFormatterContext& context,
...
ProtobufWkt::Value CELFormatter::formatValue(const Envoy::Formatter::HttpFormatterContext& context,
                                             const StreamInfo::StreamInfo& stream_info) const {
