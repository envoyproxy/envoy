...
const envoy::config::core::v3::Http1ProtocolOptions& getHttpOptions(
...
const envoy::config::core::v3::Http2ProtocolOptions& getHttp2Options(
    const envoy::extensions::filters::network::http_connection_manager::v3::HttpProtocolOptions&
        options) {
  if (options.has_explicit_http_config()) {
...
ProtocolOptionsConfigImpl::ProtocolOptionsConfigImpl(
    ...
    : http1_settings_(Http::Utility::parseHttp1Settings(http1_settings)),
      ...
      upstream_http_protocol_options_(upstream_options), use_alpn_(use_alpn),
