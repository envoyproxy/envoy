...
HttpConnectionManagerConfig::HttpConnectionManagerConfig(
  ...
  case envoy::config::filter::network::http_connection_manager::v3alpha::HttpConnectionManager::
  ...
  if (config.has_tracing()) {
    ...
    case envoy::api::v3alpha::core::UNSPECIFIED: {
    ...
    case envoy::api::v3alpha::core::INBOUND:
      tracing_operation_name = Tracing::OperationName::Ingress;
      break;
    case envoy::api::v3alpha::core::OUTBOUND:
      tracing_operation_name = Tracing::OperationName::Egress;
      break;
    default:
      NOT_REACHED_GCOVR_EXCL_LINE;
...
void HttpConnectionManagerConfig::processFilter(
    const envoy::config::filter::network::http_connection_manager::v3alpha::HttpFilter&
        proto_config,
