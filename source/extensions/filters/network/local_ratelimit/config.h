...
#include "envoy/extensions/filters/network/local_ratelimit/v3alpha/local_rate_limit.pb.validate.h"
...
class LocalRateLimitConfigFactory
    : public Common::FactoryBase<
          envoy::extensions::filters::network::local_ratelimit::v3alpha::LocalRateLimit> {
public:
  LocalRateLimitConfigFactory() : FactoryBase(NetworkFilterNames::get().LocalRateLimit) {}

private:
  Network::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoy::extensions::filters::network::local_ratelimit::v3alpha::LocalRateLimit&
          proto_config,
