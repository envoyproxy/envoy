...
#include "envoy/config/filter/network/tcp_proxy/v3alpha/tcp_proxy.pb.validate.h"
...
Network::FilterFactoryCb ConfigFactory::createFilterFactoryFromProtoTyped(
    const envoy::config::filter::network::tcp_proxy::v3alpha::TcpProxy& proto_config,
