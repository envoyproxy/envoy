...
import source.extensions.filters.network.kafka.protocol_code_generator.kafka_generator as generator
import sys
import os
...
def main():
  ...
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~
  Generates C++ code from Kafka protocol specification.
  ...
  print 'Generating (main) Kafka protocol files: %s' % (type)
