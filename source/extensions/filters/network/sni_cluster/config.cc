...
Network::FilterFactoryCb SniClusterNetworkFilterConfigFactory::createFilterFactory(const Json::Object&,
...
SniClusterNetworkFilterConfigFactory::createFilterFactoryFromProto(const Protobuf::Message&,
                                                                   Server::Configuration::FactoryContext&) {
