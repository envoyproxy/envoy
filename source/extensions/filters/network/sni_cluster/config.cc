...
#include "envoy/extensions/filters/network/sni_cluster/v3alpha/sni_cluster.pb.h"
#include "envoy/extensions/filters/network/sni_cluster/v3alpha/sni_cluster.pb.validate.h"
...
ProtobufTypes::MessagePtr SniClusterNetworkFilterConfigFactory::createEmptyConfigProto() {
  return std::make_unique<envoy::extensions::filters::network::sni_cluster::v3alpha::SniCluster>();
}
