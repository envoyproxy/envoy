...
//#include "extensions/filters/network/sip_proxy/sip_object.h"
...
//
///**
// * Protocol represents the operations necessary to implement the a generic Sip protocol.
// * See https://github.com/apache/sip/blob/master/doc/specs/sip-protocol-spec.md
// */
// class Protocol {
// public:
...
//
//  /**
//   * Reads the start of a Sip protocol message from the buffer and updates the metadata
...
//
//  /**
//   * Reads the end of a Sip protocol message from the buffer. If successful, the message footer
...
//
//  /**
//   * Reads the start of a Sip struct from the buffer and updates the name parameter with the
...
//
//  /**
//   * Reads the end of a Sip struct from the buffer. If successful, the struct footer is removed
//   * from the buffer.
//   * @param buffer the buffer to read from
...
//
//  /**
//   * Reads the start of a Sip struct field from the buffer and updates the name, field_type, and
...
//
//  /**
//   * Reads the end of a Sip struct field from the buffer. If successful, the field footer is
//   * removed from the buffer.
//   * @param buffer the buffer to read from
...
//
//  /**
//   * Reads the start of a Sip map from the buffer and updates the key_type, value_type, and size
...
//
//  /**
//   * Reads the end of a Sip map from the buffer. If successful, the map footer is removed from
//   * the buffer.
//   * @param buffer the buffer to read from
...
//
//  /**
//   * Reads the start of a Sip list from the buffer and updates the elem_type, and size
//   * parameters with the values from the list header. If successful, the list header is removed
//   from
//   * the buffer.
//   * @param buffer the buffer to read from
...
//
//  /**
//   * Reads the end of a Sip list from the buffer. If successful, the list footer is removed from
//   * the buffer.
//   * @param buffer the buffer to read from
...
//
//  /**
//   * Reads the start of a Sip set from the buffer and updates the elem_type, and size
...
//
//  /**
//   * Reads the end of a Sip set from the buffer. If successful, the set footer is removed from
//   * the buffer.
//   * @param buffer the buffer to read from
...
//
//  /**
//   * Reads a byte value from the buffer and updates value. If successful, the value is removed
//   from
//   * the buffer.
//   * @param buffer the buffer to read from
//   * @param value updated with the value read from the buffer
...
//
//  /**
//   * Writes the start of a Sip protocol message to the buffer.
...
//
//  /**
//   * Writes the end of a Sip protocol message to the buffer.
//   * @param buffer Buffer::Instance to modify
//   */
//  virtual void writeMessageEnd(Buffer::Instance& buffer) PURE;
//
//  /**
//   * Writes the start of a Sip struct to the buffer.
//   * @param buffer Buffer::Instance to modify
...
//
//  /**
//   * Writes the end of a Sip struct to the buffer.
//   * @param buffer Buffer::Instance to modify
//   */
//  virtual void writeStructEnd(Buffer::Instance& buffer) PURE;
//
//  /**
//   * Writes the start of a Sip struct field to the buffer
//   * @param buffer Buffer::Instance to modify
...
//
//  /**
//   * Writes the end of a Sip struct field to the buffer.
//   * @param buffer Buffer::Instance to modify
//   */
//  virtual void writeFieldEnd(Buffer::Instance& buffer) PURE;
//
//  /**
//   * Writes the start of a Sip map to the buffer.
//   * @param buffer Buffer::Instance to modify
...
//
//  /**
//   * Writes the end of a Sip map to the buffer.
//   * @param buffer Buffer::Instance to modify
//   */
//  virtual void writeMapEnd(Buffer::Instance& buffer) PURE;
//
//  /**
//   * Writes the start of a Sip list to the buffer.
//   * @param buffer Buffer::Instance to modify
...
//
//  /**
//   * Writes the end of a Sip list to the buffer.
//   * @param buffer Buffer::Instance to modify
//   */
//  virtual void writeListEnd(Buffer::Instance& buffer) PURE;
//
//  /**
//   * Writes the start of a Sip set to the buffer.
//   * @param buffer Buffer::Instance to modify
...
//
//  /**
//   * Writes the end of a Sip set to the buffer.
//   * @param buffer Buffer::Instance to modify
//   */
...
//   * message. If this method returns a SipObject it will be used to decode the upstream's next
//   * response.
//   *
//   * @param transport the Transport to use for decoding the response
//   * @param state SipConnectionState tracking whether upgrade has already been performed
//   * @param buffer Buffer::Instance to modify with an upgrade request
//   * @return a SipObject capable of decoding an upgrade response or nullptr if upgrade was
//   *         already completed (successfully or not)
//   */
//  virtual SipObjectPtr attemptUpgrade(Transport& transport, SipConnectionState& state,
...
//   * @param response SipObject created by attemptUpgrade, after the response has completed
//   *        decoding
//   */
//  virtual void completeUpgrade(SipConnectionState& state, SipObject& response) {
//    UNREFERENCED_PARAMETER(state);
...
//
///**
// * Implemented by each Sip protocol and registered via Registry::registerFactory or the
...
//
//  /**
//   * Create a particular Sip protocol
//   * @return ProtocolFactoryCb the protocol
//   */
//  virtual ProtocolPtr createProtocol() PURE;
//
//  std::string category() const override { return "envoy.sip_proxy.protocols"; }
//
//  /**
