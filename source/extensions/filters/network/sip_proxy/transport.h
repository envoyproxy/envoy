...
//
///**
// * Transport represents a Sip transport. The Sip transport is nominally a generic,
...
//   *
//   * @param buffer the currently buffered sip data.
...
//
///**
// * Implemented by each Sip transport and registered via Registry::registerFactory or the
...
//
//  /**
//   * Create a particular Sip transport.
//   * @return TransportPtr the transport
//   */
//  virtual TransportPtr createTransport() PURE;
//
//  std::string category() const override { return "envoy.sip_proxy.transports"; }
//
//  /**
