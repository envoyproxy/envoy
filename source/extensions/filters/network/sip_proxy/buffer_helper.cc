...
// Sip's var int encoding is described in
// https://github.com/apache/sip/blob/master/doc/specs/sip-compact-protocol.md
...
// Sip's zig-zag int encoding is described in
// https://github.com/apache/sip/blob/master/doc/specs/sip-compact-protocol.md
