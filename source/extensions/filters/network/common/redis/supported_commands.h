...
struct SupportedCommands {
  ...
  static const absl::flat_hash_set<std::string>& simpleCommands() {
    CONSTRUCT_ON_FIRST_USE(
        ...
        "pexpire", "pexpireat", "pfadd", "pfcount", "psetex", "pttl", "restore", "rpop", "rpush", "rpushx",
        "sadd", "scard", "set", "setbit", "setex", "setnx", "setrange", "sismember", "smembers", "spop",
  ...
  static const absl::flat_hash_set<std::string>& writeCommands() {
    CONSTRUCT_ON_FIRST_USE(
        ...
        "lset", "ltrim", "mset", "persist", "pexpire", "pexpireat", "pfadd", "psetex", "restore", "rpop",
