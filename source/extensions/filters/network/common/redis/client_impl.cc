...
ConfigImpl::ConfigImpl(
  ...
  case envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::ConnPoolSettings::MASTER:
    read_policy_ = ReadPolicy::Master;
    break;
  case envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::ConnPoolSettings::
      PREFER_MASTER:
    read_policy_ = ReadPolicy::PreferMaster;
    break;
  case envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::ConnPoolSettings::REPLICA:
  ...
  case envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::ConnPoolSettings::
    ...
    break;
  case envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::ConnPoolSettings::ANY:
