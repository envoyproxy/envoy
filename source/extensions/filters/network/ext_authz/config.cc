...
#include "envoy/config/filter/network/ext_authz/v3alpha/ext_authz.pb.h"
#include "envoy/config/filter/network/ext_authz/v3alpha/ext_authz.pb.validate.h"
...
Network::FilterFactoryCb ExtAuthzConfigFactory::createFilterFactoryFromProtoTyped(
    const envoy::config::filter::network::ext_authz::v3alpha::ExtAuthz& proto_config,
