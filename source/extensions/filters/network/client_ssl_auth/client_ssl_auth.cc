...
#include "envoy/config/filter/network/client_ssl_auth/v3alpha/client_ssl_auth.pb.h"
...
ClientSslAuthConfig::ClientSslAuthConfig(
    const envoy::config::filter::network::client_ssl_auth::v3alpha::ClientSSLAuth& config,
