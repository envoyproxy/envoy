...
public:
  RoleBasedAccessControlFilterConfig(
      const envoy::config::filter::network::rbac::v3alpha::RBAC& proto_config, Stats::Scope& scope);
  ...
  envoy::config::filter::network::rbac::v3alpha::RBAC::EnforcementType enforcementType() const {
...
private:
  ...
  const envoy::config::filter::network::rbac::v3alpha::RBAC::EnforcementType enforcement_type_;
};
