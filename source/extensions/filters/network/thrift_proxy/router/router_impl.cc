...
RouteEntryImplBase::RouteEntryImplBase(
  ...
  if (route.route().cluster_specifier_case() ==
      envoy::config::filter::network::thrift_proxy::v3alpha::RouteAction::ClusterSpecifierCase::
          kWeightedClusters) {
...
RouteMatcher::RouteMatcher(
    const envoy::config::filter::network::thrift_proxy::v3alpha::RouteConfiguration& config) {
  using envoy::config::filter::network::thrift_proxy::v3alpha::RouteMatch;
