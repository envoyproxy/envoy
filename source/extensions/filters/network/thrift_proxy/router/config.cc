...
#include "envoy/config/filter/thrift/router/v2/router.pb.h"
#include "envoy/config/filter/thrift/router/v2/router.pb.validate.h"
...
ThriftFilters::FilterFactoryCb RouterFilterConfig::createFilterFactoryFromProtoTyped(
    const envoy::config::filter::thrift::router::v2::Router& proto_config,
