...
#include "envoy/config/filter/network/thrift_proxy/v3alpha/route.pb.h"
...
public:
  RouteEntryImplBase(const envoy::config::filter::network::thrift_proxy::v3alpha::Route& route);
...
private:
  ...
  public:
    WeightedClusterEntry(
        ...
        const envoy::config::filter::network::thrift_proxy::v3alpha::WeightedCluster::ClusterWeight&
            cluster);
...
public:
  MethodNameRouteEntryImpl(
      const envoy::config::filter::network::thrift_proxy::v3alpha::Route& route);
...
class RouteMatcher {
public:
  RouteMatcher(const envoy::config::filter::network::thrift_proxy::v3alpha::RouteConfiguration&);
