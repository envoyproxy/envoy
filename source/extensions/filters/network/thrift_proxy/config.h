...
public:
  ProtocolOptionsConfigImpl(
      const envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProtocolOptions&
          proto_config);
...
class ThriftProxyFilterConfigFactory
    : public Common::FactoryBase<
          envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy,
          envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProtocolOptions> {
public:
...
public:
  ConfigImpl(const envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy& config,
