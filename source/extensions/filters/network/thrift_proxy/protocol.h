...
public:
   ...
   */
  virtual void setType(ProtocolType) { NOT_IMPLEMENTED_LCOV_EXCL_LINE; }
   ...
   */
  virtual DecoderEventHandlerSharedPtr upgradeRequestDecoder() { NOT_IMPLEMENTED_LCOV_EXCL_LINE; }
