...
#include "envoy/config/filter/network/thrift_proxy/v3alpha/thrift_proxy.pb.validate.h"
...
using TransportTypeMap =
    std::map<envoy::config::filter::network::thrift_proxy::v3alpha::TransportType, TransportType>;

static const TransportTypeMap& transportTypeMap() {
  CONSTRUCT_ON_FIRST_USE(
      TransportTypeMap,
      {
          {envoy::config::filter::network::thrift_proxy::v3alpha::AUTO_TRANSPORT,
           TransportType::Auto},
          {envoy::config::filter::network::thrift_proxy::v3alpha::FRAMED, TransportType::Framed},
          {envoy::config::filter::network::thrift_proxy::v3alpha::UNFRAMED,
           TransportType::Unframed},
          {envoy::config::filter::network::thrift_proxy::v3alpha::HEADER, TransportType::Header},
      });
}

using ProtocolTypeMap =
    std::map<envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType, ProtocolType>;

static const ProtocolTypeMap& protocolTypeMap() {
  CONSTRUCT_ON_FIRST_USE(
      ProtocolTypeMap,
      {
          {envoy::config::filter::network::thrift_proxy::v3alpha::AUTO_PROTOCOL,
           ProtocolType::Auto},
          {envoy::config::filter::network::thrift_proxy::v3alpha::BINARY, ProtocolType::Binary},
          {envoy::config::filter::network::thrift_proxy::v3alpha::LAX_BINARY,
           ProtocolType::LaxBinary},
          {envoy::config::filter::network::thrift_proxy::v3alpha::COMPACT, ProtocolType::Compact},
          {envoy::config::filter::network::thrift_proxy::v3alpha::TWITTER, ProtocolType::Twitter},
      });
}

TransportType
lookupTransport(envoy::config::filter::network::thrift_proxy::v3alpha::TransportType transport) {
  const auto& transport_iter = transportTypeMap().find(transport);
  if (transport_iter == transportTypeMap().end()) {
    throw EnvoyException(fmt::format(
        "unknown transport {}",
        envoy::config::filter::network::thrift_proxy::v3alpha::TransportType_Name(transport)));
  }
...
ProtocolType
lookupProtocol(envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType protocol) {
  const auto& protocol_iter = protocolTypeMap().find(protocol);
  if (protocol_iter == protocolTypeMap().end()) {
    throw EnvoyException(fmt::format(
        "unknown protocol {}",
        envoy::config::filter::network::thrift_proxy::v3alpha::ProtocolType_Name(protocol)));
  }
...
ProtocolOptionsConfigImpl::ProtocolOptionsConfigImpl(
    const envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProtocolOptions& config)
...
Network::FilterFactoryCb ThriftProxyFilterConfigFactory::createFilterFactoryFromProtoTyped(
    const envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy& proto_config,
...
ConfigImpl::ConfigImpl(
    const envoy::config::filter::network::thrift_proxy::v3alpha::ThriftProxy& config,
    Server::Configuration::FactoryContext& context)
  ...
  if (config.thrift_filters().empty()) {
    ...
    envoy::config::filter::network::thrift_proxy::v3alpha::ThriftFilter router;
...
void ConfigImpl::processFilter(
    const envoy::config::filter::network::thrift_proxy::v3alpha::ThriftFilter& proto_config) {
