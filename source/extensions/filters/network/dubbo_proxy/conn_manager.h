...
public:
  using ConfigProtocolType = envoy::config::filter::network::dubbo_proxy::v3alpha::ProtocolType;
  using ConfigSerializationType =
      envoy::config::filter::network::dubbo_proxy::v3alpha::SerializationType;
