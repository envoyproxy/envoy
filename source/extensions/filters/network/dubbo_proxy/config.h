...
public:
  using DubboProxyConfig = envoy::extensions::filters::network::dubbo_proxy::v3alpha::DubboProxy;
  using DubboFilterConfig = envoy::extensions::filters::network::dubbo_proxy::v3alpha::DubboFilter;
