...
class DubboProxyFilterConfigFactory
    : public Common::FactoryBase<envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy> {
public:
  DubboProxyFilterConfigFactory() : FactoryBase(NetworkFilterNames::get().DubboProxy, true) {}

private:
  Network::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy& proto_config,
...
public:
  using DubboProxyConfig = envoy::config::filter::network::dubbo_proxy::v3alpha::DubboProxy;
  using DubboFilterConfig = envoy::config::filter::network::dubbo_proxy::v3alpha::DubboFilter;
