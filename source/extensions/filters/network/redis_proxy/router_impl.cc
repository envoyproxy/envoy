...
MirrorPolicyImpl::MirrorPolicyImpl(const envoy::config::filter::network::redis_proxy::v3alpha::
...
Prefix::Prefix(
    const envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::PrefixRoutes::Route
        route,
...
PrefixRoutes::PrefixRoutes(
    const envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::PrefixRoutes& config,
    Upstreams&& upstreams, Runtime::Loader& runtime)
