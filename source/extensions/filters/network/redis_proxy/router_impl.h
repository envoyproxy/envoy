...
public:
  MirrorPolicyImpl(const envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::
...
public:
  Prefix(const envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::PrefixRoutes::Route
             route,
...
public:
  PrefixRoutes(const envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::PrefixRoutes&
                   prefix_routes,
               Upstreams&& upstreams, Runtime::Loader& runtime);
