...
Network::FilterFactoryCb RedisProxyFilterConfigFactory::createFilterFactoryFromProtoTyped(
    const envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy& proto_config,
  ...
  envoy::config::filter::network::redis_proxy::v3alpha::RedisProxy::PrefixRoutes prefix_routes(
