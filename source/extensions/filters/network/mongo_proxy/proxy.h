...
private:
  ...
  void chargeQueryStats(Stats::Utility::ElementVec& names, QueryMessageInfo::QueryType query_type);
  ...
  void chargeReplyStats(ActiveQuery& active_query, Stats::Utility::ElementVec& names,
