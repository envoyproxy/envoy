...
void ProxyFilter::chargeQueryStats(Stats::Utility::ElementVec& names,
...
void ProxyFilter::chargeReplyStats(ActiveQuery& active_query, Stats::Utility::ElementVec& names,
