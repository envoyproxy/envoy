...
using RateLimitAsyncCallbacks =
    Grpc::AsyncRequestCallbacks<envoy::service::ratelimit::v3alpha::RateLimitResponse>;
...
public:
  ...
  static void createRequest(envoy::service::ratelimit::v3alpha::RateLimitRequest& request,
  ...
  void onSuccess(std::unique_ptr<envoy::service::ratelimit::v3alpha::RateLimitResponse>&& response,
...
private:
  ...
  Grpc::AsyncClient<envoy::service::ratelimit::v3alpha::RateLimitRequest,
                    envoy::service::ratelimit::v3alpha::RateLimitResponse>
      async_client_;
...
ClientPtr rateLimitClient(Server::Configuration::FactoryContext& context,
                          const envoy::config::core::v3alpha::GrpcService& grpc_service,
