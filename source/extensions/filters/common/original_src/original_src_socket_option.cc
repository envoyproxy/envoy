...
bool OriginalSrcSocketOption::setOption(
    Network::Socket& socket, envoy::api::v3alpha::core::SocketOption::SocketState state) const {

  if (state == envoy::api::v3alpha::core::SocketOption::STATE_PREBIND) {
...
absl::optional<Network::Socket::Option::Details> OriginalSrcSocketOption::getOptionDetails(
    const Network::Socket&, envoy::api::v3alpha::core::SocketOption::SocketState) const {
