...
class ClientConfig {
public:
  ClientConfig(const envoy::config::filter::http::ext_authz::v3alpha::ExtAuthz& config,
...
private:
  ...
  toHeadersAdd(const Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HeaderValue>&);
