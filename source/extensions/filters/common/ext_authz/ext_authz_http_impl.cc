...
// Config
ClientConfig::ClientConfig(const envoy::config::filter::http::ext_authz::v3alpha::ExtAuthz& config,
...
Http::LowerCaseStrPairVector ClientConfig::toHeadersAdd(
    const Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HeaderValue>& headers) {
