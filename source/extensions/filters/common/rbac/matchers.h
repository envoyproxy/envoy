...
public:
  HeaderMatcher(const envoy::api::v3alpha::route::HeaderMatcher& matcher) : header_(matcher) {}
...
public:
  IPMatcher(const envoy::api::v3alpha::core::CidrRange& range, bool destination)
