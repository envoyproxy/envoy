...
#include "envoy/extensions/filters/common/rbac/matchers/v3/upstream_ip_matcher.pb.validate.h"
...
// the `envoy::extensions::filters::common::rbac::matchers::v3::UpstreamIpMatcher` configuration
// with the resolved upstream IP (v4 and v6).
class UpstreamIpMatcher : public Filters::Common::RBAC::Matcher {
public:
  UpstreamIpMatcher(
      const envoy::extensions::filters::common::rbac::matchers::v3::UpstreamIpMatcher& proto)
...
class UpstreamIpMatcherFactory
    : public Filters::Common::RBAC::BaseMatcherExtensionFactory<
          UpstreamIpMatcher,
          envoy::extensions::filters::common::rbac::matchers::v3::UpstreamIpMatcher> {
public:
