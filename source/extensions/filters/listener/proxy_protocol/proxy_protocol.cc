...
using Envoy::Extensions::Filters::Common::ProxyProtocol::PROXY_PROTO_V1_SIGNATURE_LEN;
...
using Envoy::Extensions::Filters::Common::ProxyProtocol::PROXY_PROTO_V2_HEADER_LEN;
using Envoy::Extensions::Filters::Common::ProxyProtocol::PROXY_PROTO_V2_LOCAL;
...
using Envoy::Extensions::Filters::Common::ProxyProtocol::PROXY_PROTO_V2_TRANSPORT_DGRAM;
