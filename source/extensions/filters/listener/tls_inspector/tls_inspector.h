...
public:
  ...
  bool enableConnectionFingerprinting() const { return enable_connection_fingerprinting_; }
...
private:
  ...
  const bool enable_connection_fingerprinting_;
...
private:
  ...
  void connectionFingerprint(const SSL_CLIENT_HELLO* ssl_client_hello);
