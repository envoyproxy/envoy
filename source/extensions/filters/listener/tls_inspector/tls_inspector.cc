...
// `JA4` uses the first 12 hex characters (6 bytes) of a SHA-256 hash for each component
// of the fingerprint. This provides a good balance between uniqueness and brevity.
...
// Checks if a value is not a GREASE value
// Returns true if the value is NOT a GREASE value (i.e., it should be included in fingerprinting)
// Returns false if the value IS a GREASE value (i.e., it should be excluded from fingerprinting)
