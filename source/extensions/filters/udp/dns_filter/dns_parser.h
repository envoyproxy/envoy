...
public:
  ...
  //         record_class_(record_class), available_bytes_(available_bytes),
  //         data_length_(data_length), ttl_(ttl), offset_(offset) {}
  ...
  //  * @param buffer a reference to a buffer containing a DNS request or response
  //  * @param offset a reference to an index into the buffer indicating the position where reading
  //  may
  //  * begin
  //  */
