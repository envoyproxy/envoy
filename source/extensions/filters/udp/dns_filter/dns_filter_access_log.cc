...
public:
  using FieldExtractor = std::function<std::optional<std::string>(const Formatter::Context&,
...
public:
  using ProviderFunc =
      std::function<Formatter::FormatterProviderPtr(absl::string_view, std::optional<size_t>)>;
...
private:
  static const ProviderFuncTable& providerFuncTable() {
    CONSTRUCT_ON_FIRST_USE(
        ...
        {
            {"QUERY_NAME",
             [](absl::string_view, std::optional<size_t>) -> Formatter::FormatterProviderPtr {
