...
#include "source/extensions/filters/http/credentials/oauth.h"
...
public:
  virtual void asyncGetAccessToken(const std::string& client_id,
...
public:
   ...
   */
  void asyncGetAccessToken(const std::string& client_id,
