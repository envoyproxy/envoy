...
public:
  ...
  make(const envoy::extensions::filters::http::cache::v3::CacheConfig& config,
...
private:
  ...
  static HttpCache& getCache(const envoy::extensions::filters::http::cache::v3::CacheConfig& config);
