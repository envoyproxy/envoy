...
public:
   ...
   * @param audience the value for the 'aud' claim (typically the token endpoint URL or
   ...
   * @param kid the Key ID for the JWT header (RFC 7515 Section 4.1.4); empty means no
   *        'kid' header field is emitted.
