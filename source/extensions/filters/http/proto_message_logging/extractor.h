...
struct AuditResult {
  ...
  std::vector<::Envoy::Extensions::HttpFilters::ProtoMessageLogging::AuditMetadata> request_data;
  std::vector<::Envoy::Extensions::HttpFilters::ProtoMessageLogging::AuditMetadata> response_data;
...
public:
  ...
  virtual absl::StatusOr<ExtractorPtr>
