...
using AuthenticatorCallback = std::function<void(const ::Envoy::JwtVerify::Status& status)>;
...
public:
  ...
  static AuthenticatorPtr create(const ::Envoy::JwtVerify::CheckAudience* check_audience,
...
public:
  ...
  virtual AuthenticatorPtr create(const ::Envoy::JwtVerify::CheckAudience* check_audience,
                                  const absl::optional<std::string>& provider, bool allow_failed,
