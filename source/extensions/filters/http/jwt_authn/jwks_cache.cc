...
public:
  JwksDataImpl(const JwtProvider& jwt_provider, Server::Configuration::ServerFactoryContext& context,
...
public:
  ...
  JwksCacheImpl(const JwtAuthentication& config, Server::Configuration::ServerFactoryContext& context,
