...
using envoy::config::filter::http::jwt_authn::v3alpha::JwtRequirement;
using envoy::config::filter::http::jwt_authn::v3alpha::JwtRequirementAndList;
using envoy::config::filter::http::jwt_authn::v3alpha::JwtRequirementOrList;
