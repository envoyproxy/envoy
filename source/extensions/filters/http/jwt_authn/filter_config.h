...
public:
  ...
  ThreadLocalCache(const envoy::config::filter::http::jwt_authn::v3alpha::JwtAuthentication& config,
...
public:
  ...
  FilterConfig(envoy::config::filter::http::jwt_authn::v3alpha::JwtAuthentication proto_config,
...
private:
  ...
  // The proto config.
  envoy::config::filter::http::jwt_authn::v3alpha::JwtAuthentication proto_config_;
