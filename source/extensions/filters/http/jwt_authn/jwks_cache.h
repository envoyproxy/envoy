...
public:
  ...
  public:
    ...
    virtual const envoy::extensions::filters::http::jwt_authn::v3alpha::JwtProvider&
  ...
  static JwksCachePtr
  create(const envoy::extensions::filters::http::jwt_authn::v3alpha::JwtAuthentication& config,
