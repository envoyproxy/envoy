...
public:
  CsrfPolicy(const envoy::config::filter::http::csrf::v3alpha::CsrfPolicy& policy,
  ...
  bool enabled() const {
    const envoy::api::v3alpha::core::RuntimeFractionalPercent& filter_enabled =
  ...
  bool shadowEnabled() const {
    ...
    const envoy::api::v3alpha::core::RuntimeFractionalPercent& shadow_enabled =
...
private:
  const envoy::config::filter::http::csrf::v3alpha::CsrfPolicy policy_;
...
public:
  CsrfFilterConfig(const envoy::config::filter::http::csrf::v3alpha::CsrfPolicy& policy,
