...
Http::HeaderMap::Iterate fillHeaderList(const Http::HeaderEntry& header, void* context) {
  Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HeaderValue>& header_list =
      *reinterpret_cast<Protobuf::RepeatedPtrField<envoy::api::v3alpha::core::HeaderValue>*>(
          context);
...
HttpTapConfigImpl::HttpTapConfigImpl(envoy::service::tap::v3alpha::TapConfig&& proto_config,
