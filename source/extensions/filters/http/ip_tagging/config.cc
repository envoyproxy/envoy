...
#include "envoy/extensions/filter/http/ip_tagging/v3alpha/ip_tagging.pb.validate.h"
...
Http::FilterFactoryCb IpTaggingFilterFactory::createFilterFactoryFromProtoTyped(
    const envoy::extensions::filter::http::ip_tagging::v3alpha::IPTagging& proto_config,
