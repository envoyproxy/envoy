...
private:
  ...
  // Eviction takes two configuration parameters:
  //   1. Eviction candidate ratio: The fraction of the cache to read for potential eviction
  //   2. Eviction threshold ratio: Evict items with TTL lower than X% of the average TTL
  void Evict() {
