...
#include "envoy/config/filter/http/router/v3alpha/router.pb.validate.h"
...
class RouterFilterConfig
    : public Common::FactoryBase<envoy::config::filter::http::router::v3alpha::Router> {
public:
...
private:
  Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoy::config::filter::http::router::v3alpha::Router& proto_config,
