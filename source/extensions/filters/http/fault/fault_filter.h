...
public:
  FaultSettings(const envoy::config::filter::http::fault::v3alpha::HTTPFault& fault);
...
public:
  FaultFilterConfig(const envoy::config::filter::http::fault::v3alpha::HTTPFault& fault,
