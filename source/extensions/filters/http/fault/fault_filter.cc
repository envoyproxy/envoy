...
FaultSettings::FaultSettings(const envoy::config::filter::http::fault::v3alpha::HTTPFault& fault)
...
FaultFilterConfig::FaultFilterConfig(
    const envoy::config::filter::http::fault::v3alpha::HTTPFault& fault, Runtime::Loader& runtime,
