...
class FaultFilterFactory
    : public Common::FactoryBase<envoy::extensions::filters::http::fault::v3alpha::HTTPFault> {
public:
  FaultFilterFactory() : FactoryBase(HttpFilterNames::get().Fault) {}

private:
  Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoy::extensions::filters::http::fault::v3alpha::HTTPFault& proto_config,
