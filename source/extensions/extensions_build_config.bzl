...
EXTENSIONS = {
    ...
    #
    "envoy.path.match.pattern_template.pattern_template_matcher": "//source/extensions/path/match/pattern_template:config",
    "envoy.path.rewrite.pattern_template.pattern_template_rewriter": "//source/extensions/path/rewrite/pattern_template:config",
