...
EXTENSIONS = {
    ...
    # UDP packet writers
    #
    "envoy.udp_packet_writer.default": "//source/source/common/network:udp_packet_writer_handler_lib",
    "envoy.udp_packet_writer.gso": "//source/common/quic:udp_gso_batch_writer_lib",
