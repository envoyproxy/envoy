...
EXTENSIONS = {
    ...
    #
    "envoy.extensions.outlier_detection_monitors.consecutive_errors": "//source/extensions/outlier_detection_monitors/consecutive_errors:consecutive_errors_monitor_lib",
