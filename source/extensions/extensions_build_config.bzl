...
EXTENSIONS = {
    ...
    "envoy.filters.network.kafka_parser_lib":           "//source/extensions/filters/network/kafka:parser_lib",
    "envoy.filters.network.kafka_serialization_lib":    "//source/extensions/filters/network/kafka:serialization_lib",
