...
EXTENSIONS = {
    ...
    #
    # External Processing On Processing Response
    #
    "envoy.http.ext_proc.save_processing_response":         "//source/extensions/http/ext_proc/save_processing_response:save_processing_response_lib",
