...
EXTENSIONS = {
    ...
    # Pattern Template
    #
    "envoy.path_match_policy.pattern_template_match_predicate": "//source/extensions/pattern_template/match:config",
    "envoy.path_rewrite_policy.pattern_template_rewrite_predicate": "//source/extensions/pattern_template/rewrite:config",
