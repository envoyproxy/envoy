...
public:
  CelBootstrapExtension(Server::Configuration::ServerFactoryContext&,
  ...
  const envoy::extensions::bootstrap::cel::v3::CelEvaluatorConfig& config() const {
    return config_;
  }

private:
  const envoy::extensions::bootstrap::cel::v3::CelEvaluatorConfig config_;
};
...
public:
  ...
  ProtobufTypes::MessagePtr createEmptyConfigProto() override {
    return std::make_unique<envoy::extensions::bootstrap::cel::v3::CelEvaluatorConfig>();
  }
