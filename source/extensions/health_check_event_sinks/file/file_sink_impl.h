...
#include "envoy/extensions/health_check_event_sinks/file/v3/file.proto.h"
...
class HealthCheckEventFileSink : public HealthCheckEventSink {
 public:
  explicit HealthCheckEventFileSink(
      const envoy::extensions::health_check_event_sinks::file::v3::
          HealthCheckEventFileSink& config,
...
class HealthCheckEventFileSinkFactory : public HealthCheckEventSinkFactory {
 public:
  ...
  std::string name() const override {
    return "envoy.health_check_event_sink.file";
  }

  ProtobufTypes::MessagePtr createEmptyConfigProto() override {
    return ProtobufTypes::MessagePtr{
        new envoy::extensions::health_check_event_sinks::file::v3::
