...
// Returns the parsed Url rewrite pattern and processes variables to be used by
// RewriteURLTemplatePattern() and in rewrite.
// |capture_regex| should be the regex generated by ConvertURLPatternSyntaxToRegex().
