...
using AggregationTemporality =
    ::Envoy::Extensions::Common::OpenTelemetry::Sdk::Metrics::AggregationTemporality;
using MetricsExportRequest =
    ::Envoy::Extensions::Common::OpenTelemetry::Sdk::Metrics::ExportRequest;
using MetricsExportResponse =
    ::Envoy::Extensions::Common::OpenTelemetry::Sdk::Metrics::ExportResponse;
using KeyValue = ::Envoy::Extensions::Common::OpenTelemetry::Sdk::Common::KeyValue;
using MetricsExportRequestPtr =
    ::Envoy::Extensions::Common::OpenTelemetry::Sdk::Metrics::ExportRequestPtr;
using MetricsExportRequestSharedPtr =
    ::Envoy::Extensions::Common::OpenTelemetry::Sdk::Metrics::ExportRequestSharedPtr;
