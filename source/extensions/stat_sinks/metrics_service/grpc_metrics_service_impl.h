...
#include "envoy/service/metrics/v3alpha/metrics_service.pb.h"
...
class GrpcMetricsStreamer
    : public Grpc::AsyncStreamCallbacks<envoy::service::metrics::v3alpha::StreamMetricsResponse> {
public:
   ...
   */
  virtual void send(envoy::service::metrics::v3alpha::StreamMetricsMessage& message) PURE;

  // Grpc::AsyncStreamCallbacks
  void onCreateInitialMetadata(Http::HeaderMap&) override {}
  void onReceiveInitialMetadata(Http::HeaderMapPtr&&) override {}
  void onReceiveMessage(
      std::unique_ptr<envoy::service::metrics::v3alpha::StreamMetricsResponse>&&) override {}
...
public:
  ...
  // GrpcMetricsStreamer
  void send(envoy::service::metrics::v3alpha::StreamMetricsMessage& message) override;

  // Grpc::AsyncStreamCallbacks
  void onRemoteClose(Grpc::Status::GrpcStatus, const std::string&) override { stream_ = nullptr; }

private:
  Grpc::AsyncStream<envoy::service::metrics::v3alpha::StreamMetricsMessage> stream_{};
  Grpc::AsyncClient<envoy::service::metrics::v3alpha::StreamMetricsMessage,
                    envoy::service::metrics::v3alpha::StreamMetricsResponse>
      client_;
...
private:
  ...
  envoy::service::metrics::v3alpha::StreamMetricsMessage message_;
