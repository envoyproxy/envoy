...
class LoadBalancerFactory
    : public Upstream::ConfigurableTypedLoadBalancerFactory<
          envoy::extensions::load_balancers::shuffle_shard::v3::ShuffleShardConfig> {

public:
  std::string name() const override;
  Upstream::LoadBalancerPtr createLoadBalancerWithConfig(
      Upstream::LoadBalancerType, const Upstream::PrioritySet&, const Upstream::PrioritySet*,
      Upstream::ClusterStats&, Runtime::Loader&, Random::RandomGenerator&,
