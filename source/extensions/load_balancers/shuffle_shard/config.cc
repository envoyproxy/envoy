...
Upstream::LoadBalancerPtr LoadBalancerFactory::createLoadBalancerWithConfig(
  ...
  return std::make_unique<ShuffleShardLoadBalancer>(priority_set, local_priority_set, stats,
                                                    runtime, random, common_config, config);
}
