...
#include "envoy/config/cluster/dynamic_forward_proxy/v3alpha/cluster.pb.h"
#include "envoy/config/cluster/dynamic_forward_proxy/v3alpha/cluster.pb.validate.h"
...
public:
  Cluster(const envoy::api::v3alpha::Cluster& cluster,
          const envoy::config::cluster::dynamic_forward_proxy::v3alpha::ClusterConfig& config,
...
private:
  ...
  const envoy::api::v3alpha::endpoint::LocalityLbEndpoints dummy_locality_lb_endpoint_;
  const envoy::api::v3alpha::endpoint::LbEndpoint dummy_lb_endpoint_;
...
class ClusterFactory : public Upstream::ConfigurableClusterFactoryBase<
                           envoy::config::cluster::dynamic_forward_proxy::v3alpha::ClusterConfig> {
public:
  ClusterFactory()
...
private:
  ...
  createClusterWithConfig(
      ...
      const envoy::config::cluster::dynamic_forward_proxy::v3alpha::ClusterConfig& proto_config,
