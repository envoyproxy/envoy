...
SPIFFEValidator::parseTrustBundles(std::string trust_bundle_mapping_str) {
  ...
  trust_domains->iterate(
      [&](const std::string& domain_name, const Envoy::Json::Object& domain_object) -> bool {
