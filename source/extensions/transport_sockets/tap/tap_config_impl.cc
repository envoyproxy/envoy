...
void PerSocketTapperImpl::fillConnectionInfo(envoy::data::tap::v3alpha::Connection& connection) {
...
void PerSocketTapperImpl::initEvent(envoy::data::tap::v3alpha::SocketEvent& event) {
