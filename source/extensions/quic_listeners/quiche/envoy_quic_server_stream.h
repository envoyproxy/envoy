...
class EnvoyQuicServerStream : public quic::QuicSpdyServerStreamBase,
                              ...
                              public Http::ResponseStreamEncoder {
public:
  ...
  void setRequestDecoder(Http::RequestStreamDecoder& decoder) { request_decoder_ = &decoder; }
...
private:
  ...
  Http::RequestStreamDecoder* request_decoder_{nullptr};
};
