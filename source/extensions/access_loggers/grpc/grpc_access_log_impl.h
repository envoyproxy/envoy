...
public:
   ...
   */
  virtual void log(envoy::data::accesslog::v3alpha::HTTPAccessLogEntry&& entry) PURE;

  /**
   * Log tcp access entry.
   * @param entry supplies the access log to send.
   */
  virtual void log(envoy::data::accesslog::v3alpha::TCPAccessLogEntry&& entry) PURE;
};
...
public:
  ...
  getOrCreateLogger(const envoy::config::accesslog::v3alpha::CommonGrpcAccessLogConfig& config,
...
public:
  ...
  void log(envoy::data::accesslog::v3alpha::HTTPAccessLogEntry&& entry) override;
  void log(envoy::data::accesslog::v3alpha::TCPAccessLogEntry&& entry) override;

private:
  struct LocalStream : public Grpc::AsyncStreamCallbacks<
                           envoy::service::accesslog::v3alpha::StreamAccessLogsResponse> {
    ...
    void onReceiveMessage(
        std::unique_ptr<envoy::service::accesslog::v3alpha::StreamAccessLogsResponse>&&) override {}
    void onReceiveTrailingMetadata(Http::HeaderMapPtr&&) override {}
    void onRemoteClose(Grpc::Status::GrpcStatus status, const std::string& message) override;

    GrpcAccessLoggerImpl& parent_;
    Grpc::AsyncStream<envoy::service::accesslog::v3alpha::StreamAccessLogsMessage> stream_{};
  };

  void flush();

  Grpc::AsyncClient<envoy::service::accesslog::v3alpha::StreamAccessLogsMessage,
                    envoy::service::accesslog::v3alpha::StreamAccessLogsResponse>
      client_;
  ...
  envoy::service::accesslog::v3alpha::StreamAccessLogsMessage message_;
