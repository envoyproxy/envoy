...
#include "envoy/config/accesslog/v3alpha/als.pb.h"
...
void GrpcAccessLoggerImpl::log(envoy::data::accesslog::v3alpha::HTTPAccessLogEntry&& entry) {
...
GrpcAccessLoggerSharedPtr GrpcAccessLoggerCacheImpl::getOrCreateLogger(
    const envoy::config::accesslog::v3alpha::CommonGrpcAccessLogConfig& config,
