...
void HttpGrpcAccessLog::log(const Http::HeaderMap* request_headers,
  ...
  if (request_info.protocol()) {
    ...
    case Http::Protocol::Http10:
      log_entry->set_protocol_version(envoy::output::accesslog::v2::HTTPAccessLogEntry::HTTP10);
      break;
    case Http::Protocol::Http11:
      log_entry->set_protocol_version(envoy::output::accesslog::v2::HTTPAccessLogEntry::HTTP11);
      break;
    case Http::Protocol::Http2:
      log_entry->set_protocol_version(envoy::output::accesslog::v2::HTTPAccessLogEntry::HTTP2);
      break;
    }
  }
