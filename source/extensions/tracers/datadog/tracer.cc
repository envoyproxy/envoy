...
Tracing::SpanPtr Tracer::startSpan(const Tracing::Config&, Tracing::TraceContext& trace_context,
  ...
  datadog::tracing::Span span = extract_or_create_span(*thread_local_tracer.tracer, span_config, reader);
...
datadog::tracing::Span Tracer::extract_or_create_span(datadog::tracing::Tracer& tracer, const datadog::tracing::SpanConfig& span_config, const datadog::tracing::DictReader& reader) {
