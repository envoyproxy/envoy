...
/**
 * envoy_dynamic_module_callback_http_read_request_body is called by the module to read
...
/**
 * envoy_dynamic_module_callback_http_read_response_body is the same as
 * envoy_dynamic_module_callback_http_read_request_body, but for the response body.
 ...
 * envoy_dynamic_module_callback_http_get_request_body_size, but for the response body.
