 ...
 */
typedef enum {
  envoy_dynamic_module_type_on_http_filter_response_headers_statusContinue,
  envoy_dynamic_module_type_on_http_filter_response_headers_statusStopIteration,
  envoy_dynamic_module_type_on_http_filter_response_headers_statusContinueAndDontEndStream,
  envoy_dynamic_module_type_on_http_filter_response_headers_statusStopAllIterationAndBuffer,
  envoy_dynamic_module_type_on_http_filter_response_headers_statusStopAllIterationAndWatermark,
