...
__attribute__((weak)) size_t envoy_dynamic_module_callback_tracer_define_counter(
...
__attribute__((weak)) size_t envoy_dynamic_module_callback_tracer_define_gauge(
    envoy_dynamic_module_type_tracer_config_envoy_ptr, envoy_dynamic_module_type_module_buffer) {
...
__attribute__((weak)) size_t envoy_dynamic_module_callback_tracer_define_histogram(
    envoy_dynamic_module_type_tracer_config_envoy_ptr, envoy_dynamic_module_type_module_buffer) {
...
envoy_dynamic_module_callback_tracer_increment_counter(
    envoy_dynamic_module_type_tracer_config_envoy_ptr, size_t, uint64_t) {
