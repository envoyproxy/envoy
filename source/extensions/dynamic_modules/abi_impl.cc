...
__attribute__((weak)) size_t envoy_dynamic_module_callback_matcher_get_headers_size(
    envoy_dynamic_module_type_matcher_envoy_ptr, envoy_dynamic_module_type_http_header_type) {
...
envoy_dynamic_module_callback_matcher_get_headers(envoy_dynamic_module_type_matcher_envoy_ptr,
