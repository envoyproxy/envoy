...
//
//	mockgen -source=http.go -destination=mocks/mock_http.go -package=mocks -aux_files=github.com/envoyproxy/envoy/source/extensions/dynamic_modules/sdk/go/shared=common.go
//
...
func (m *MockSpan) SpawnChild(operationName string) shared.ChildSpan {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SpawnChild", operationName)
	ret0, _ := ret[0].(shared.ChildSpan)
	return ret0
}

// SpawnChild indicates an expected call of SpawnChild.
func (mr *MockSpanMockRecorder) SpawnChild(operationName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SpawnChild", reflect.TypeOf((*MockSpan)(nil).SpawnChild), operationName)
}
...
// SpawnChild mocks base method.
func (m *MockChildSpan) SpawnChild(operationName string) shared.ChildSpan {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SpawnChild", operationName)
	ret0, _ := ret[0].(shared.ChildSpan)
	return ret0
...
// GetUpstreamConnectionIDsAttempted mocks base method.
func (m *MockHttpFilterHandle) GetUpstreamConnectionIDsAttempted() []uint64 {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUpstreamConnectionIDsAttempted")
	ret0, _ := ret[0].([]uint64)
	return ret0
}

// GetUpstreamConnectionIDsAttempted indicates an expected call of GetUpstreamConnectionIDsAttempted.
func (mr *MockHttpFilterHandleMockRecorder) GetUpstreamConnectionIDsAttempted() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUpstreamConnectionIDsAttempted", reflect.TypeOf((*MockHttpFilterHandle)(nil).GetUpstreamConnectionIDsAttempted))
}

// GetUpstreamHostsAttempted mocks base method.
func (m *MockHttpFilterHandle) GetUpstreamHostsAttempted() []shared.UnsafeEnvoyBuffer {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUpstreamHostsAttempted")
	ret0, _ := ret[0].([]shared.UnsafeEnvoyBuffer)
	return ret0
}

// GetUpstreamHostsAttempted indicates an expected call of GetUpstreamHostsAttempted.
func (mr *MockHttpFilterHandleMockRecorder) GetUpstreamHostsAttempted() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUpstreamHostsAttempted", reflect.TypeOf((*MockHttpFilterHandle)(nil).GetUpstreamHostsAttempted))
}

// GetUpstreamRemoteAddress mocks base method.
func (m *MockHttpFilterHandle) GetUpstreamRemoteAddress() (shared.UnsafeEnvoyBuffer, bool) {
	m.ctrl.T.Helper()
...
func (mr *MockHttpFilterHandleMockRecorder) GetUpstreamRemoteAddress() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUpstreamRemoteAddress", reflect.TypeOf((*MockHttpFilterHandle)(nil).GetUpstreamRemoteAddress))
}
