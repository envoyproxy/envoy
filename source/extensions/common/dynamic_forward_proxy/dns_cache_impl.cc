...
DnsCacheImpl::DnsCacheImpl(
  ...
  // We store the reloadable flag here to avoid toggling this flag per request because it create
  // inconsistent results with the DNS cache.
  allow_disabling_dns_query_timeout_ = Runtime::runtimeFeatureEnabled(
      "envoy.reloadable_features.dfp_allow_disabling_dns_query_timeout");
}
