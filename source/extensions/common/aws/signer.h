...
public:
   ...
   * @return absl::NotFoundError("Message is missing :path header") if the path header is missing
   * @return absl::NotFoundError("Message is missing :method header"); if the method header is
   * missing
   * @return absl::StatusOk for successful signing
   */
