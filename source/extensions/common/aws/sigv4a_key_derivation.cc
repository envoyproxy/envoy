...
EC_KEY* SigV4AKeyDerivation::derivePrivateKey(absl::string_view access_key_id,
         ...
         (external_counter <= 254)) // MAX_KEY_DERIVATION_COUNTER_VALUE
  {
    ...
    fixed_input.insert(fixed_input.end(), SigV4ASignatureConstants::get().SigV4AAlgorithm[0],
                       SigV4ASignatureConstants::get().SigV4AAlgorithm[0] +
                           sizeof(SigV4ASignatureConstants::get().SigV4AAlgorithm));
