...
public:
   ...
   * included_headers will take precedence over excluded_headers and if included_headers is non-empty, only headers that match included_headers will be signed.
