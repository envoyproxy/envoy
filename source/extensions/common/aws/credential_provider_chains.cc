...
CommonCredentialsProviderChain::CommonCredentialsProviderChain(
    ...
    CredentialsProviderChainFactories& factories) {}
        ...
        CommonCredentialsProviderChain::CustomCredentialsProviderChain(const envoy::extensions::common::aws::v3::AwsCredentialProvider&)
{}
    CommonCredentialsProviderChain::DefaultCredentialsProviderChain()
    {
