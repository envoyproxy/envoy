...
SetLogicMatcher::SetLogicMatcher(
    const envoy::service::tap::v3alpha::MatchPredicate::MatchSet& configs,
...
NotMatcher::NotMatcher(const envoy::service::tap::v3alpha::MatchPredicate& config,
                       std::vector<MatcherPtr>& matchers)
...
HttpHeaderMatcherBase::HttpHeaderMatcherBase(
    const envoy::service::tap::v3alpha::HttpHeadersMatch& config,
