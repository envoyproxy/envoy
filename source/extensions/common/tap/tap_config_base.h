...
public:
   ...
   */
  static bool addBufferToProtoBytes(envoy::data::tap::v3alpha::Body& output_body,
   ...
   */
  static void bodyBytesToString(envoy::data::tap::v3alpha::TraceWrapper& trace,
...
protected:
  TapConfigBaseImpl(envoy::service::tap::v3alpha::TapConfig&& proto_config,
...
private:
  ...
  Sink* sink_to_use_;
  SinkPtr sink_;
  envoy::service::tap::v3alpha::OutputSink::Format sink_format_;
...
public:
  FilePerTapSink(const envoy::service::tap::v3alpha::FilePerTapSink& config) : config_(config) {}
...
private:
  ...
  const envoy::service::tap::v3alpha::FilePerTapSink config_;
};
