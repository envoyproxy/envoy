...
TapConfigBaseImpl::TapConfigBaseImpl(envoy::service::tap::v3alpha::TapConfig&& proto_config,
  ...
  case envoy::service::tap::v3alpha::OutputSink::OutputSinkTypeCase::kStreamingAdmin:
    ...
    RELEASE_ASSERT(sink_format_ == envoy::service::tap::v3alpha::OutputSink::JSON_BODY_AS_BYTES ||
                       sink_format_ ==
                           envoy::service::tap::v3alpha::OutputSink::JSON_BODY_AS_STRING,
                   "admin output only supports JSON formats");
    sink_to_use_ = admin_streamer;
    break;
  case envoy::service::tap::v3alpha::OutputSink::OutputSinkTypeCase::kFilePerTap:
    sink_ =
...
void Utility::bodyBytesToString(envoy::data::tap::v3alpha::TraceWrapper& trace,
                                envoy::service::tap::v3alpha::OutputSink::Format sink_format) {
  ...
  if (sink_format != envoy::service::tap::v3alpha::OutputSink::JSON_BODY_AS_STRING) {
    return;
  }
...
void FilePerTapSink::FilePerTapSinkHandle::submitTrace(
  ...
  if (!output_file_.is_open()) {
    ...
    switch (format) {
    case envoy::service::tap::v3alpha::OutputSink::PROTO_BINARY:
      path += MessageUtil::FileExtensions::get().ProtoBinary;
      break;
    case envoy::service::tap::v3alpha::OutputSink::PROTO_BINARY_LENGTH_DELIMITED:
      path += MessageUtil::FileExtensions::get().ProtoBinaryLengthDelimited;
      break;
    case envoy::service::tap::v3alpha::OutputSink::PROTO_TEXT:
