...
using TraceWrapperPtr = std::unique_ptr<envoy::data::tap::v3alpha::TraceWrapper>;
inline TraceWrapperPtr makeTraceWrapper() {
  return std::make_unique<envoy::data::tap::v3alpha::TraceWrapper>();
}
...
public:
  ...
  virtual void submitTrace(TraceWrapperPtr&& trace,
                           envoy::service::tap::v3alpha::OutputSink::Format format) PURE;
};
...
public:
   ...
   */
  virtual void newTapConfig(envoy::service::tap::v3alpha::TapConfig&& proto_config,
