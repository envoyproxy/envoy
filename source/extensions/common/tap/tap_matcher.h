 ...
 */
void buildMatcher(const envoy::service::tap::v3alpha::MatchPredicate& match_config,
...
public:
  ...
  SetLogicMatcher(const envoy::service::tap::v3alpha::MatchPredicate::MatchSet& configs,
...
public:
  NotMatcher(const envoy::service::tap::v3alpha::MatchPredicate& config,
             std::vector<MatcherPtr>& matchers);
...
public:
  HttpHeaderMatcherBase(const envoy::service::tap::v3alpha::HttpHeadersMatch& config,
