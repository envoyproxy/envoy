...
ExtensionConfigBase::ExtensionConfigBase(
    const envoy::config::common::tap::v3alpha::CommonExtensionConfig proto_config,
  ...
  case envoy::config::common::tap::v3alpha::CommonExtensionConfig::ConfigTypeCase::kAdminConfig: {
  ...
  case envoy::config::common::tap::v3alpha::CommonExtensionConfig::ConfigTypeCase::kStaticConfig: {
    newTapConfig(envoy::service::tap::v3alpha::TapConfig(proto_config_.static_config()), nullptr);
...
void ExtensionConfigBase::newTapConfig(envoy::service::tap::v3alpha::TapConfig&& proto_config,
                                       Sink* admin_streamer) {
