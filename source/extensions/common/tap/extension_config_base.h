...
#include "envoy/config/common/tap/v3alpha/common.pb.h"
...
public:
  ...
  void newTapConfig(envoy::service::tap::v3alpha::TapConfig&& proto_config,
                    Sink* admin_streamer) override;

protected:
  ExtensionConfigBase(const envoy::config::common::tap::v3alpha::CommonExtensionConfig proto_config,
...
private:
  ...
  const envoy::config::common::tap::v3alpha::CommonExtensionConfig proto_config_;
