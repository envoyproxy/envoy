...
extern "C" WasmResult envoyResolveDns(const char* dns_address, size_t dns_address_size,
                                        uint32_t* token);
...
extern "C" WasmResult envoyResolveDns(const char* address, size_t address_size, uint32_t* token);
