...
proxy_wasm::Word resolveDns(proxy_wasm::Word dns_address, proxy_wasm::Word dns_address_size,
...
inline WasmResult envoyResolveDns(const char* dns_address, size_t dns_address_size,
                                    uint32_t* token) {
