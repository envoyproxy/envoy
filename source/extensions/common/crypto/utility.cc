...
const VerificationOutput Utility::verifySignature(absl::string_view hash, CryptoObject& key,
...
CryptoObjectPtr Utility::importPublicKey(const std::vector<uint8_t>& key) {
