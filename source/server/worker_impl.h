...
public:
  ...
  void start(GuardDog& guard_dog, const Event::OptDispatcherStartCb& cb = absl::nullopt) override;
...
private:
  void threadRoutine(GuardDog& guard_dog, const Event::OptDispatcherStartCb& cb);
