...
ClusterManagerPtr ValidationClusterManagerFactory::clusterManagerFromProto(
  ...
  return std::make_unique<ValidationClusterManager>(
      bootstrap, *this, stats_, load_report_stats_store_, tls_, runtime_, random_, local_info_,
      log_manager_, main_thread_dispatcher_, admin_, validation_context_, api_, http_context_,
      grpc_context_, time_system_);
}
...
ValidationClusterManager::ValidationClusterManager(
    ...
    Stats::Store& stats, Stats::StoreRootPtr& load_stats_store_root, ThreadLocal::Instance& tls,
    ...
    : ClusterManagerImpl(bootstrap, factory, stats, load_stats_store_root, tls, runtime, random,
                         local_info, log_manager, main_thread_dispatcher, admin, validation_context,
                         api, http_context, grpc_context),
