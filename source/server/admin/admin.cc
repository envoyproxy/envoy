    ...
    : server_(server),
      ...
      handlers_{
          ...
          {"/config_dump",
           ...
           false,
           false,
           {{Admin::ParamDescriptor::Type::String, "resource",
             "See documentation for 'mask' below"},
            {Admin::ParamDescriptor::Type::String, "mask",
             "When both resource and mask query parameters are specified, the mask is "
             "applied to every element in the desired repeated field so that only a "
