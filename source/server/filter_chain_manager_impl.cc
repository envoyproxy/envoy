...
const envoy::config::core::v3alpha::Metadata& FactoryContextImpl::listenerMetadata() const {
  return config_.metadata();
}
envoy::config::core::v3alpha::TrafficDirection FactoryContextImpl::direction() const {
