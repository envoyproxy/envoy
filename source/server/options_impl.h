...
public:
  ...
  void setConfigProto(const envoy::config::bootstrap::v3alpha::Bootstrap& config_proto) {
  ...
  const envoy::config::bootstrap::v3alpha::Bootstrap& configProto() const override {
