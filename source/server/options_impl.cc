...
OptionsImpl::OptionsImpl(std::vector<std::string> args,
  ...
  TCLAP::SwitchArg ignore_unknown_dynamic_fields("", "ignore-unknown-dynamic-fields",
                                                 ...
                                                 cmd, false);
  TCLAP::SwitchArg suppress_deprecated_warning_logs(
      "", "suppress-deprecated-warning-logs",
      "Suppresses the logging of deprecated field warnings during Protobuf message validation", cmd,
      false);
  ...
  suppress_deprecated_warning_logs_ = suppress_deprecated_warning_logs.getValue();
...
Server::CommandLineOptionsPtr OptionsImpl::toCommandLineOptions() const {
  ...
  command_line_options->set_suppress_deprecated_warning_logs(suppress_deprecated_warning_logs_);
