...
public:
  ...
  static std::vector<Network::ListenerFilterFactoryCb> createListenerFilterFactoryList_(
      const Protobuf::RepeatedPtrField<envoy::api::v3alpha::listener::ListenerFilter>& filters,
  ...
  LdsApiPtr createLdsApi(const envoy::api::v3alpha::core::ConfigSource& lds_config) override {
  ...
  DrainManagerPtr createDrainManager(envoy::api::v3alpha::Listener::DrainType drain_type) override;
...
public:
  ...
  bool addOrUpdateListener(const envoy::api::v3alpha::Listener& config,
                           const std::string& version_info, bool added_via_api) override;
  void createLdsApi(const envoy::api::v3alpha::core::ConfigSource& lds_config) override {
...
private:
  ...
  bool addOrUpdateListenerInternal(const envoy::api::v3alpha::Listener& config,
  ...
  bool listenersStopped(const envoy::api::v3alpha::Listener& config) {
    ...
    return stop_listeners_type_ == StopListenersType::All ||
           (stop_listeners_type_ == StopListenersType::InboundOnly &&
            config.traffic_direction() == envoy::api::v3alpha::core::INBOUND);
  }
  ...
  createListenSocketFactory(const envoy::api::v3alpha::core::Address& proto_address,
...
public:
  ...
  buildFilterChain(const envoy::api::v3alpha::listener::FilterChain& filter_chain) const override;
