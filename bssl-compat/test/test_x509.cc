...
TEST(X509Test, test_X509_digest) {
  ...
  uint8_t expected[] {0xc3,0x49,0x59,0xa8,0x3b,0x10,0xa2,0xef,0x91,0xe5,0x30,0x3f,0x63,0xdb,0xbd,0x1b,0xfd,0x63,0xc7,0xf6,0x6a,0x75,0xbb,0x9f,0x43,0x4a,0x77,0xad,0x9d,0x9a,0xfc,0x09};
