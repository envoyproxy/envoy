...
ENVOY_BAZEL_PREFIX=@envoy envoy/tools/code_format/check_format.py \
    ...
    --build_fixer_check_excluded_paths ./BUILD ./dist ./examples ./library/java ./library/kotlin ./library/objective-c ./library/swift ./library/common/extensions ./test/java ./test/kotlin ./test/objective-c ./test/swift
