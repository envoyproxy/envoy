...
interface RequestFilter : Filter {
   ...
   */
  fun onRequestHeaders(headers: RequestHeaders, endStream: Boolean, streamIntel: StreamIntel):
   ...
   */
  fun onRequestData(body: ByteBuffer, endStream: Boolean, streamIntel: StreamIntel):
   ...
   */
  fun onRequestTrailers(trailers: RequestTrailers, streamIntel: StreamIntel):
