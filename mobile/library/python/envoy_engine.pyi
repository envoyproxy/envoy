...
class RequestHeadersBuilder:
    ...
    def remove(self, name: str_view) -> "RequestHeadersBuilder": ...
...
class RequestTrailersBuilder:
    ...
    def remove(self, name: str_view) -> "RequestTrailersBuilder": ...
...
class ResponseHeadersBuilder:
    ...
    def remove(self, name: str_view) -> "ResponseHeadersBuilder": ...
...
class ResponseTrailersBuilder:
    ...
    def remove(self, name: str_view) -> "ResponseTrailersBuilder": ...
