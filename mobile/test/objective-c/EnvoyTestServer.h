...
// `exec_properties` in its BUILD target. EnvoyTestServer binds to a listening socket on the machine
// it runs on, and on CI, this operation is not permitted in remote execution environments.
