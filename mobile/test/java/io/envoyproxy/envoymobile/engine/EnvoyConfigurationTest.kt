...
class EnvoyConfigurationTest {
  ...
  fun buildTestEnvoyConfiguration(
    ...
    filterChain: MutableList<EnvoyNativeConfig> = mutableListOf(EnvoyNativeConfig("buffer_filter_1", "{'@type': 'type.googleapis.com/envoy.extensions.filters.http.buffer.v3.Buffer'}"), EnvoyNativeConfig("buffer_filter_2", "{'@type': 'type.googleapis.com/envoy.extensions.filters.http.buffer.v3.Buffer'}")),
