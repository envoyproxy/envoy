...
EXTENSIONS = {
    ...
    # "envoy.filters.http.assertion": Removed - directory does not exist in mobile
    ...
    # "envoy.filters.http.route_cache_reset": Removed - directory does not exist in mobile
    ...
    # "envoy.connection_handler.default": Removed - listener_manager directory does not exist
