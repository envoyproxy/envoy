...
def update_rotation(add: str | None, remove: str | None, dirty: bool,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="oncall rotation")
    parser.add_argument(
        "--add",
        type=str,
        help=
    ...
    if args.add or args.remove:
        update_rotation(args.add, args.remove, args.dirty, args.substitute)
