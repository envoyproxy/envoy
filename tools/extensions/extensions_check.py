...
EXTENSION_CATEGORIES = (
    ...
    "envoy.http.header_validators", "envoy.matching.common_inputs", "envoy.matching.input_matchers",
    "envoy.tls.key_providers", "envoy.quic.proof_source", "envoy.quic.server.crypto_stream",
    ...
    "envoy.thrift_proxy.filters", "envoy.tracers", "envoy.sip_proxy.filters",
    ...
    "envoy.http.stateful_session", "envoy.matching.http.input", "envoy.matching.network.input",
