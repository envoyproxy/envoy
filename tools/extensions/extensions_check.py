...
EXTENSION_CATEGORIES = (
    ...
    "envoy.compression.decompressor", "envoy.config.validators", "envoy.network.connection_balance",
    "envoy.filters.http", "envoy.filters.http.cache", "envoy.filters.listener",
    "envoy.filters.network", "envoy.filters.udp_listener", "envoy.formatter",
