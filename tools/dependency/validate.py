...
# data imports
from envoy_repo.api.bazel.repository_locations import data as api_repository_locations_data
from envoy_repo.bazel.repository_locations import data as repository_locations_data
from envoy_repo.source.extensions import extensions_build_config
...
# THIS CAN BE REMOVED ONCE utils.py IS UPDATED
# All repository location metadata in the Envoy repository.
def get_repository_locations():
