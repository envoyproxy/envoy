...
class ValidateTest(unittest.TestCase):
  ...
  def test_invalid_build_graph_structure(self):
    ...
    self.assertRaises(validate.DependencyError, lambda: validator.validate_build_graph_structure())
  ...
  def test_valid_test_only_deps(self):
    ...
    validator = self.build_validator({'a': fake_dep('test_only')}, {'//test/...': ['a', 'b__pip3']})
    validator.validate_test_only_deps()
