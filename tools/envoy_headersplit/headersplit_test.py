...
class HeadersplitTest(unittest.TestCase):
    ...
    source_code_hello_world = open(
        "tools/envoy_headersplit/code_corpus/hello.h", "r").read()
    # A C++ source code contains definition for several classes
    source_class_defn = open("tools/envoy_headersplit/code_corpus/class_defn.h",
                             "r").read()
    ...
    source_class_impl = open(
        "tools/envoy_headersplit/code_corpus/class_impl.cc", "r").read()

    def test_to_filename(self):
        # Test class name with one "mock"
        self.assertEqual(headersplit.to_filename("MockAdminStream"),
                         "admin_stream")
...
"""
    ...
    def test_class_definitions(self):
        ...
        defns_cursors = headersplit.class_definitions(
            translation_unit_class_defn.cursor)
    ...
    def test_class_implementations(self):
        translation_unit_class_impl = TranslationUnit.from_source(
            ...
            options=TranslationUnit.PARSE_SKIP_FUNCTION_BODIES)
        impls_cursors = headersplit.class_implementations(
            translation_unit_class_impl.cursor)
    ...
    def test_class_implementations_error(self):
        ...
        impls_names_correct = [
            cursor.spelling for cursor in impls_cursors_correct
        ]
