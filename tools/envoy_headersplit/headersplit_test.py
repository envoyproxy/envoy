...
class test{
 ...
 """
  ...
  def test_to_filename(self):
    ...
    self.assertEqual(headersplit.to_filename("MockClusterMockPrioritySet"), "cluster_mock_priority_set")

    # Test class name with no "Mock"
    self.assertEqual(headersplit.to_filename("TestRetryHostPredicateFactory"), "test_retry_host_predicate_factory")
...
"""
    ...
    translation_unit_hello_world = TranslationUnit.from_source("hello.h", options=TranslationUnit.PARSE_SKIP_FUNCTION_BODIES)
