...
IGNORED_V2_PROTOS = [
    ...
    "envoy/config/trace/v2alpha",
    "envoy/config/transport_socket/alts/v2alpha",
    ...
    "envoy/type",
    "envoy/type/matcher",
    "envoy/type/metadata/v2",
    "envoy/type/tracing/v2",
]
...
def generate_current_api_dir(api_dir, dst_dir):
    ...
    for proto in IGNORED_V2_PROTOS:
        rm_path = str(dst.joinpath(proto[6:]))
        if os.path.exists(rm_path):
            shutil.rmtree(rm_path)
        else:
            print(f"WARNING: unable to delete api dir: {rm_path}")
