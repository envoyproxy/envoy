...
def run_checks():
  ...
  errors += check_unfixable_error("designated_initializers.cc", "Don't use designated initializers")
  ...
  errors += check_unfixable_error("test_naming.cc",
  ...
  errors += check_unfixable_error("std_make_optional.cc",
